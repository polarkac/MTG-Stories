...
"Tell me more of this #emph[lawbringer] ," drawled Nicol Bolas as he casually tore off the right arm of the minor functionary he held in his talon. An elf, the leader of whatever-this-place-was and the overseer of who-cares.
...
Nicol Bolas savored the taste of the lawmage's ultimate despair as she died. #emph[A true evil] , he thought, #emph[how flattering . . .]
...
#figure(image("107_Sabotage/01.jpg", width: 100%), caption: [Crux of Fate | Art by Michael Kormarck], supplement: none, numbering: none)
...
#figure(image("107_Sabotage/02.jpg", width: 100%), caption: [Sanctum of the Sun | Art by Yeong-Hao Han], supplement: none, numbering: none)
...
#figure(image("107_Sabotage/03.jpg", width: 100%), caption: [Hour of Devastation | Art by Simon Dominic], supplement: none, numbering: none)
...
#emph[Ravnica ] was Nicol Bolas's goal.
...
"If I don't deliver the Sun I'm trapped here, and if I do deliver it Nicol Bolas will destroy Ravnica. Ravnica is #emph[our home] !"
...
Vraska closed her eyes and let out a long, shaking breath. It was the most frightening idea she had ever had in her life. But if Nicol Bolas looked and saw nothing, continued to trust her, allowed her the power he had promised her in return for her service . . . then she could hurt him all the more. #emph[They ] could hurt him all the more.
...
Vraska spoke with confidence. "You have my word as captain of the #emph[Belligerent ] that I will do whatever it takes to sabotage Nicol Bolas upon the return of my memories. I swear to commit my conscious self to his destruction."
...
#emph[I'll also leave some memories for Nicol Bolas to find so he doesn't see any gaps. Is that all right?]
...
#figure(image("107_Sabotage/04.jpg", width: 100%), caption: [Induced Amnesia | Art by Chris Rallis], supplement: none, numbering: none)
...
#figure(image("107_Sabotage/05.jpg", width: 100%), caption: [Mastermind's Acquisition | Art by Svetlin Velinov], supplement: none, numbering: none)
