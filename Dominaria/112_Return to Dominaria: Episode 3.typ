...
It had taken all day and all night, but sure enough, as Ziva promised, the morning after the merfolk had begun, Jhoira stood on the shore looking at what was left of the great skyship #emph[Weatherlight] .

They were on the coast of Bogardan in a cove with a wide stretch of beach, protected by rocky outcrops on each side. Above the dunes was a flat stretch of grassy ground where the #emph[Weatherlight]  now lay. Some distance inland, dark volcanic peaks rose past undulating lava fields.
...
#figure(image("112_Return to Dominaria: Episode 3/01.jpg", width: 100%), caption: [Art by Kev Walker], supplement: none, numbering: none)
...
#emph[Now I just need a crew] , Jhoira thought. She missed Karn, Venser, and all the others. At least she knew where Teferi was, though there was no telling whether he could be persuaded to help or not. #emph[And there's Jodah] . Her expression turned wry. She didn't know if she could count on him, either. It had been so long since Urza's final powerful spell had all but ended the Phyrexian invasion, and Dominaria had healed so much since then. But some things would never heal.

It didn't matter. Whatever happened, Jhoira would find a way. She always had before, and she didn't expect that to change anytime soon. #emph[This is too important] , she thought.
...
Her expression rapt, Tiana didn't seem to hear the question. "The shape." She gestured toward the #emph[Weatherlight] 's bare spine. "It's Gerrard's blade in the portraits." She shook her head. "Of course! I don't know why I didn't realize that before."
...
"Don't you?" Jhoira lifted her brows. This was the second time Tiana had reacted to the #emph[Weatherlight]  like it was a long-lost friend.
...
Tiana turned to look at the engines, at the artisans who were already planning their restoration. No, Jhoira hadn't been imagining it; Tiana had an affinity for the #emph[Weatherlight] . Sounding as if her throat had gone dry, Tiana said, "Why me?"
...
Gathering her crew would be a long journey, but Jhoira had planned and prepared for it, just the way she had for the #emph[Weatherlight] 's recovery.
...
A man howled in fury, his hood falling back to reveal pale skin and a shaved head marked with livid scars. #emph[A Cabal cleric] , Jhoira thought. He was using dementia magic, creating phantasms that were causing everyone else in range to run for their lives, but it clearly wasn't affecting the woman.
...
#figure(image("112_Return to Dominaria: Episode 3/03.jpg", width: 100%), caption: [Art by Magali Villeneuve], supplement: none, numbering: none)
...
If Shanna agreed, they would have plenty of time to discuss the past. Jhoira said, "And I have answers, but hear my question first: Would you consider serving on the #emph[Weatherlight] ?"

Shanna laughed. "If it still existed, I'd consider it." Then, as she took in Jhoira's expression, her face turned sober. "I'd consider it an honor, to follow in the footsteps of my ancestor. To serve as she served. If the #emph[Weatherlight]  existed."
...
#figure(image("112_Return to Dominaria: Episode 3/04.jpg", width: 100%), caption: [Art by Chris Rallis], supplement: none, numbering: none)
...
"I understand." Jhoira leaned back against her chair and let her breath out in resignation. #emph[I can't argue with that] , she thought. She looked at Shanna, who made a little gesture of defeat.
...
Raff was lucky she realized it was an illusion, not an attack. The garden had vanished and she and Shanna were suddenly standing high in the air, drifts of cloud around them. In the distance the original version of the #emph[Weatherlight]  angled across the sky. The lines of its mast and hull weren't quite accurate, but it was a credible effort. Remembering Shanna's ability, she asked, "Can you see this?"
...
#figure(image("112_Return to Dominaria: Episode 3/05.jpg", width: 100%), caption: [Art by John Stanko], supplement: none, numbering: none)
...
The hull was gracefully curved, the stern mast angled backward. The railings and glass of the ports gleamed brightly. From the upright way the ship sat on the ground, it must be already partially awake and supporting itself. The #emph[Weatherlight]  was whole and ready to launch.
...
With a rush of wind and golden light, Ajani Goldmane appeared on the shore. He gazed up at the #emph[Weatherlight]  with a satisfied expression.

"—a friend to arrive." Jhoira smiled. "#emph[Now]  we are ready."

#figure(image("112_Return to Dominaria: Episode 3/06.jpg", width: 100%), caption: [Ajani, Valiant Protector | Art by Anna Steinbauer], supplement: none, numbering: none)
