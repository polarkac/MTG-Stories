...
#figure(image("216_Episode 3: Forever Hold Your Peace/01.jpg", width: 100%), caption: [Edgar, Charmed Groom | Art by: Volkan Baga], supplement: none, numbering: none)
...
"Welcome, welcome! Oh, it's such a delight to have so many guests. I simply couldn't have a wedding with the groom's side empty. It'd be such a faux pas#emph[.] "
...
"Now, I'm sure you're all honored to be here, and #emph[dying ] to get to the main event. But I hope you'll forgive me; I have a little something else planned first. A little amuse-bouche, if you will, and a present for my dear Edgar. Thralls!"
...
#emph[Something ] sinks lower, draped in rich red curtains. The shape reminds him of a birdcage, and he wonders if she's made someone stitch her an abomination as a gift. Given her predilection for torturing the faithful, she might have torn the wings from an angel and attached them to a choir singer. #emph[Behold, a songbird.]
...
That day—years ago, centuries—she was still writhing. Her eyes met Sorin's not long after his grandfather's, her plea just as impassioned: #emph[Do not drink. Save me.]
...
And when she looks to him from within her feathered prison it is with the same pleading look he remembered. A new face does not dull its blade. His chest aches, his tongue sticks to the roof of his mouth. #emph[Drink and be eternal] , his grandfather had said. But was this what they'd been striving for all these years? To repeat history?

Another thought follows: Olivia can't have brought Sigarda here solely to serve as a gift.

#figure(image("216_Episode 3: Forever Hold Your Peace/02.jpg", width: 100%), caption: [Sigarda's Imprisonment | Art by: Bryan Sola], supplement: none, numbering: none)
...
#emph[Drink and be eternal] , his grandfather said to him. As if he had any choice in the matter. As if he had wanted to be eternal.
...
There is an #emph[angel ] hanging from the ceiling, and that man can only think of passing pleasures.
...
"I've done #emph[no ] such thing!" Sorin protests, struggling again. The guards yank him backward. Worse—the crowd laughs.
...
#figure(image("216_Episode 3: Forever Hold Your Peace/03.jpg", width: 100%), caption: [Arterial Alchemy | Art by: Caio Monteiro], supplement: none, numbering: none)
...
"Attacking a bride on her wedding day! I knew you were gauche, but this! We'll need to construct a whole new #emph[word ] for how gauche this is," she sneers down at him.

His grandfather's hand lands on his shoulder.

"Sorin, this is more important than you could ever imagine. We need this. The key—my word, what is #emph[that] ?"
...
"Who invited #emph[you?] #emph[" ] Olivia snaps.

The spirit turns toward her. Brows knit over spectral eyes. "You did."

#figure(image("216_Episode 3: Forever Hold Your Peace/04.jpg", width: 100%), caption: [Katilda, Dawnhart Martyr | Art by: Miguel Castañón], supplement: none, numbering: none)
...
But looking at her now, framed by the Voldaren's stained glass window, Sorin realizes it's better that he #emph[didn] #emph['t ] make Sigarda.
...
#figure(image("216_Episode 3: Forever Hold Your Peace/05.jpg", width: 100%), caption: [Sanctify | Art by: Kasia 'Kafis' Zielinska], supplement: none, numbering: none)
