...
#figure(image("244_Episode 3: The Locked Tower/01.jpg", width: 100%), caption: [Art by:  Bryan Sola], supplement: none, numbering: none)
...
Despite Jaya's earlier objection to jumping through hoops, Karn heard her low laugh. "Oh, so you're assuming #emph[your]  way is the only way to do this? Remind you of anyone?"
...
Karn traced a #emph[ting-ting-ting]  along the pipes. He pursued it into the storeroom's corner and then located a small vent in the floor. Slime and blood slid down between the metal slots, thick and clotting. "We must proceed back to the stairs, then down to the second floor."
...
#figure(image("244_Episode 3: The Locked Tower/02.jpg", width: 100%), caption: [Art by:  Justyna Dura], supplement: none, numbering: none)
...
"While some people might find fighting an unknown number of opponents that can seep through walls and attack at any time #emph[interesting] ," Jaya said, "I can think of a good hundred other ways I'd like to spend the evening."
...
"Wise," Stenn said. "If Sheoldred knew the sylex's location, she would stop at nothing to attain it. Since any of us could be a sleeper agent, we can't risk having that become common knowledge—and we don't know how well that~ that #emph[thing]  can listen."
...
#figure(image("244_Episode 3: The Locked Tower/03.jpg", width: 100%), caption: [Art by:  Donato Giancola], supplement: none, numbering: none)

"Karn, I—" Jaya stopped. Frustration clouded her face. "What's that?"

Stenn peered around her. "Yes, what #emph[is]  that?"
...
"It is time that I call the #emph[Weatherlight] ," Karn said.
...
"Phyrexians?" Karn could hear the #emph[Weatherlight ] creaking in the winds. When she spoke again, her voice sounded calm and determined: "You're in luck—we're not far. If the winds favor us, we'll be there soon."
