...
#show: doc => conf(
    ...
    set_name: "Kaldheim",
    author: "Roy Graham & Jenna Helland",
    doc
)
...
#emph[That sword.]  It hadn't been any kind of magic she'd seen before—nothing like the portal Alrund had opened. "We've got to get that sword away from him. If he can rip open the doors to this place, who knows what else he can do with it?"
...
#figure(image("188_Episode 4: Into the Demons' Realm/01.jpg", width: 100%), caption: [Immersturm Skullcairn | Art by: Cliff Childs], supplement: none, numbering: none)
...
Across the magma, the basalt shore began to creep out. The stone didn't just expand or double up on itself, either—it seemed to #emph[grow] , tendrils of rock twining together, knitting themselves into a bridge. When he opened his eyes, Tyvar seemed just as surprised as she was.
...
#emph[First, he turns those trolls to stone, now this. The kid's a transmuter. ] But that wasn't all he was. Somehow, Tyvar had sparked without realizing it—gone all the way to Zendikar, just thinking it was another of Kaldheim's realms.
...
#emph[Stubborn fool.]  Why was she even still here? She had other paying work on Kaldheim, after all. A monster she was supposed to be tracking down.
...
#figure(image("188_Episode 4: Into the Demons' Realm/02.jpg", width: 100%), caption: [Demon Berserker Token | Art by: Grzegorz Rutkowski], supplement: none, numbering: none)
...
With a thought, she wreathed her hand in that eerie light and straightened her fingers into a spear. #emph[Quick jab through the heart. Flicker out of phase, and extract. Won't be comfortable, but it'll get the job done.]
...
And nearly blacked out from the pain. It was #emph[burning ] inside the demon, like sticking her hand in a furnace. She lost her grip on the demon's neck and tumbled off down onto the rough black stone beneath.
...
Her hand had only been material for a fraction of a second, yet she could still feel the pain, white-hot and absolute. But pain, like so many things, was a tool. A tool Kaya knew how to use. #emph[Focus on it. Use it.]  From somewhere deep inside her, Kaya felt an icy chill welling up.
...
"That jarl was twice your size! Do you know how many humans, in all the sagas I've known, have slain a demon? Assuming you didn't talk things through with the other one, you bested #emph[two] ! And without a weapon! The skalds #emph[must ] hear about this. I'll tell them myself, when we're finished!"

"Uh, thanks," said Kaya, caught off guard. #emph[So the kid can share glory. ] "If we plan on doing this again, though, I'd prefer to be armed."

Something seemed to dawn on Tyvar, then. "Of course. Allow me."

He stooped over the massive hammer the demon jarl had dropped before going into the magma. Kaya was about to protest—#emph[a bit heavy for me, not really my style] —when Tyvar pushed his fingers into the black iron of the hammerhead as if it were mud. From it, he pulled two fistfuls of metal: one he dropped to the path where it clinked dully against the rock.
...
#figure(image("188_Episode 4: Into the Demons' Realm/03.jpg", width: 100%), caption: [], supplement: none, numbering: none)
...
#emph[But that horned bastard has so many enemies, I could probably find a buyer. Chandra, maybe.]
...
#figure(image("188_Episode 4: Into the Demons' Realm/04.jpg", width: 100%), caption: [Sword of the Realms | Art by: Lie Setiawan], supplement: none, numbering: none)
...
Fifteen feet, then ten. Kaya slipped an axe from her belt and hurled it at Tibalt. It clipped his shoulder, sent him sprawling, and she drew the second axe. #emph[Don't let him get up.]
...
#emph[It's not too late to run.]

The thought seemed to come from nowhere.

#emph[It's done anyway. Tibalt already started the Doomskar. What are you still doing here?]
...
#emph[This plane's problems aren't your problems. You owe these people nothing. Go on—jump through the Blind Eternities. Get out of here. Save yourself. It's what you're best at, after all.]
...
#emph[It would be so easy. There's nothing for you here anymore but pain.]
...
There was a movement in the swirling smoke to her right; she saw the sword first, those beautiful colors trapped in glass, arcing toward her. Tibalt, swinging to kill. "You couldn't just #emph[leave] , could you?"
...
Kaya opened her eyes. Between her and Tibalt stood Tyvar. He'd caught that shimmering god-light sword on the dagger fixed to his bracer. Tibalt was struggling to push through, arms shaking with the effort, and getting nowhere. "Who in all the hells are #emph[you] ?"
...
The fog was starting to clear from Kaya's head now; she could #emph[feel ] where Tibalt had slipped into her mind, the way he had cloaked his presence in her own doubts and fears. The more she listened, the worse the fatigue and pain grew. It was almost artful, this magic—nothing like the clumsy, slapdash work she'd seen from him so far.
...
#emph[By the ancients] , she thought. #emph[He's too young—too arrogant—too ] dumb#emph[ to doubt himself. And thank all the gods of Kaldheim for that.]
...
He shook his head. "My talents #emph[do ] have their limits, you know."
...
#figure(image("188_Episode 4: Into the Demons' Realm/05.jpg", width: 100%), caption: [Varragoth, Bloodsky Sire | Art by: Ian Miller], supplement: none, numbering: none)
...
The energy Kaya had been gathering to planeswalk still hung in the air around her, a nameless pressure lacking a valve. She could still go. She #emph[should ] still go. It was the smart choice. It was her code.
