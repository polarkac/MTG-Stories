...
#figure(image("164_The Path to Opulent/01.jpg", width: 100%), caption: [Kaya's Ghostform | Art by: Johan Grenier], supplement: none, numbering: none)
...
#figure(image("164_The Path to Opulent/02.jpg", width: 100%), caption: [Relentless Advance | Art by: Stanton Feng], supplement: none, numbering: none)
...
Me and Teyo Verada and Mistress Kaya were now in the company of Gan Shokta, the ogres Govan and Bombop, Akamal, Sheeza and Jahdeera (the viashino twins), and a handful of other Gruul warriors, shamans, and druids all led by #emph[Master ] Domri Rade.
...
#figure(image("164_The Path to Opulent/03.jpg", width: 100%), caption: [Kasmina's Transmutation | Art by: Uriah Voth], supplement: none, numbering: none)
...
And then I felt like hitting Dumb Domri when he actually #emph[cheered] : "Woohoo! Ya see that! That was Vitu-Ghazi they trashed! Krokt, they taught those Selesnya droops a lesson!"
...
#figure(image("164_The Path to Opulent/04.jpg", width: 100%), caption: [Domri, Anarch of Bolas | Art by: Raymond Swanland], supplement: none, numbering: none)
