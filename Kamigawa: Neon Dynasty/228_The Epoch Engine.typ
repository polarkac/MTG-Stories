...
#figure(image("228_The Epoch Engine/01.jpg", width: 100%), caption: [Katsumasa, the Animator | Art by: Heonhwa Choe], supplement: none, numbering: none)
...
"My prototype for a new generation of mech. I call this prime iteration the Epoch Engine—and I want #emph[you]  to be its pilot."
...
#figure(image("228_The Epoch Engine/02.jpg", width: 100%), caption: [Shorikai, Genesis Engine | Art by: Wisnu Tan], supplement: none, numbering: none)
...
"I've never mentioned them before? Oh, I've been getting #emph[delightful]  fan mail since my promotion three years ago. You know the type. Incompetent researchers without enough talent and too much time between their ears, unhappy about someone born outside Otawara rising through Futurist ranks." Arima flipped through the enchanted menu and selected a sweet spiced tea and two platters of fried dumplings. "Anyway, I'm so happy to see you again, little sister. You're looking more furtive than usual. What's going on?"
...
"I don't #emph[idolize]  him. He's guided me since I was thirteen, Arima. He's been generous with his knowledge and time. I owe him a lot. Plus, no matter what you say, he's a talented scientist. There's much I can gain from staying at his side."
...
#figure(image("228_The Epoch Engine/03.jpg", width: 100%), caption: [Kotori, Pilot Prodigy | Art by: Aaron J. Riley], supplement: none, numbering: none)
...
#emph[Katsumasa—Jukai not Reckoner? Please clarify.]
...
#emph[Teacher! I'm confused. Please reply.]
...
#figure(image("228_The Epoch Engine/04.jpg", width: 100%), caption: [Universal Surveillance | Art by: Aaron J. Riley], supplement: none, numbering: none)
...
"Kotori. You've always been rational. Don't compromise the mission. I couldn't #emph[bear]  to see the consequences on your career if you do. I'll explain everything afterwards, all right? You know I wouldn't make you do anything wrong."
...
To her astonishment, she received a reply. #emph[Not my doing, but perhaps an aftereffect.]
...
Something powerful churned within the mech, like a tide crashing over rocks. #emph[Take our own path.]
...
#figure(image("228_The Epoch Engine/05.jpg", width: 100%), caption: [Jungle Hollow | Art by: Lucas Staniec], supplement: none, numbering: none)
