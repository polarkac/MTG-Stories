...
#show: doc => conf("The Dragon's Errand", doc)

#emph[Long ago, on the plane of Kamigawa, a goblin named Kiki-Jiki finds himself in a tight spot…] 

#figure(image("../stories_older/052_The Dragon's Errand/01.png", width: 100%), caption: [], supplement: none, numbering: none)

#emph[This story originally ran in 2004 as one of the ] Kamigawa block legend vignettes#emph[.] 
...
#figure(image("../stories_older/052_The Dragon's Errand/02.jpg", width: 100%), caption: [Meloku the Clouded Mirror | Art by Scott M. Fischer], supplement: none, numbering: none)
...
#emph[Little scaly fish-with-legs, searching with eager claws in water hungry for light. Turn back, little fish. You are not the only one who hungers.] 

#figure(image("../stories_older/052_The Dragon's Errand/03.jpg", width: 100%), caption: [Kiki-Jiki, Mirror Breaker | Art by Steven Belledin], supplement: none, numbering: none)
...
#emph[Clever fish, to find my lair so readily. Foolish fish, for now you must die.] 

Kiki-Jiki bolted upright. Something was really wrong, and he had a pretty big suspicion it was more of that #emph[muh] -stuff at work. First of all, he hadn't expected to land so soon after jumping, especially since as far as he could tell he was landing on #emph[thin air] —air that felt as hard as the tribe elder's shell, and hurt just about as much as being sat upon by said elder (a punishment he had endured many times for his various escapades). Weirder still, he had actually seen himself #emph[keep falling]  into the chasm below. Damn shame, he was just about to catch that fishtail too, when he saw himself fall out of sight.

#emph[Open your eyes, little fish. See the one who will end you. See me.] 

#figure(image("../stories_older/052_The Dragon's Errand/04.jpg", width: 100%), caption: [Moonring Mirror | Art by Christopher Rush], supplement: none, numbering: none)
...
#emph[Can you see me, little fish?] 
...
A #emph[ryu] —a great dragon. Its voice echoed inside Kiki-Jiki's skull. Oh, and it was big, huge, enormous. It was probably old, too, and if Kiki-Jiki knew anything about elders, they were cantankerous.

#emph[I am older than time itself, frightened fish. The lives of your kind are like a brief shifting in the current to me. I have seen the rings grow on the great oysters in the deep and seen their shells decay to sand. My scales are brighter than any diamond in the earth, and my wrath burns hotter than any fire from the mountains. And I am angry, fish-with-legs, very angry, for something dear to me has been stolen.] 
...
#emph[Little fish-with-shell…little fish…] 
...
#emph[You were clever to find my lair, very clever. Perhaps I have a use for you….] 
...
#figure(image("../stories_older/052_The Dragon's Errand/05.jpg", width: 100%), caption: [Soratami Cloud Chariot | Art by Franz Vohwinkel], supplement: none, numbering: none)

Then Kiki-Jiki looked up and saw it looming in the distance: an incredible palace that seemed to grow up out of the clouds. Its spires were dazzling in the sun. He could see great arches and courtyards, and here and there vehicles that looked like chariots were skating on the wind currents, back and forth between the main palace and outlying clouds with smaller towers and pagodas on them. These were the halls of the soratami, the people of the moon, a tall, cold race that floated on the air and cared little for the people on the ground, and least of all for the akki. He had heard stories about Zo-Zu the Punisher leading the bravest of the akki on stone-throwing practice near where the soratami chariots were known to fly. And in the charred remains he had seen the results of their powerful #emph[muh…muh…] 

#emph[Magic.] 

"#emph[Magic] !" the Kiki-Jiki shouted over the rushing wind. That was the word! He chortled in delight and almost slid off the #emph[ryu's]  back, but the great beast snaked in the air, balancing his rider. "But wait—if the soratami have magic, won't they see us coming?"

#emph[They will see a swift-moving cloud, nothing more, little fish. The soratami are wise and wary, but they do not own the skies. There are many here much older than they.] 

The #emph[ryu]  swerved left around a dark cumulonimbus.

#emph[That cloud there, that is a raijin, a thunder kami. Woe to the soratami chariot that passes beneath its stormy veil.] 
...
Kiki-Jiki wolfed down his fifth #emph[biwa]  from the heavily laden fruit tree in the courtyard outside and contemplated his next move. What was it with these soratami and their wide-open halls? He had half expected the inside of the palace to have some measure of comfort, a little rough-hewn rock, some cave moss, maybe. But all this glass and marble was downright unsettling, and the vast chambers were not good for sneaking. He ducked down a passageway, feet going pitter-pat across painted clouds on the cold flagstone floor. He must be close to the ambassador's chambers the #emph[ryu]  was talking about. Then, voices from around the corner, coming this way. Kiki-Jiki took refuge behind a large jade carving of what looked like a giant mouth with wings.

"…so the doguso land-dweller says to me 'the #emph[kami]  they take everything from us, everything! When they take the very land away from us, what will we stand upon!' and I say to him 'A worrisome problem, I'm sure.'"
...
Kiki-Jiki looked down at the pearl. Yes, there it was, tucked under his right arm, heavy as an unconscious sibling. He looked at the mirror. His reflection had his arm bent in a strange fashion, but there was #emph[no pearl] ! He set the pearl down on the floor, and looked back up. His reflection met his gaze. He scratched his chin. His reflection scratched his own. He smiled and his reflection returned the smile, then #emph[it stuck out its tongue and blew a loud raspberry] ! For a second, Kiki-Jiki thought he had done it—it certainly wouldn't be the first time his mouth had done something without his permission—but he glanced down and sure enough his tongue was firmly where it should be, tucked behind his teeth. He looked back up. Now his reflection waving its finger at him! #emph[Cheeky reflection! You think you're so smart?]  Furious, Kiki-Jiki reached down and scooped up the pearl. Slowly, he lifted the pearl up over his head and grinned at his reflection. His reflection's face clouded and he held his hands up over his face. He seemed to be shouting something, but Kiki-Jiki couldn't hear the words. "Now who's having fun?" said Kiki-Jiki as he slammed the pearl into his reflection's face.
...
They were in luck. The soratami ambassador hadn't made it back to the entrance. The two Kiki-Jikis took a hard left and spilled out into a wide courtyard. Kiki-Jiki stopped and turned to his reflection. "Look, I have to get back to the #emph[ryu] ."

"So do I!" said his reflection.

Kiki-Jiki thought fast, which was a first for him, and something of a miracle, but he would have to pat himself on the shell later. There was work to be done. "Er, look—let's split up. I'll go left to that spire there, and you go right, through that courtyard there. Then we'll meet behind the palace at the #emph[ryu] . Gives us a better chance!"

His reflection frowned suspiciously.

#emph[Damn.] 

Kiki-Jiki tried a different tactic. "Hey, pick up some more of those #emph[biwa]  on your way through, okay?"

His reflection grinned. Same face, same stomach, apparently. Kiki-Jiki shuddered as his reflection ran off across the courtyard. Was he so easily duped? That was something he would have to work on. He turned and ran straight back to the little pagoda where the #emph[ryu]  had promised to pick him up. The sun was warm on his shell, and somehow, the pearl didn't feel so heavy anymore.

#v(0.35em)
#line(length: 100%, stroke: rgb(90%, 90%, 90%))
#v(0.35em)

The #emph[ryu]  sped fast through a string of puffy clouds, swerving now and then to avoid flocks of high-flying giant moths that scattered like pieces of paper in the ryu's wake. The pearl, held in his massive jaws, glowed softly in the crimson light of the setting sun. On his back, Kiki-Jiki sat in a rare moment of contemplation. Then he straightened up and shouted out over the howling wind. "What do you think happened to my reflection?"

#emph[He is the prisoner of the soratami ambassador now.] 

"Oh," said Kiki-Jiki frowning. "I feel kinda' bad leaving him behind. I mean, family is one thing, but he's…me!"

#emph[Worry not, brave little fish. Your kind's reflections are even more ephemeral than you are. He will not be caught for long. Be happy, fish-with-horns, great mirror breaker. You have done well.] 
...
#emph[What can a mirror give you other than what you show it? The magic was yours, clever fish.] 
...
#figure(image("../stories_older/052_The Dragon's Errand/07.jpg", width: 100%), caption: [Keiga, the Tide Star | Art by Ittoku], supplement: none, numbering: none)

The #emph[ryu]  had promised to take him to an abandoned orchard he knew of, with lots of overburdened fruit trees and fat snails for the taking. There would be a pool of water there, too, thought Kiki-Jiki—a place where he could try out his new-found talents. Kiki-Jiki grinned. Today was turning out to be a pretty good day, after all.
...
Something was wrong. The akki was no longer squirming. In fact, he was perfectly still, frozen in mid-air. Meloku raised an eyebrow, then gasped as the akki #emph[splintered]  into a thousand gleaming shards that fell like a sudden rain, disappearing into the Æther before they reached the floor. All that was left was a tangled length of cord, hanging uselessly from the ceiling spire. Meloku rubbed his temples with long, slender fingers. Yes, it had been a most #emph[annoying]  interrogation indeed.

#v(0.35em)
#line(length: 100%, stroke: rgb(90%, 90%, 90%))
#v(0.35em)

In a hidden grotto by an underground river, the great blue #emph[ryu]  coiled in the darkness, around the pearl that glowed faintly as though it had been warmed by the sun's rays on the journey down from the cloud palace.

#emph[Sleep, my child, and grow strong. Soon you will hatch and take your rightful place among the falls and the mists and the stars of this world. You will eat the oysters in the deep, and the sweet cloud-dew, and the fish that walk on your land. Just…go easy on the shelled ones.] 
