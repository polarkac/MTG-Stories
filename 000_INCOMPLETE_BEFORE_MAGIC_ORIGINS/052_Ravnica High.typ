...
#show: doc => conf("Ravnica High", doc)

#emph[We were sitting around the writer's pit talking about high school during]  Return to Ravnica #emph[block and the subject of mapping the guilds to high school clique tropes came up. It was a fun exploration and we all had a laugh wondering who Rakdos would be in our school... or the Golgari. After we had figured out all the major players, we went home for the day. Soon thereafter, Jennifer wrote the following story.] 

#emph[Ravnica may be in our rearview mirror but it is always close in our minds and hearts. Here's another lighthearted glimpse into our favorite city-plane. Enjoy!] —Adam

#figure(image("../stories_older/052_Ravnica High/01.jpg", width: 100%), caption: [Tablet of the Guilds | Art by Nic Klein], supplement: none, numbering: none)
...
#figure(image("../stories_older/052_Ravnica High/02.jpg", width: 100%), caption: [Art by Jaime Jones], supplement: none, numbering: none)
...
#figure(image("../stories_older/052_Ravnica High/03.jpg", width: 100%), caption: [Isperia, Supreme Judge | Art by Scott M. Fischer], supplement: none, numbering: none)
...
#figure(image("../stories_older/052_Ravnica High/04.jpg", width: 100%), caption: [Golgari Charm | Art by Zoltan Boros], supplement: none, numbering: none)
...
#figure(image("../stories_older/052_Ravnica High/05.jpg", width: 100%), caption: [Shattering Blow | Art by Steve Prescott], supplement: none, numbering: none)
...
#figure(image("../stories_older/052_Ravnica High/06.jpg", width: 100%), caption: [Dynacharge | Art by Matt Stewart], supplement: none, numbering: none)
...
#figure(image("../stories_older/052_Ravnica High/07.jpg", width: 100%), caption: [], supplement: none, numbering: none)
