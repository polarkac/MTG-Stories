...
#show: doc => conf("Loran's Smile", doc)
...
#figure(image("../stories_older/030_Loran's Smile/01.jpg", width: 100%), caption: [Feldon of the Third Path | Art by Chase Stone], supplement: none, numbering: none)
