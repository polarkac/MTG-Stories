...
#show: doc => conf("The Absolution of the Guildpact", doc)
...
#figure(image("../stories_older/023_The Absolution of the Guildpact/01.jpg", width: 100%), caption: [Art by Tyler Jacobson], supplement: none, numbering: none)
...
#figure(image("../stories_older/023_The Absolution of the Guildpact/02.jpg", width: 100%), caption: [Art by John Avon], supplement: none, numbering: none)
...
#figure(image("../stories_older/023_The Absolution of the Guildpact/03.jpg", width: 100%), caption: [Razia, Boros Archangel | Art by Donato Giancola], supplement: none, numbering: none)
...
#figure(image("../stories_older/023_The Absolution of the Guildpact/04.jpg", width: 100%), caption: [Art by David Palumbo], supplement: none, numbering: none)
