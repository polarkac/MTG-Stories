...
#show: doc => conf("The Reforged Chain", doc)
...
#emph[But all is not well in ancient Tarkir. Yasova, khan of this era's Temur clan, ] #emph[revealed to Sarkhan ] #emph[that she is following the guidance of a dragon as well. Unbeknownst to her, her patron is—or will later become—Sarkhan's most hated enemy: the unfathomably ancient dragon Planeswalker Nicol Bolas.] 

#emph[Now, Sarkhan races against time to find Ugin before Bolas can set Tarkir's history—and Sarkhan's own—on the path to ruin.] 

#v(0.35em)
#line(length: 100%, stroke: rgb(90%, 90%, 90%))
#v(0.35em)

Sarkhan thrashed his wings against the frigid air, flying over the tundra toward the churning storm. Thoughts flashed across his mind, mirroring the pops of lightning and mana illuminating the tempests ahead, thoughts that broke into nothingness like brittle ash. He had traveled all this way, shattered the laws of time and history—and for what? He had found a time when dragons still lived, when dragon tempests still birthed mighty sky tyrants onto his world, when warriors sought glory by clashing with dragon-kind—but it had amounted to nothing, because the shadow of Nicol Bolas loomed even here. Even in this precious place, a time long before the mistakes of Tarkir's history, in a refuge hidden centuries before Sarkhan's own errors of judgment—the influence of Bolas had somehow made it here before him. Sarkhan spat a blast of fire at the air and flew through it.

#emph[Do you understand now, dragon mage? ] Questions exploded at him in roaring tones, as if voiced by the thundercracks of the storm ahead—but they were only his own mind shouting at itself. #emph[Do you see why Ugin would lead you here, to witness this? Do you grasp the lesson now? ] A sobering answer crept over Sarkhan's mind: perhaps the lesson of this entire quest was that fate was inescapable. That he should embrace despair and accept the iron rigidity of time, and of Bolas's dominion over him.

In a flash, the grim, circular joke of it all took shape for Sarkhan. Bolas had killed Ugin over some ancient feud. Ugin's death ended Tarkir's dragon tempests, which wiped out dragons on Tarkir long before Sarkhan was born, and the clans rose to rule the plane. The clans' remembrance of dragons led the young Sarkhan to revere the ancient beasts, which led to Sarkhan, in a moment of weakness, bowing his head in loyalty to Bolas, the very dragon who had made Sarkhan's obsession possible in the first place. The chain looped back on itself, inevitable and unbreakable. Sarkhan was here just to serve as witness to the forging of its earliest link.

Sarkhan felt like letting his wings drop, to stall his flight in the air. He could just fall, here, as Ugin would fall. Some part of him wanted to plunge, to let gravity be his final master, to meet the ground at speed and feel everything collapse.

But instead he tipped his head up, wingbeats hammering the air as he climbed. The cold tore at him and ozone filled his lungs, but he continued to climb up and up, trying to punish the clouds with his rage. There was still a chance. He still had the hedron shard with him, a piece of Ugin's chamber on Zendikar, and the thought of it pulled him onward. If he was still here, still alive, then there was a chance he could reforge the chain. If he still held on to the breath in his chest—then maybe Ugin could too.

#figure(image("../stories_older/113_The Reforged Chain/01.jpg", width: 100%), caption: [Fearsome Awakening | Art by Véronique Meignaud], supplement: none, numbering: none)

Sarkhan flew through the tempests. He could feel the wings of other dragons passing through the storms around him, and heard their roars. He broke through the rumbling cloudbank and his breath caught at what he saw. The shimmering, ghostlike dragon Ugin flew across the atmosphere like a comet, dragging a tail made of storm. Sarkhan knew Ugin instantly, as surely as he knew the sun or the earth. Pale blue mist trailed out behind the spirit dragon, merging with the tempests, like a cape that spread out to connect him to all of Tarkir.

Sarkhan forgot everything that had brought him to this moment, and his soul stirred. It was #emph[Ugin] —and #emph[not]  Bolas—who had truly birthed his fascination with dragons. Ugin was the true beginning of the chain that made Sarkhan who he was—and made Tarkir what it should have been. Sarkhan felt like staying in dragon form forever, dancing in the clouds around this immense and wise progenitor. He flew at a distance, just watching Ugin's wings hold him effortlessly in the air.

This, before him, was his purpose. This was the reason he was here. He could stop what was about to happen, to alter Tarkir's path. He would do whatever he needed to do. He would—
...
It was a tilt of Ugin's head that made Sarkhan notice the spell happening down on the ground. Sarkhan followed Ugin's eyes. Through a break in the clouds, he saw lines of greenish elemental energy tracing a curving pattern across the snow and ice, anchored at certain nodes like tethered lightning. As Sarkhan looked closer, he could see that the nodes were carved boulders, marked by slashing claw patterns.

Sarkhan cursed a name in his mind. #emph[Yasova.] 

Together, the claw-rune sites formed a pathway. The pathway marked the exact path of the dragon tempests—and therefore, predicted the path of Ugin. Yasova had been tracking the storms in order to track the spirit dragon.

But Yasova's path down on the tundra was not for her own benefit. It was a guiding spell, but not for her sabertooth cat or Temur warriors to follow. This pattern was meant to be seen from the air—by Nicol Bolas.
...
#figure(image("../stories_older/113_The Reforged Chain/02.jpg", width: 100%), caption: [Crux of Fate | Art by Michael Komarck], supplement: none, numbering: none)
...
#figure(image("../stories_older/113_The Reforged Chain/03.jpg", width: 100%), caption: [Ugin, the Spirit Dragon | Art by Raymond Swanland], supplement: none, numbering: none)
...
#emph[Yes] , said his draconic heart. #emph[Yes, destroy the all-father. Destroy the progenitor who commands us. Destroy him, and be free of his rule.] 

#emph[No] , said some small part of Sarkhan. #emph[No!] 
...
#figure(image("../stories_older/113_The Reforged Chain/04.jpg", width: 100%), caption: [Nicol Bolas, Planeswalker | Art by D. Alexander Gregory], supplement: none, numbering: none)
...
And then it stopped. He was suspended in a snowbank, a foot or a mile from air, lungs compressed, suffocating. He held onto a thread of consciousness, enough to tell him that he was dying.

When the claws dug away the snow above him, Sarkhan thought for a moment that it was Bolas, come to finish the job, to finally have his victory. But it wasn't. It was Yasova's sabertooth cat, clearing snow with great swipes of its paws. Its tusks bit into the back of his collar, grabbing him by the scruff, and lurched him painfully out of the snowbank. The cat laid him out on his back on the tundra.

#figure(image("../stories_older/113_The Reforged Chain/05.jpg", width: 100%), caption: [Yasova Dragonclaw | Art by Winona Nelson], supplement: none, numbering: none)

Sarkhan was a limp thing, a sack of skin with assorted bone-pieces inside. Through squinting eyes he could see Yasova looking down at him. She held his staff, with the hedron shard dangling from it.

"Don't try to move," she said. "Don't try to speak."

She said some other words in a low voice, and he could feel his insides begin to sort themselves out.

"Ugin," Sarkhan managed.

"Don't try to speak," she repeated. But she looked up at the sky, and then back down at him. "It's just about over. The Unwritten Now will finally be free of the blight of dragons."

Sarkhan twisted his eyes to one side, to see as much as he could see. What he saw was Ugin's body falling out of the clouds, streaking toward the ground.

Ugin defeated. Dragons on the road to extinction. Tarkir's fate sealed.

Sarkhan groaned.

"I don't know what you are," said Yasova. "But you seem like you might have some answers in you. So do me a favor, and don't die just yet. I'll drag you back to my shamans and see what you're about."

The healing spell had not completed its work, but Sarkhan lurched onto his side anyway. Everything hurt—consciousness was a wall of pain—but somehow he rolled onto his hands and knees.

"What are you doing, fool thing?" said Yasova.

At that moment, Sarkhan raised his head to see Ugin hitting the tundra.

There was a moment, before the force of it hit them, that Sarkhan and Yasova glanced at each other. They both felt it. Something had tilted on Tarkir. The world was poised to change forever. For a moment, Sarkhan thought he saw a shadow of concern brush across Yasova's face.

Then the wave of force, stronger than the power of Ugin's roar, hit them. Snow exploded into them, and the earth bucked. Sarkhan, Yasova, and the sabertooth were knocked over. Sarkhan's staff tumbled and landed in snow.

Sarkhan crouched as the snow blast pummeled him for what felt like a thousand heartbeats. After the blast of snow and force subsided, he crawled back to his knees, but then huddled again as rocks and chunks of ice rained down.

When the rubble-rain ended, Sarkhan coughed and shuddered. He looked for the crater, to find where Ugin's body had landed. He saw the place where Ugin fell, but it wasn't just a crater—it was an entire chasm punched into the land, a massive crack of shattered earth, with Ugin's body somewhere far below the level of the snow. It was the same place Sarkhan had come to in his own time—the site of the temporal nexus.

Sarkhan glanced up to see Nicol Bolas turn toward the sky and vanish. The air rippled, and he was gone, along with Sarkhan's chance to destroy him.

Sarkhan climbed to his feet, climbing out of the snow and rubble. He pulled his staff from the snow, and felt an urging to move when he saw the hedron shard attached to it.

"Where do you think you're going?" asked Yasova, dusting herself off.

"To save him," said Sarkhan, and he turned and stomped toward the chasm. His balance wavered, and his muscles and bones protested, but Yasova's healing spell, still at work in his bones, dulled the pain.

"You weren't meant to do this," warned Yasova. "I can't let you do this."

Sarkhan snapped around to her. He lashed an accusatory hand at the ancient Temur khan. His hand became the head of a dragon, and that dragon's head breathed forth a flame as hot as Sarkhan's rage, blasting Yasova full on in the chest. Yasova tumbled back from the force of the spell, flying boots over head into the snow. She landed, and slumped, and let out a groan.

#figure(image("../stories_older/113_The Reforged Chain/06.jpg", width: 100%), caption: [Banefire | Art by Raymond Swanland], supplement: none, numbering: none)
...
After one more snarl of warning, Sarkhan marched off toward Ugin.

The climb down to the floor of the chasm was an awkward skid more than a climb. Sarkhan didn't take time to choose footholds carefully, and he half-slipped his way down the craggy walls of the gorge, reinjuring his already battered bones. His body felt like a broken marionette, but he continued forcing it to move, using his staff like a crutch.

Ugin was laid out against the chasm floor, burned and abraded on every surface, littered with rubble from the impact. His eyes were closed. Sarkhan's heart leaped when he saw that a slow exhale was escaping the dragon's nostrils.

There was still part of a breath in him, he thought. There was still time.

Sarkhan ran over to the dragon. He brushed away the rubble from the twisting, runic shapes along Ugin's neck, and pressed his own face against Ugin's. He closed his eyes, and tried to feel the essence of the great dragon, tried to hear the same voice that had drawn him back to his home plane.

But there was nothing. There was no voice, just the long, ragged exhale of a broken titan. Sarkhan's heart sank.

The only voice was an unwelcome one, from Sarkhan's own mind, an echo meant to torture himself with old questions. #emph[Do you understand now, dragon mage? ] The question rang in his skull. #emph[Do you grasp the lesson now? Do you see why you had to come?] 

"No, I don't!" he whispered into Ugin's face. "I don't understand! Tell me! Guide me!"

#emph[Do you see now? Do you understand the lesson?] 

"No! I don't! I can't!" He slapped Ugin's scales softly with his hand. "Ugin, help me, please. Help me…"

#emph[Do you understand how you must always fail?] 

Sarkhan gritted his teeth and gripped his staff. "No! I—I can't!"

#emph[Do you understand that you must always fail, as long as your goal is not truth, but guidance?] 

"What does that mean? I don't understand! I don't see it!"

#emph[…that as long as you seek dragons around you, you will never become the dragon within you?] 
...
#figure(image("../stories_older/113_The Reforged Chain/07.jpg", width: 100%), caption: [Art by Daarken], supplement: none, numbering: none)
...
Sarkhan smiled up at Yasova, a crooked smile made of gratitude and simple dumb joy. "What we were meant to," he yelled up at her. "Thank you, Yasova khan."

#figure(image("../stories_older/113_The Reforged Chain/08.jpg", width: 100%), caption: [Crucible of the Spirit Dragon | Art by Jung Park], supplement: none, numbering: none)

She looked around at the hedron cocoon, confounded, and Sarkhan laughed. It struck him that the chain of events that had brought him here was not a circular joke at all—it was a chain with a purpose. Fate had conspired to place him here, at this crossroads of history, to give him the chance to act. If he had never served Bolas, if he had never been sent to the Eye of Ugin, if he had never come to Tarkir with voices ringing in his broken mind—without all of that hardship, he wouldn't have had a chance to forge a new chain for his world.
...
Snowflakes fell past Yasova, dropping flecks of white on the snug structure at the bottom of the chasm. Her sabertooth padded over and nuzzled her, and she put her hand on its head. High above, dragons screeched and soared across the sky.
