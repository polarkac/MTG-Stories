...
Jace tried to reason with her, but Nissa ignored him. It was Nahiri she focused on as the lithomancer yelled, "This is #emph[my]  home, tree-dweller!"
...
Elementals, who taught her what being part of a family meant, what a family was supposed to be. Who came to her aid now, without her asking. #emph[Hers ] and not Nahiri's.

#emph[What would Gideon do?]  Nissa thought.

#emph[He would tell you it's time to make choices for yourself.]
...
#emph[How is the tree dweller managing to do all of this? ] she thought.
...
Nahiri brought her hands together with a #emph[clap] .
...
#emph[Damn it] , Nahiri thought, calling the stones again. She tried to throw boulders at Nissa, to make the ground around the elf trap her, to send more swords. But Nissa's elementals defended her fiercely, as if they were more than just mindless tools. As if they knew they were fighting for their lives.

#emph[How can anyone live a good life if your world is broken and failing? ] Nahiri thought with a scowl. She attacked again. And again. And again.
...
But they #emph[were]  attacking him, and it took his full skill and cunning to evade their blows and not damage them in return. He knew that if he hoped to win Nissa back as a friend and ally, he couldn't damage Zendikar.
...
#emph[Damn it. ] She knew who it was before she even turned around. She recognized the pattern of Jace's footsteps on the stones. But she hadn't noticed them until now.
...
"I don't want to fight you," he said again, and there was no aggression in his voice. But she heard what he wasn't saying. The silence half of that statement: #emph[But I will.]
...
#emph[No, not you, too. ] Nahiri bared her teeth and screamed. She sent a giant stone foot shooting up from the ground directly at the vampire's chest.
...
#emph[This is an illusion, ] she realized. #emph[This is Jace.]
...
#emph[It worked! ] Jace thought as the hedrons hit the surrounding ground. He could feel Nahiri's mind struggle against his control. He hated that it had come to this, but his choices were limited.

The Singing City's eerie hum began to grow in volume.

#emph[Better hurry. ] He wasn't sure if he could hold Nahiri's mind and a silencing spell simultaneously.
...
#emph[No, that's not who I am. ] Jace pushed the temptation away.
...
#emph[Safely on the other side] , he thought with some satisfaction.
...
#emph[Nissa, please, we need to stop this] , Jace thought.#emph[ Call off the elementals.]

#emph[If we stop, Jace, Nahiri will take the truce as an opportunity to overwhelm us. You've seen how ruthless she is.]
...
#emph[Please] ,#emph[ ] Jace thought. #emph[Let's go to Ravnica. We can study the Core there together.]

#emph[What makes you think we won't accidentally annihilate Ravnica? ] Nissa replied. #emph[I've seen the damage the Core can do. We should destroy it.]

#emph[Nahiri said it won't work outside of Zendikar. It'll be safe to test it there.]
...
#emph[Nahiri is not known for her truthfulness, Jace.]
...
#emph[The Gatewatch. We can use this] , thought Jace as he struggled against Ashaya's roots. #emph[There's something you don't know. I] #emph[] #emph[. . .] #emph[ we have other battles to face, Nissa.]

#emph[The Gatewatch failed. We were supposed to protect the things we love. We couldn't even protect each other. ] Nissa's heart ached with the memory of Gideon's smiling face, at those tender and hopeful moments with Chandra. How, for a little while at least, among the other planeswalkers, Nissa felt like she belonged somewhere. #emph[You were like a family to me.]
...
#emph[Who are you? ] she asked.

#emph[I am me. I am you.]

Fifty feet away, Nahiri smashed a stone foot into an earth elemental, catching it by surprise. It crumbled to its knees.

Nissa shot a tangle of vines at Nahiri's ankles. #emph[Why are you only speaking now? ] she said to the Core.
...
#emph[How? ] she asked. This was impossible. Confusing. Nissa didn't have time for a new mystery right now. Nahiri close and coming closer.

But if this was Zendikar, really Zendikar~

#emph[Nissa, please! Let me take the Core! ] Jace thought. Nissa ignored him.

#emph[The object in your hand is a very old piece of me. It's full of power] ,#emph[ ] the voice from the Core replied.

Nissa frowned, aimed a fresh attack at Nahiri. #emph[Why? Why would the ancient kor create this?]
...
#emph[Will you help me, Jace? ] Nissa thought. Jace nodded once, but even at a distance, she could tell he was planning something.
...
#emph[What would Gideon do? ] she thought, then caught herself. #emph[No, what would I do?]

#emph[Trust your strength] ,#emph[ ] whispered the power in her hands.
...
#emph[I will protect my home, my family. I will try and try again until I get this right.]
...
#emph[What if I destroy] , Nissa thought, #emph[like Nahiri?]

#emph[Trust your strength] , her home whispered.
...
#emph[Trust my strength] , she thought.
...
#emph[Like a life bloom after the Roil] , he thought. He'd read about life blooms but had never seen one.
...
#emph[Nissa] , he thought. #emph[I'm so sorry. I should have listened better.]
