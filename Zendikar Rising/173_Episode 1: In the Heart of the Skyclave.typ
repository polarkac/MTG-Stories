...
#figure(image("173_Episode 1: In the Heart of the Skyclave/01.jpg", width: 100%), caption: [Mountain | Art by: Chase Stone], supplement: none, numbering: none)
...
"When I was young, this land was peaceful. There was none of #emph[this] ." Nahiri gestured at the ground, wrinkling her nose in disgust. Far below, there were bubbles rising from the lava again, heralding another earthquake from the Roil. "The Eldrazi caused an unspeakable amount of damage to this plane."
...
#emph[To remember when this Skyclave was built] , Nahiri thought.
...
#figure(image("173_Episode 1: In the Heart of the Skyclave/02.jpg", width: 100%), caption: [Nissa of Shadowed Boughs | Art by: Yongjae Choi], supplement: none, numbering: none)
...
#emph[Well, what would Gideon do? ] she thought. #emph[Start acting like him if you want to be more like—.]

#emph[Like he was.]  And suddenly, the grief of his death hit her in a fresh wave.

#emph[Gideon wouldn't hesitate.]
...
#emph[Jace would know] , she thought, but then quickly shook the thought away. She didn't want to think about Jace or the battle with Nicol Bolas and its toll on Ravnica or the shattered state of the Gatewatch or Gideon's death or Chandra.
...
With one powerful motion, Nahiri brought her hands together with a #emph[clap] , and the massive doors flew apart, booming as they slammed against the stone walls to the right and left of them.
...
"No you don't," Nissa grunted as brambles began to wrap themselves around the felidar. But the beast shook and reared up, swiping its massive paws. One connected with Nissa's shoulder and sent her flying with a shout and a harsh #emph[thud.]
...
"What is #emph[that] ?" Nahiri said, taking a step back.
...
Nissa grinned. #emph[Take that, not-a-snake.]
...
Nissa smiled. Maybe they#emph[ were]  going to heal this plane. Together. "True. Let's go take this Skyclave's heart."

#v(0.35em)
#line(length: 100%, stroke: rgb(90%, 90%, 90%))
#v(0.35em)

#figure(image("173_Episode 1: In the Heart of the Skyclave/03.jpg", width: 100%), caption: [Inscription of Insight | Art by: Zoltan Boros], supplement: none, numbering: none)
...
"I said the ancient kor texts are not always clear," Nahiri started, briskly, "but the object we seek is both powerful and dangerous. It's~an orb. It roughly translates to #emph[lithoform core] . And it's the last one in existence."
...
"Of course," Nahiri replied, "I #emph[am]  an ancient kor."
...
"What?" Nahiri asked, turning around. Nissa saw that she was holding the key to her chest and #emph[smiling] , like she just won a battle. "It stopped the Roil."

"You murdered the elemental!"

"Your plant?"

#emph[My family.]  Nissa didn't say. #emph[A piece of Zendikar. ] Because the elementals #emph[were ] Zendikar, and if quelling the Roil with the core meant their death, then Zendikar was in mortal danger. Nissa stared at the ashes in her hands, felt anger and grief well up inside her. Over this mistake.
...
"At the expense of Zendikar's #emph[life] ," Nissa retorted. She reached out her awareness to the plants and moss that grew in the corners and cracks of the Skyclave, but they didn't respond. Nissa knew then that everything that lived in that ruined fortress was dead.
...
"And you don't know what Zendikar is like #emph[now] . It's still beautiful, Nahiri"—Nissa reached out her hand—"give me the key."
...
#figure(image("173_Episode 1: In the Heart of the Skyclave/04.jpg", width: 100%), caption: [Jace, Mirror Mage | Art by: Tyler Jacobson], supplement: none, numbering: none)
...
Maybe Chandra was right. Maybe she #emph[was]  a walking disaster.
...
"Nahiri," Jace said, brows knitting together. "The #emph[other]  guardian of Zendikar?"
