...
#figure(image("004_The Blight We Were Born For/01.jpg", width: 100%), caption: [Aligned Hedron Network | Art by Richard Wright], supplement: none, numbering: none)

With Kozilek's arrival, Ulamog had been freed. Both titans were now loose and amok amidst the Zendikari army. Tazri rallied her soldiers away from the collapsing Sea Gate, a reaction more reflexive than strategic. #emph[We are going to die here.]  All the preparations, all the victories and sacrifices, all the tales the soldiers told themselves of hope and redemption, all now reduced to the stark truth they knew in their bones. #emph[The end is always faster and bloodier than you expect.]  Kozilek had risen, and many horrific ends followed his wake.
...
#figure(image("004_The Blight We Were Born For/02.jpg", width: 100%), caption: [Kozilek, the Great Distortion | Art by Aleksi Briclot], supplement: none, numbering: none)

But as Kozilek moved over the horizon, a shimmering wave of #emph[something]  roamed over the land, a pulsating, translucent ripple emanating outward in all directions from the great titan. The wave rushed toward them, and Tazri didn't even have time to scream as it crashed upon them.
...
#figure(image("004_The Blight We Were Born For/03.jpg", width: 100%), caption: [Reality Hemorrhage | Art by Chris Rallis], supplement: none, numbering: none)

The wave hit Tazri. The angel's halo around Tazri's collar glowed with golden heat. Time, previously slowed, now #emph[stretched] . Events and actions from her past and future flickered in her mind, became her mind, became her #emph[now] . All her previous life, flickering, flickering into existence. All her #emph[future]  life, flickering, flickering into existence. Time and space stretched further, straining. Snapping. Reality stopped.
...
#figure(image("004_The Blight We Were Born For/04.jpg", width: 100%), caption: [Needle Spires | Art by Jonas De Ro], supplement: none, numbering: none)
...
The angel coughed, blood and more of the white glow sputtering up from her breath onto her chest. #emph[How is she still alive?]  Tazri had never before beheld an angel, and regarded her beauty and power in stunned silence.
...
The angel shook her head. "I am. I am dying. Might...days. Help." The angel stared at the sword at Tazri's side, still in its scabbard. #emph[No] . #emph[No!]

"If you can last, we can get you help, we can go back to Sea Gate or Coralhelm, find someone..." One, two, three horns blared in the distance. #emph[No!]
...
#figure(image("004_The Blight We Were Born For/05.jpg", width: 100%), caption: [Fortified Rampart | Art by David Gaillet], supplement: none, numbering: none)

The man smiled. A broad, easy smile that a few years ago might have quickened her heart. "I'm Vorik. Why are you here, Tazri?"

She hesitated, unsure of where to begin. Even #emph[how]  to begin. She just looked at him, and remained silent. There were other jobs, certainly, right? There were other militias besides Sea Gate. She thought furiously about who else she knew, who else could...
...
Each time Vorik spoke the word, it was like a sword through her chest. #emph[Hope] . Was this life's revenge for her inability to help him?

#emph[You saved me, and now I cannot save you.]
...
#figure(image("004_The Blight We Were Born For/06.jpg", width: 100%), caption: [Stone Haven Medic | Art by Anna Steinbauer], supplement: none, numbering: none)
...
#emph[How could you not choose me as your successor?]

#emph[Why could I not figure out how to be the person I was? How could I let you down, over and over?]
...
#emph[He's dying. He's dying and soon he will be gone. And then what will you have? Whom will you love?]

And then, #emph[Zendikar will follow. Vorik will die. Zendikar will die. The only person who will not die is you. You died a long time ago. Soon everything will be empty and void, just like you.]

The horrifying thought warmed her, filling her emptiness, if only for a moment.

#emph[flicker flicker flicker]

#v(0.35em)
#line(length: 100%, stroke: rgb(90%, 90%, 90%))
#v(0.35em)

#figure(image("004_The Blight We Were Born For/07.jpg", width: 100%), caption: [Spatial Contortion | Art by Daarken], supplement: none, numbering: none)

Tazri screamed as reality crumbled. Each memory, no, the #emph[actual living ] of her past was being experienced #emph[now] , all moments occurring simultaneously, a kaleidoscopic display infinitely unfolding. The halo around her neck, the angel's halo, was now a candescent white, and the heat burned. Even as her mind sought refuge from the flickering onslaught of the past, it was assaulted by the future...
...
#figure(image("004_The Blight We Were Born For/08.jpg", width: 100%), caption: [Call the Gatewatch | Art by Yefim Kligerman], supplement: none, numbering: none)
...
#figure(image("004_The Blight We Were Born For/09.jpg", width: 100%), caption: [Kozilek's Return | Art by Lius Lasahido], supplement: none, numbering: none)
...
The thrumming resonated throughout the sphere. Tazri shared in her master's joy, but could not perceive the cause of such mirth. Kozilek raised an arm, and there was a #emph[ripple]  in space, and Gideon Jura appeared once more before them, whole and resurrected. He was once more clenched in Kozilek's fist, but in his terror and screams it was apparent that Gideon Jura #emph[remembered] . Remembered dying, and now he was to die again. Kozilek squeezed and Gideon Jura once more found the embrace of death.
...
Another twitch, another #emph[ripple] , and Gideon Jura was reborn again, and his terrified cries were delicious.
...
#figure(image("004_The Blight We Were Born For/10.jpg", width: 100%), caption: [Wastes | Art by Raymond Swanland], supplement: none, numbering: none)
...
#figure(image("004_The Blight We Were Born For/11.jpg", width: 100%), caption: [Essence Depleter | Art by Chase Stone], supplement: none, numbering: none)
...
She took a deep breath #emph[why are you are still so human, stop breathing, you don't need to breathe ] and went back to work.

She wanted him back. #emph[Why did you leave me? Was I not a good soldier? We had won. Where are you now? Do you miss me? ] She wanted his laughter again, his comforting presence. She wanted her emptiness to once more be filled. She would keep on trying, keep on improving, keep on understanding. She turned her face to the strange rain, feeling it fall on her simulated cheeks.
...
There was something...#emph[soothing]  in that glow. Something buffering the horror, a salve removing the bitterest stings of insanity. But for the warmth and power of the angel's halo, she would have plunged into the gibbering abyss from which there was no return.
...
A small part of the endless white in front of her #emph[wrinkled] , coalesced. She saw a face first, a perfect face, and then below the face a body formed with arms and legs and four wondrous wings, two on a side, unfurled and wide.

#figure(image("004_The Blight We Were Born For/12.jpg", width: 100%), caption: [Angelic Gift | Art by Josu Hernaiz], supplement: none, numbering: none)

It was the angel she had killed twenty years ago. #emph[An infinity ago] , some errant thought whispered. To her great surprise, Tazri started crying.
...
"We are outside of time, Tazri. Outside of the domain of Kozilek. In the throes of Kozilek's field, for you all time was compressed to #emph[now] . It was just the shortest motion to come outside of #emph[now] , to be free of time. You are safe here."

At the mention of the word #emph[Kozilek] , Tazri flinched, though she could no longer remember why. The name struck a chord in her, a ringing of dark bells that thrummed not just through her head but through her entire body, the deepest parts of her bones. She could not tell whether the feeling was great horror or great delight.
...
"No!" The ferocity of Tazri's response took her by surprise. When was the last time she had felt anything so clearly, so strongly? So #emph[purely] .

"The sacrifice was mine to give! You told me there were consequences, and I did it anyway. I paid the price, and I paid it willingly! You cannot take that away from me!" The immensity of what Tazri had lost these twenty years became fully realized. Never to know confidence, or desire, or joy. Never to be fully engaged in the present, striving toward a better future. Never to know #emph[hope] .

She had lost so much. #emph[It was my choice to make!]

"Tazri, you have suffered for an eternity. You have suffered #emph[enough] . You are forgiven."
...
#figure(image("004_The Blight We Were Born For/13.jpg", width: 100%), caption: [Make a Stand | Art by Magali Villeneuve], supplement: none, numbering: none)

Reality was starting to intrude in the white space of Tazri's mind. Kozilek. Ulamog. The titans freed and running amok. Gideon and his friends lost or dead. #emph[How could Zendikar win? How could Zendikar survive?]
...
"You will not remember much from your interlude here. You cannot and still remain whole. But remember this. #emph[You can win. ] You will win. There is no other option." And then that beautiful voice was gone, and reality reasserted itself with rolling thunder and flame.
...
#figure(image("004_The Blight We Were Born For/14.jpg", width: 100%), caption: [Witness the End | Art by Igor Kieryluk], supplement: none, numbering: none)
...
#figure(image("004_The Blight We Were Born For/15.jpg", width: 100%), caption: [Maw of Kozlikek | Art by Daarken], supplement: none, numbering: none)
...
There was a brief moment of doubt. #emph[Who am I to be that leader?]  And then the doubting voice was silent, replaced by a voice twenty years gone, but intimately familiar despite all that time. #emph[I am Tazri. I have bled and battled for Zendikar. I have trained under Vorik for fifteen years, learning the shape and sweep of high command. I am here for my people and my land. I am Tazri, and that is enough.]
...
"Yes, Tazri. Yes. What do you need from me?" Noyan's grief was replaced by anger. Anger and purpose. #emph[Perfect] .
...
#figure(image("004_The Blight We Were Born For/17.jpg", width: 100%), caption: [Allied Reinforcements | Art by Matt Stewart], supplement: none, numbering: none)
...
#emph[General Tazri] ...said in scorn, but Tazri admitted she liked the sound of it. #emph[Time to roll the dice. ] She approached Drana close, put her lips to the vampire's ear, and whispered.

"You are more powerful than I am, Drana. More powerful than probably all of us." Drana's smile turned coy. "Your people talk, Drana. We know what you did, what you can do. But you know while the vampires of Guul Draz follow you, the rest of Zendikar never will. There's too much fear of vampires. Too much fear of #emph[you] . So I will lead. Think of me as a figurehead if you want. We can kill each other later, once all the Eldrazi are dead. But until the Eldrazi are dead, I #emph[am]  going to lead this army. I need your help, though. #emph[Zendikar]  needs your help. Please." Tazri realized she was holding her breath in, and slowly released it. #emph[No more fear. ] Not ever again.
...
When Drana looked back, she was all smugness and superiority again, her wicked smile once more in full display. But Tazri knew it was an act. #emph[Time to push.]
...
Tazri could feel the anger from Drana, could see reality unfolding in many different ways, some of them quite short and bloody ends for herself. But she focused on the outcome she wanted, the outcome she #emph[needed] .

After a long pause, when Drana said simply, "As you command, General Tazri," both of them knew Drana meant it. #emph[At least for now.]
...
Tazri thought about all of it, and discarded it. #emph[This is where I want to be. This is what I was meant to do.]
...
#figure(image("004_The Blight We Were Born For/18.jpg", width: 100%), caption: [General Tazri | Art by Chris Rahn], supplement: none, numbering: none)
