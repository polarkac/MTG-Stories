...
#emph[A better life than mine] . It always came back to that.
...
"You #emph[don’t know] ? What the hell does that mean? Did you cheat or not?"
...
"They’re saying you solved a six-node mana-pressure equation in your #emph[head] . If that’s true, you should be supervising a regulator team, not taking lessons."
...
#emph[Why is it never easy with you?]
...
The guide ring above him began to crackle with flickers of energy—intermittently at first, then more vigorously. Jace was in luck. He smiled and reached into his pack, where he’d stashed some meat pies in anticipation of being sent to bed without eating. #emph[Dinner and a show.]
...
Jace took another bite of his pie. What if someone asked #emph[him]  to solve it? Would he find that he somehow knew this too? He chewed, contemplating. Perhaps. Probably. It seemed so.
...
#emph[Shut up! ] Tuck shoved Jace, sending him skidding across the slick, cold plating of the mage-ring’s roof—toward the edge.
...
"Nobody knows about that," he hissed. "#emph[Nobody] . Not since the bastard died."
...
#emph[As though that would stop me.]
...
#emph["My name is Alhammarret. And you, Jace Beleren, are a mind mage of unusual talent."]
...
#emph["Respond in kind, please, if you can,"]  said the booming voice in his head.

 

#emph["Like this?"]  thought Jace.
...
#emph["A ‘mind mage?’"]  thought Jace. #emph["But doesn’t a mage cast spells? I don’t know any spells."]

 

#emph["What you do is spellcasting,"]  said Alhammarret. #emph["You intuited the spells involved, rather than being taught."]

 

#emph["So if I’m casting spells, then] …#emph[you’re here to make me stop?"]

 

Alhammarret smiled. #emph["No. I want to train you, so you do not have to."]

 

#emph["Train me where?" ] Jace glanced back at his parents. #emph["Here?"]

 

#emph["No,"]  said Alhammarret. #emph["The chance to train a promising mind mage is rare, but not so rare that I can abandon my other duties. You would come with me, as my apprentice."]
...
#emph["Do they know what you’re proposing?"]  he asked.

 

#emph["I’ve spoken with them about it, yes. They want what’s best for you. And in this case, what’s best is to get you out of this provincial backwater so you can grow to your true potential. Yours is a rare gift. Don’t squander it here."]

 

Jace looked back at his parents again. His mother nodded encouragement. His father at least must be relieved. #emph[Education is your ticket out of here.]
...
He looked Tuck in the eyes. #emph["And if you harm my family, I’ll take your mind apart, one squalid little memory at a time."]
...
#emph["That was unkind,"]  said Alhammarret.
...
"You…?" He stopped. Alhammarret hadn’t given him leave to speak normally and, in any case, the wind made spoken conversation impossible. #emph["You heard that?"]

 

#emph["Of course,"]  said Alhammarret. #emph["This is something you must adjust to. Up to now, you have been, in effect, the only mind mage in existence. You’ve never had to consider the implications of dealing with another telepath."]

 

#emph["I’ll keep that in mind," ] said Jace.

 

#emph["I will train you to control your powers. I will help you hone them, to accomplish feats of telepathy you never dreamed possible, to glean deeply hidden information…and to do all this without hurting anyone. If you use these abilities to inflict intentional harm, that will be the end of your training…and possibly, depending on the severity of the harm, your life. Do you understand?"]

 

#emph["Fully,"]  said Jace. #emph["I was just trying to scare him."]

 

#emph["Tread that path carefully,"]  said the sphinx. #emph["In time, you will become more terrifying than you can imagine. And fear, once inspired, can seldom be eased."]
...
#emph["This is Separatist territory, isn’t it?"]  asked Jace.

 

#emph["These lands are claimed by the Trovians, yes. ‘Separatist’ is a politically charged term."]

 

#emph["And you’re an arbiter?"]

 

#emph["I am,"]  said Alhammarret. #emph["So why is the war still going?"]
...
#emph["The war is a generation old,"]  said Alhammarret. #emph["The arbiters negotiate a peace every few years, when both sides are exhausted enough to want it. Then one side breaks the truce, and the war continues. We don’t even bother with permanent peace anymore—it’s simpler, and fairer, if both sides know from the outset when hostilities will resume."]

 

#emph["Why not let one side win?"]  asked Jace.

 

#emph["The Ampryn]  #emph[and the Trovians fight for control of the Core,"]  the sphinx said. #emph["But only one of them holds it at any given time, and that side reaps the benefits of the mage-ring network. So why are the mage-rings unharmed? Why, when the Ampryn]  #emph[hold the Core, do the Trovians not destroy the mage-rings to deny the Ampryn]  #emph[their power source?"]

 

Jace had never thought about that. #emph["Because…Because they think they can take the Core, and they want the mage-rings intact for their own use when they do."]

 

#emph["Precisely,"]  said Alhammarret. #emph["And as long as each side thinks it can win, that balance holds, and the mage-rings stand. Cities are abandoned intact rather than leveled. Roads and bridges are given up, to be recaptured later. If that ever changes—if either side finds itself in existential danger—then it will destroy everything as it retreats, to deny it to the other. Civilization on Vryn might take centuries to recover—if it ever did."]
...
#emph["That," ] said Alhammarret, #emph["not mere loss of life, is what the arbiters seek to prevent. As usual, matters are not as simple as they seem."]
...
#emph["Welcome home, Jace Beleren."]

 

Home#emph[. ] Jace hoped this could be home.
...
#emph["To keep each other honest,"]  the sphinx explained with a twinkle in his eye. #emph["They learned long ago not to send anyone who knew anything they didn’t want spoken aloud."]
...
#emph["Welcome back," ] said Alhammarret. #emph["What have you learned?"]
...
#emph["Excellent work,"]  said Alhammarret.#emph[ "I expect the look on the Trovian ambassador’s face when I mention this at the next negotiation will be…gratifying."]

 

The sphinx turned and padded down the curved steps, past Jace. #emph["Come,"]  he said. #emph["I want to review the maps while your memory is fresh, and mark their exact routes."]
...
#emph[A flood of sensations, of memories, overtook him.]

 

#emph[He was looking down at himself, practicing illusions, concentrating hard to control a few wisps of light and sound. He looked so young.]

 

#emph[Something was wrong. Blue-white energy crackled in his eyes. The illusions swirled around him faster and faster.]
...
#emph[Within the swirling illusions, Jace vanished entirely.]
...
#emph[Alhammarret reached out with a tendril of Æther, into the void between worlds ] (plural!)#emph[, and pulled the boy back.]
...
#emph[Jace stirred. He sat up. He asked what had happened.]

 

#emph[And Alhammarret wiped the incident from the young man’s mind.]
...
#emph["There,"]  said Jace, illuminating a section of the map. #emph["Sorry."]

 

#emph["You’re exhausted,"]  said Alhammarret. #emph["No more bravado. Rest."]
...
#emph[The entire Trovian battle plan for the coming campaign hovered before him, an illusory map that matched the contours of the land to the smallest detail. Their plan was audacious…and without proper countermeasures, it was going to work.]

 

#emph["You’re sure this is genuine?" the general asked.]

 

#emph["Positive," said the hooded figure. "Has our source ever misled you before?"]

 

#emph["No," he said. "Nor the renegades, I’m sure."]

 

#emph["Of course," said the figure. "When your business is information, reputation is everything."]

 

#emph["Of course," he said.]

 

#emph[The hooded man—boy, really, lanky and cocksure—knew much more than he was willing to tell…like the identity of this source. For the good of the Ampryn, he ought to seize the young man, torture the name of this source out of him, and….]

 

#emph["It wouldn’t do any good," said the kid. "He doesn’t tell me much." The boy’s eyes glinted beneath the hood.]

 

#emph["Fine," he said. "Take your payment and go. And tell your source there’s more where that came from, any time he has intel."]

 

#emph["I’ll tell him," said the kid. He pocketed the money and turned, and the general caught a glimpse of his face….]
...
#emph["Ah,"]  said Alhammarret. #emph["I take it you’ve learned something that displeased you."]  The sphinx’s voice in his head was louder now, insistent.
...
#emph["It has. You are more powerful now. You could hurt yourself."]
...
#emph[Ought to report you to the Boros for reckless teleportation.]
...
#emph[Came out of nowhere. Some poor Izzet experimental subject, probably.]
...
#emph[I’m not an experimental subject. I’m…I’m…]
...
#emph[Vagrant. Thief. Poor kid. Wretch.]
...
"I’m from…" #emph[out of town] , he almost said, but he still had no idea what that meant here, "another district. I need a place to stay. I heard you take in people like me."
...
#emph[And who is Jace Beleren? Is he a good man? Is he kind?]
