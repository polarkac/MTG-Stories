...
#figure(image("008_The Family Man/01.jpg", width: 100%), caption: [Art by: Donato Giancola], supplement: none, numbering: none)
...
But Fiero? #emph[Fiero] ? It just didn't make any sense. Guy'd never done a real job, so far as Anhelo heard. He #emph[really was ] just an art dealer, and a bad one, at that.
...
#emph[To Mister Fiero Vespin, in recognition of your contribution to New Capenna's ever-changing fashions, we'd like to invite you to a private tour of the museum] #emph[] #emph[. . .] 
...
#figure(image("008_The Family Man/02.jpg", width: 100%), caption: [Art by: Marta Nael], supplement: none, numbering: none)
...
A moment of silence passed between them, Evelyn sizing him up. "My, what a #emph[predicament] . Of course, I'll help~"
...
No. An artist never compromises. He had time for both. He #emph[was]  both. He could no more slit Fiero's throat in an alley than he could abandon his daughter. It was going to work out, it had to.
...
"Old Capenna? Anhelo, a guy like you, rea—What is #emph[that] ?"

Even a rube like Fiero knew something special when he saw it. And it #emph[was ] something special. Standing twice as tall as Anhelo and twice as wide as Fiero, the Old Capennan Warrior's blade arm was fearsome even in death. A storm of sharp edges, a symphony of metal, Anhelo had never seen anything like it. He had no idea where Evelyn found it, either.
...
#figure(image("008_The Family Man/03.jpg", width: 100%), caption: [Art by: Aurore Folny], supplement: none, numbering: none)
...
#figure(image("008_The Family Man/04.jpg", width: 100%), caption: [Art by: Dan Scott], supplement: none, numbering: none)
...
But even as he danced on the edge of unconsciousness, he didn't let himself give in. Couldn't. Not today. Not with so little time to spare. And Severo had been right about one thing: Anhelo #emph[couldn't]  give him what he wanted.
...
He had fifteen minutes, #emph[maybe] , to make it to the wedding before Errant missed him. He could hardly see, his suit was ruined, he'd killed two people in one day, and every bone in his body ached, freshly broken.
...
He laughed, which only made him cough up blood. "Oh? #emph[You've]  got some regrets? Tell me about it."
...
#figure(image("008_The Family Man/05.jpg", width: 100%), caption: [Art by: Justine Cruz], supplement: none, numbering: none)
