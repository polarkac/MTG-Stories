...
#figure(image("232_Episode 2: Dirty Laundry/01.jpg", width: 100%), caption: [Art by: Muhammad Firdaus], supplement: none, numbering: none)
...
"#emph[Sheesh] , anyone ever told you to keep your eyes forward?" The leonin stood and left her behind.
...
Elspeth wrapped her arms around him, holding her friend in equal measure. The fur around his neck tickled her nose and cheek, bringing a smile to her lips. Happiness. Relief. #emph[Safety] . It had been so long since she'd last felt such pleasant emotions that it was a wonder she could still feel them at all.
...
"After defeating Bolas, I came here to meet with Karn and the Gatewatch to discuss the Phyrexian threat. But there will be time for business later." Ajani shook his head, as if dismissing the notion. "#emph[How]  are you here?"
...
"Elspeth, how are #emph[you] ? You might be one of the strongest people I know. But I cannot imagine the toll on your body and spirit of what you've been forced to endure. The upheaval when all you've wanted for so long is stability. And Daxos~I know how much he meant to you."
...
"I can encourage you to #emph[keep your eyes forward] . Look to the future. Don't let the demons of your past consume you."
...
"I didn't come to you for a lecture." She pushed away from the bench, wrapping her arms around herself and stalking away. #emph[Look within. Find peace, then find home. It's not a place.]  The words stuck with her, uncomfortable. She couldn't escape them with a few steps; she might not be able to escape them ever. She needed to get away, clear her head, and hope to gain new perspective from the distance.
...
Ajani continued anyway. "While you were—" he clearly struggled with the word "dead" and said instead "—#emph[gone]  I continued your search for home~" He inhaled deeply, as if bracing himself. "I found it."
...
#emph[Should I intervene?]  No, it wasn't her business. For all she knew, the shopkeeper had done something to merit this fate. She should just ignore it and—
...
#figure(image("232_Episode 2: Dirty Laundry/02.jpg", width: 100%), caption: [Art by: Jodie Muir], supplement: none, numbering: none)
...
He glared, leaning toward his subordinate, their noses almost touching. "#emph[I'm]  in command here, and we do not attack people unless I say so."
...
Her knuckles met metal. Plate protected the woman's abdomen, hidden underneath the finely tailored coats she wore. The Maestro grinned widely, putting her fangs on display.#emph[ On top of everything else, vampires. Perfect.]
...
He fired at her sudden movement but telegraphed his aim. Elspeth dodged, closed the gap, and rendered him unconscious with a #emph[thud] . The rush of the fight began to fade, and Elspeth relaxed her stance, checking on each of them. She did not envy the ache they'd feel when consciousness returned~but at least they were all breathing. She didn't really want to kill anyone, and the last thing she needed was the Maestros out for vengeance against her.
...
"Your '#emph[responsibilities] ' are lucky all I had was this stick." She kept it at his throat. One jab at his windpipe, and he would collapse. Though Elspeth had no more interest in killing him than she had in the others.
...
"Why do you think #emph[I]  would want it?" Elspeth asked carefully, trying to phrase the question to give away as little as possible. If his eyes narrowing slightly or his gaze becoming more curious than conniving or hungry was any indication, she failed.

"You're not from around here."

"Of course I am." Elspeth shrugged and continued walking.

His footsteps were hasty behind her. "No, #emph[no] ~anyone from New Capenna knows exactly why they'd want Halo. There's always a reason to covet it." He looked at her with new eyes. "You wear the fashions of New Capenna, but you're clearly not one of us."

#emph[Not one of us.]  How many times would she be identified as the odd one out? As the one who didn't belong? It never became easier. Every time, the sentiment cut deeper than the last.
...
#figure(image("232_Episode 2: Dirty Laundry/03.jpg", width: 100%), caption: [Art by: Aurore Folny], supplement: none, numbering: none)
...
"Elspeth, #emph[huh] , you're a few generations out of date for a name like that." He chuckled and continued to follow her as the street opened to a square between buildings. A fountain bubbled at its center. Elspeth slowed to a stop, staring up at the figures that crowned the carvings of the fountain.
...
"While you were—" Ajani clearly struggled with the word "dead" and said instead "—#emph[gone]  I continued your search for home. I found it."

"What?" Elspeth spun in place, her sole focus on him once more. Her heart hammered. #emph[Home.]  The place she had left when she was a child and had never been able to find again.
...
"Exactly." Ajani grabbed her shoulder as she moved to leave. "Before you go~promise me you'll think about what I said. I know this mission will be partly personal, and I hope you find what you're looking for—what you #emph[need] —in New Capenna. But please, remember that nowhere will be truly home until you've made peace with your past. You've killed a god, you've overcome death, you've accomplished so much, Elspeth. If you can fight all that, then you can also fight for yourself and find the security you're looking for within you."
...
#figure(image("232_Episode 2: Dirty Laundry/04.jpg", width: 100%), caption: [Art by: Vincent Proce], supplement: none, numbering: none)
...
The Adversary considered this and let out a bark of laughter. #emph[Really.]  The Font was #emph[that] ? Pathetic. So much power, so ripe for the taking, and the Cabaretti were practically asking for it to be stolen.
...
#grid(
    columns: (1fr, 1fr),
    gutter: 2em,
    figure(image("232_Episode 2: Dirty Laundry/05.png", height: 40%), caption: [], supplement: none, numbering: none),
    figure(image("232_Episode 2: Dirty Laundry/06.png", height: 40%), caption: [], supplement: none, numbering: none),
)
