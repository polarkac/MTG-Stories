...
Property Item 1: Qty 3 – Coin chains, silver. Valued at 69 zinos#linebreak() Property Item 2: Qty 1 – Orzhov charm, lapis lazuli with crystal sunburst. Valued at 155 zinos#linebreak() Property Item 3: Qty 7 – Thrull face masks, gold plated. Valued at 109 zinos#linebreak() ~
...
Today was my first refusal. The citizen in question tried to argue with me that the new thirty-percent requisite tithing was too much. It used to be ten percent, he said, as far back as he could remember. I gently explained that it #emph[was]  still ten percent—the first ten percent going toward defense and war management, the second ten percent going to social services and infrastructure, and the final ten percent going to Orzhova to compensate the Obzedat and the Oligarchs for their valuable time, but he didn't want to hear that. I presented him with the opportunity to make up the other twenty percent in debt promises if he needed to, but then he started cursing the guild, saying that our guildmasters had better get their greedy hands out of his pockets before he did something about it.
...
#emph[He's ] the one who refused to pay. I was just doing my job.

#v(0.35em)
#line(length: 100%, stroke: rgb(90%, 90%, 90%))
#v(0.35em)

#strong[Date: The 24th of Dhazo]

#strong[Location: Prosperity Estates]
...
Property Item 1: Qty 3 – Brass knuckles, spiked. Valued at 37 zinos#linebreak() Property Item 2: Qty 12 – Small censers, silver with gold trim. Valued at 155 zinos#linebreak() Property Item 3: Qty 1 – Communications earpiece, Dimir, enchanted. Valued at 109 zinos#linebreak() ~
...
Only I couldn't. I know it was the whole reason Father pushed me into the profession. #emph[An honest day's work for an honest day's skimming ] he'd say with a laugh. But taking people's money didn't bring me joy, even if our family needed it, because all those families out there had so much less than we did. So I got a second job assisting a fleshmage. Making thrulls isn't the most glamorous line of work, but it pays well, and I'm good at it. If my parents ever find out, I'll never hear the end of it—how flesh magic is beneath our station, and if the spirits in our family ever found out~gods help us all.
...
#strong[Date: The 11th of Prahz]

#strong[Location: Oligarch's Row, South]
...
Property Item 1: Qty 4 – Cluestones, enchanted. Valued at 67 zinos#linebreak() Property Item 2: Qty 2 – Sigils, tainted. Valued at 55 zinos#linebreak() Property Item 3: Qty 12 – Quart of human blood, pasteurized. Valued at 109 zinos#linebreak() ~
...
Something interesting #emph[did]  happen working for Fleshmage Jarek today. I was busy rendering a corpse, when I heard him in the reckoning room.
...
#figure(image("004_The Ledger of Hidden Fortunes/02.jpg", width: 100%), caption: [Camaraderie | Art by: Sidharth Chaturvedi], supplement: none, numbering: none)
...
#strong[Date: The 26th of Prahz]

#strong[Location: Penance Place]
...
#strong[Date: The 7th of Mokosh]

#strong[Location: Initiates' Compound]

I'm #emph[here] ! Selesnyan orientation.
...
#figure(image("004_The Ledger of Hidden Fortunes/03.jpg", width: 100%), caption: [Plains | Art by: James Paick], supplement: none, numbering: none)
...
#strong[Date: The 12th of Mokosh]

#strong[Location: Conclave Assembly]
...
~But that is not the Selesnyan way. To make matters worse, the seamstress would only trade the robes for a copper tea kettle or bandu-filed pruning shears. I figured a tea kettle would be easier, since I had no idea of what bandu-filed pruning shears were. I went to a metalsmith who wanted four pairs of knitted socks for the tea kettle. The only knitter nearby wanted three pounds of white wolf fur. (I didn't dare inquire what it was to be used for.) I found a wolf-rider who was infirmed and wanted his pup walked in trade. I walked the wolf (#emph[sooo]  not a pup). Gave the fur to the knitter and the socks to the metalsmith. I was really getting the hang of bartering, though I'd spent nearly my entire morning running errands instead of studying, and let me tell you, my personal aura was #emph[ripe] .
...
She smiled the kindest smile and said, "But what use would I have for #emph[two ] tea kettles?" And from inside her home, I heard a kettle whistling, traded to her by some other customer not twenty minutes prior. My head ached. My heart did, too.
...
Every year, he would head home with empty pockets and a big grin stretched across his face, saying how he was #emph[that ] #emph[close]  to winning it all, and how one day there would be nothing I could ask for that he wouldn't be able to give me, and then he'd pinch my ear and gasp at how he'd found one last coin tucked behind it.
...
#strong[Date: The 13th of Mokosh]

#strong[Location: Initiates' Compound]

Today we learned a growth spell. My podmates all seem to have found "the gift" and were able to conjure seeds into healthy plants. Me, I just spent my time praying to the ancestor spirits for something to happen, #emph[anything ] to happen, before the elder came back from his meditations and saw my sad terracotta pot filled with nothing but dirt.
...
This artifact would be worth #emph[millions ] to Orzhov. Tens of millions. Maybe more. Our family would be pulled out of despair, and the pride my father would have for me would shine as brightly as the sun.

#v(0.35em)
#line(length: 100%, stroke: rgb(90%, 90%, 90%))
#v(0.35em)

#strong[Date: The 14th of Mokosh]

#strong[Location: My Bedroom]
...
#figure(image("004_The Ledger of Hidden Fortunes/04.jpg", width: 100%), caption: [Crown of Convergence | Art by: Jen Page], supplement: none, numbering: none)
...
#strong[Date: The 29th of Mokosh]

#strong[Location: Oligarch's Row, North]
...
Property Item 1: Qty 3 – Runes, enchanted. Valued at 67 zinos#linebreak() Property Item 2: Qty 1 – Sigil, very tainted. Valued at 75 zinos#linebreak() Property Item 3: Qty 12 – Flagon of bat guano. Valued at 205 zinos#linebreak() ~
