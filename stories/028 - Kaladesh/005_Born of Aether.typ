...
#emph[The aetherborn of Ghirapur are a race of pleasure-seekers and adrenaline junkies. With a lifespan of up to four years, they consider the city their natural habitat and parties their playground. Although their lives are short, they also possess empathic abilities that allow them to experience the energies of those around them.]

#emph[Yahenni, an investor, philanthropist, and socialite, knows their life is near an end. When they host one of their fabulously over-the-top parties before the Inventors' Fair, three unexpected guests arrive seeking dangerous knowledge.]

#v(0.35em)
#line(length: 100%, stroke: rgb(90%, 90%, 90%))
#v(0.35em)

#figure(image("005_Born of Aether/01.jpg", width: 100%), caption: [Art by Jonas De Ro], supplement: none, numbering: none)
...
What kind of host looks like a thrown-together mess sixteen hours into their own party? Hosts who are #emph[failures. ] That's who.
...
Forget substances and adrenaline—#emph[parties ] are the finest vice. I relish the sensation of my guest's pleasure. I have no idea what eating a roasted animal feels like, but I imagine it's something like that. I indulge in my hosting duties, and my guests bloom with praise.

My dear friend and ace pilot Depala (#emph[the]  Depala!) sits relaxed and easy on a more private couch. Her hyena rests at her side, happily gnawing a bone while Depala toys with a golden leash.

#figure(image("005_Born of Aether/02.jpg", width: 100%), caption: [Art by Greg Opalinski], supplement: none, numbering: none)
...
Three women stand outside the entrance to my flat. Mrs. Pashiri I know instantly (one of the most famous inventors in the world, as well as the fiercest board game enthusiast I know). To her right is a young red-headed woman in an out-of-fashion wrap (that style is from#emph[ years]  ago— does she go outside?).

On the other side is the most fascinating person I think I've ever seen.

#figure(image("005_Born of Aether/03.jpg", width: 100%), caption: [Art by Willian Murai], supplement: none, numbering: none)

Her eyes are endless, a brilliant green from center to lid, a vivid beauty that is betrayed by an uncomfortable stance. It is tragic for someone who #emph[looks ] so interesting to be so tense. Her dress is decorated with brilliant flowers (are those real?) and cut in a way that it could fit only her. Had I any interest in romancing persons, I would be tempted, but to me her allure is strictly in terms of social gain. My goals as a host are to make my guests happy, of course, but being seen palling with interesting people is always a bonus.
...
I hold open the door for the elf. "#emph[Gorgeous]  eyes, darling," I compliment as Nissa enters. She smiles tightly.
...
"#emph[It's my penultimate party!] " they yell with enthusiasm. The motley group heaves the chair and moves the living wake up the stairs toward the roof.
...
Chandra places her hands on the table with purpose and stands. "#emph[Welp] . I'm going to start asking around. Nissa—"

"I'm fine," the elf replies softly. Her energy is cold and bitter with unease. She is #emph[not ] fine, so I decide to intervene.

"Nissa, was it? Follow me; you #emph[must ] tell me where you found that ensemble."
...
#figure(image("005_Born of Aether/04.jpg", width: 100%), caption: [Blighted Gorge | Art by Jung Park], supplement: none, numbering: none)
...
"We #emph[are ] the city. I'm made of aether, and one day, I'll return to it. Nature is all around us, it just may look different than what you're used to."
...
#figure(image("005_Born of Aether/05.jpg", width: 100%), caption: [Art by Wesley Burt], supplement: none, numbering: none)
...
"So you came into my party—#emph[my house] —without an invitation?"
...
#figure(image("005_Born of Aether/06.jpg", width: 100%), caption: [Art by Ryan Yee], supplement: none, numbering: none)
...
I inhale the wafts of perfume lingering in the air. As the other aetherborn continues to dissipate, their energy mingles with the spilled attar. I've seen many of my kin in their dying moments, and it is almost always with an air of triumph. They fought and kicked and scratched and reveled in the glory of #emph[life] , and here they are at the finish line.
...
In that instant I am filled with envy. I have so little time left. My life, this aetherborn's life, #emph[all the lives ] of my kind are spent chasing and cramming as much experience as we can into a pathetically small span of time. It isn't fair that we have to burn so fast.
...
What if I left the party and went out? What if I hunted down the Consulate filth that detained this aetherborn and gave them what they had coming? I'd drained essence (once, accidentally) before; it felt #emph[amazing] . I could do that again. I could do that again a hundred times over, if someone deserved it.
...
"I'm hosting the party of a lifetime here after the conclusion of the Inventors' Fair. I expect each and every one of you to be there, and tell everyone you know that they would be #emph[fools]  to miss out."

They cheer. I feel like I could live for ten more years.

"Enough of that, though. You all don't want to hear more about #emph[me] , right?"

The party screams, "#emph[Of course we do!] "

"#emph[Well too bad!]  I'm sick of talking! Get on the floor, turn the music up, and somebody open another cask for everyone in here with a liver!"
