...
#emph[Chandra and Nissa went looking for Chandra's mother Pia, using Mrs. Pashiri's Kaladesh contacts. But instead of finding Pia, they found themselves trapped]  #emph[in an underground Consulate prison facility. Only the timely arrival ] #emph[of the leonin Planeswalker, Ajani, saved them from having to make a deadly choice. Liliana has left without the others, concerned about Tezzeret's presence on Kaladesh, while the rest of the Gatewatch, Jace and Gideon, remain on Ravnica.]
...
#figure(image("008_In This Very Arena/01.jpg", width: 100%), caption: [Rakdos Ringleader | Art by Jason Felix], supplement: none, numbering: none)
...
#emph["The Guildpact is a—] " was the thought front-and-center in Ral's mind, followed by a colorfully vulgar and startlingly visual torrent of phrases.

Jace sighed audibly.

Ral muffled a laugh. #emph["Just testing if you could really read my thoughts."]

#emph["Test successful,"]  Jace thought. He faced the stage, eyes on the Rakdos performers. Just a regular audience member, cloaked in noise. "#emph[We could have done this back at the Hall of the Guildpact, you know. Unless you really wanted to take in a show] ."

#emph["All your official visitors there are recorded and tracked,"]  Ral thought. #emph["Not safe."]

So Ral wasn't here as a concerned member of the Izzet guild. He wanted to talk to Jace as a Planeswalker. #emph["What is it, then?"]

#emph["An irregular planeswalk." ] Ral's mind paused, either to let that sink in or to come up with how to form the next thought. #emph["Someone planeswalked away from Ravnica in a manner that was...anomalous.] "

#emph["What? Who? How do you know this?"]

#emph["You've seen the clouds outside, Beleren. Don't make me do all the work."]

#emph["] Project Lightning Bug#emph[?"]

#emph["There you go."]

Jace furrowed his brow. #emph["I thought that was shut down after we sabotaged the results."]

#emph["It was, officially." ] Ral's thoughts coiled in on themselves. Images of magically-created lightning storms and sensitive sensor mechanisms swam through his mind, along with memories of conjuring careful half-truths while Niv-Mizzet's hot breath bore down on him.

Jace couldn't help tilting his eyes to the side, to see Ral's expression. Worry lined the man's forehead.

Ral's mind continued. "#emph[The detectors still trigger when someone planeswalks. I glance over the results from time to time, but mostly I keep them hidden from Niv-Mizzet and most of my guild. I reached out when I saw Vraska's planeswalk."]

Jace was deeply un-thrilled to hear the gorgon's name.

#emph["She left Ravnica," ] Ral thought, "#emph[with no destination."]

#emph["No destination?"]

#emph["She didn't planeswalk ] to#emph[ a plane. Only from one."]

#emph["That doesn't make sense."]

#emph["Exactly."]

#emph["A flaw in the detectors?"]

Ral gave an impatient flick of his hand. "#emph[The experiment performed perfectly. The pattern of the departure was authentic, but the endpoint recorded as anomalous. Vraska hasn't been seen since. It's like she planeswalked into a void."]
...
#figure(image("008_In This Very Arena/02.jpg", width: 100%), caption: [Homing Lightning | Art by Slawomir Maniak], supplement: none, numbering: none)

#emph["That's fascinating," ] Jace thought at him. "W#emph[ait. Are you saying you can still see when I leave Ravnica?"]

#emph["First to Zendikar, then off to Innistrad, was it?" ] Ral was still watching the performers, but his elevated eyebrows were all for Jace's benefit. "#emph[So, will you be staying long this time? Or should we expect you to leave Ravnica without its Guildpact again soon?"]

#emph["That's... Uh... Ral, listen—"]

Ral stood up to leave. #emph["Anyway, I thought you'd want to know. Vraska was none too fond of you, last I heard."]

#emph["I—Thank you. Ral, wait."]
...
#figure(image("008_In This Very Arena/03.jpg", width: 100%), caption: [Art by Dave Kendall], supplement: none, numbering: none)
...
Finally it read: "NOON TOMORROW!"

"Chandra," Nissa said softly.

"He's calling me out," Chandra said. "I have to face him."

"He is. But we just got out of one trap..."

"My mother is alive. That's all there is."
...
"Where's the courier?" Consul Kambal snapped.
...
She flashed a look at him in horror, but remembered that his was a liar's face. She stared back out at the arena, and bit words through her teeth one at a time. "If you harmed a #emph[hair..] ."

"We'll have to see, won't we?" Baral asked. "#emph[Will]  she be here? When Tezzeret humiliates you out there, will she come for you?"

#emph[Just stay away, daughter, ] she thought.#emph[ Please, do as your mother says, this once.]
...
#emph[What did ] that#emph[ mean? ] A cold feeling swirled in her gut.

The announcer was calling her to the floor. "And now, friends and citizens, his opponent," the voice boomed. "She's the convicted aether criminal who failed to destroy #emph[your]  Inventors' Fair...Pia Nalaar!"
...
#figure(image("008_In This Very Arena/04.jpg", width: 100%), caption: [Fateful Showdown | Art by Chris Rallis], supplement: none, numbering: none)
...
She glanced up. Tezzeret was already rooting through his pieces. He had something with legs half-built already. #emph[So fast!]
...
Tezzeret had already built some silvery crawler of some sort. It unfurled, rising taller than him, displaying an undercarriage of sharp pincers and legs. The crowd clapped furiously. #emph[How did he make that from the provided parts? Is he even ] trying#emph[ not to cheat? ] The thopter orbited Tezzeret, slicing around his head with its stinger. He batted it away effortlessly as he sent the crawler toward her.

#figure(image("008_In This Very Arena/05.jpg", width: 100%), caption: [Art by Izzy], supplement: none, numbering: none)

She quick-fashioned a rudimentary servo, welding its plates into place even as it scurried away toward the crawler. The crawler scuttled forward and tore into the servo, ripping it apart. But Pia had embedded a surprise—a small detonator. The servo burst in a small sphere of smoke and pieces, and blew the legs off the crawler. A huge reaction from the crowd. #emph[Maybe I can do more than delay the inevitable. Maybe I can win.]
...
#figure(image("008_In This Very Arena/06.jpg", width: 100%), caption: [Art by Izzy], supplement: none, numbering: none)
...
#emph[He's not just playing to the crowd] , she thought. #emph[He's going to kill me] .
...
#emph["How many times have I told you, Jace?" ] Chandra thought back. "#emph[Least. Favorite. Words!] "
...
"#emph[We have to understand what's behind his presence here," ] came Jace's urgent thoughts. "#emph[Keep him occupied!"]
...
"That's just what he wants!" her mother snapped. "Leave me and go. #emph[Now] , young lady."

"I'm not young anymore," Chandra snapped back. "And I'm #emph[not]  losing you again!"
...
"But #emph[here] ?" Tezzeret cooed. "In #emph[this]  #emph[very ] arena? Do you dare face me in the #emph[same place]  where you were once about to be—"

"YES," Chandra insisted. "I get it. Where I was about to be executed. Very poetic. Now can we #emph[please fight] ?" She focused on a spot on her palm, and a ball of fire grew in her hand.
...
#figure(image("008_In This Very Arena/07.jpg", width: 100%), caption: [Dramatic Reversal | Art by Eric Deschamps], supplement: none, numbering: none)
...
"#emph[Chandra," ] came Jace's voice in her head. "#emph[I think his automatons are still blocking my telepathy somehow. You've got to get us in closer.] "

"#emph[Blow up metal things] ," Chandra thought. "#emph[Got it] ."

#figure(image("008_In This Very Arena/08.jpg", width: 100%), caption: [Art by Raymond Swanland], supplement: none, numbering: none)
...
Tezzeret staggered back, and for the first time Chandra thought she saw a hesitation before his next assault. She thought at Jace. "#emph[Have you read him yet?] "

"#emph[No," ] Jace thought, his mental state coming through like a swear word. "S#emph[omething's still blocking me] ."

"#emph[Hurry up!] "

"#emph[He's too closed off] ," Jace responded. "#emph[We've got your mother. I think we should go.] "

Chandra looked at her mother, and back at Tezzeret. "#emph[I think I should end this. Right here.] " The flame on her fist extended down her arm, and her vision blurred with fire.

Jace's thoughts had a tone of warning. "#emph[Chandra, if he knew to block his mind, it means he was prepared for this. He knew all of us were coming. We've made a mistake...] "

Chandra's fist closed, compressing fire into a tiny point of blinding, seething heat. Her teeth clenched, and she trembled. #emph["I could just..."]

Liliana's thought carried through the telepathy clear and sharp: "#emph[End him] ."

A stark shadow passed over the arena, and Chandra looked up to see the airship #emph[Skysovereign]  eclipse the sky. Its majestic bulk spanned the entirety of the arena, hovering with a droning churn of internal engines. An enormous turret swiveled on its underside, crackling with aether, its cannon aiming down—not firing, but threatening to fire.
...
#figure(image("008_In This Very Arena/09.jpg", width: 100%), caption: [Cathartic Reunion | Art by Howard Lyon], supplement: none, numbering: none)
...
"The inventions. They're gone."

"What?" Pia and Ajani said simultaneously.
...
Ajani snarled low. "He's #emph[building something] ."
