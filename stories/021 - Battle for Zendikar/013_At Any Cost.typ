...
#show: doc => conf(
    ...
    story_date: datetime(day: 25, month: 11, year: 2015),
    author: "Nik Davidson",
    doc
)

#emph[Ob Nixilis is having a bad day.]

#emph[Things had been going so well. He'd seized the power of the relocated Khalni Heart, and with it forged a connection to the raw mana of Zendikar. He was finally ready to tap into Zendikar's hedron network and restore his Planeswalker spark—and then disaster struck, in the form of the elf Planeswalker Nissa Revane.]

#emph[Nissa took Khalni Heart from the demon would-be Planeswalker, repaired her own connection with Zendikar, and collapsed tons of rock and soil on him.]

#emph[It was a setback. But Ob Nixilis had not gotten this far by giving up.]
...
#figure(image("013_At Any Cost/01.jpg", width: 100%), caption: [Nissa's Renewal | Art by Lius Lasahido], supplement: none, numbering: none)
...
#figure(image("013_At Any Cost/02.jpg", width: 100%), caption: [Sire of Stagnation | Art by Tyler Jacobson], supplement: none, numbering: none)

Time. I needed more #emph[time] !
...
#linebreak I clawed through the dust for more than a day before I found what I was looking for: a hedron no larger than my head, intricately carved, and alive with power. It was the keystone in the hedron network I had created—just the thing to use to bind Ulamog and diminish its power. I looked upon it again with some amount of awe. There was room in my loathing of Nahiri to admire her genius. To create something of such power, and contain that power in an object that could survive for millennia or more! If Nahiri had not returned to help forestall Zendikar's destruction, it almost certainly meant she was dead. It made me a little sad, truly, that I would never get the chance to face her again.
...
#figure(image("013_At Any Cost/03.jpg", width: 100%), caption: [Lithomancer's Focus | Art by Cynthia Sheppard], supplement: none, numbering: none)
...
#figure(image("013_At Any Cost/04.jpg", width: 100%), caption: [Aligned Hedron Network | Art by Richard Wright], supplement: none, numbering: none)
...
I needed a moment to take it all in. I couldn't keep the grin off my face. The network was huge. The Zendikari had accomplished with brute force what had taken me decades to complete through care and subtlety. By using the gigantic, structural hedrons, they were able to tap into the energy of the entire #emph[plane] —my work with Khalni Heart was essentially a scale model of what they had done. The alignment was rough and amateurish, even by my dabbler's standards, but it was stable.
...
#figure(image("013_At Any Cost/05.jpg", width: 100%), caption: [Demon's Grasp | Art by David Gaillet], supplement: none, numbering: none)
...
#figure(image("013_At Any Cost/06.jpg", width: 100%), caption: [Ob Nixilis Reignited | Art by Chris Rahn], supplement: none, numbering: none)

I laughed. I had not felt joy like this before, not ever. No triumph, no glory was greater than this. Beings of power... beings of power #emph[want to be called] ! With my spark reignited, it was the easiest thing in the world.
