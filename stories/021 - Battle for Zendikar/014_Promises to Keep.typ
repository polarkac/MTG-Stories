...
#emph[MY INSPIRING ORATION]

#emph[BY ABBOT NALAAR]
...
#emph[This is the life you've chosen] , she reminded herself.

She had made a promise. No matter what was happening on Zendikar, no matter how much they might need her, no matter how #emph[freeing]  it might be to be part of that battle. This was her role now.

#figure(image("014_Promises to Keep/01.jpg", width: 100%), caption: [Mountain | Art by Sam Burley], supplement: none, numbering: none)
...
#emph[This is what keeping a promise feels like] , she told herself. #emph[You're not a child anymore. This is taking—] she balanced herself against the doorframe with one hand and forced herself to think the next word—#emph[responsibility.]
...
#emph[Just one peek] , she thought.

She pressed her will against the whereness around her, forcing it to change. #emph[Zendikar] .
...
#figure(image("014_Promises to Keep/02.jpg", width: 100%), caption: [Skyline Cascade | Art by Philip Straub], supplement: none, numbering: none)
...
Chandra followed Gideon's eye line. One of the larger hedrons, hovering over the water, was #emph[moving] . In fact, she could see teams of figures guiding it along the surface of the water, hauling it through the air with heavy ropes and nudging spells. Kor ropeworkers along the seawall pulled on their guidelines, shepherding the hedron gradually into place.
...
#emph[They're doing it] , she thought. #emph[My friends are doing it. They've come here, and they're helping. They're saving this world] .
...
#figure(image("014_Promises to Keep/03.jpg", width: 100%), caption: [Skyrider Elf | Art by Dan Scott], supplement: none, numbering: none)
...
The manta rider began a wide turn to double back to Chandra's position. Chandra only had moments before the scout's sharp eyes would discover her. Chandra wasn't here to stay. #emph[Just one peek.]
...
#figure(image("014_Promises to Keep/04.jpg", width: 100%), caption: [Eyeless Watcher | Art by Yohann Schepacz], supplement: none, numbering: none)

#emph[Eldrazi] . These were Eldrazi. The creatures that afflicted this world, that Gideon and Jace had asked for her help in fighting.
...
#figure(image("014_Promises to Keep/05.jpg", width: 100%), caption: [Flames of the Firebrand | Art by Steve Argyle], supplement: none, numbering: none)
...
#emph[That's it. That's all I came for. Just to know they're safe. Just to know—that they don't need me.]
...
In the first rays of predawn, she could see that the giant shape on the horizon #emph[moved] . It slowly undulated its limbs, which meant it had #emph[limbs] . Its twin jawbones shone pale and jagged in the night.

It wasn't just looming. It was #emph[approaching] . It was heading toward Sea Gate, toward Gideon and the others, carving its death-path across the world. It threatened to destroy all life in its way.

The creatures she had fought—those were insignificant compared to this monstrosity. This—Ulamog—#emph[this]  was what the true battle was about. #emph[This]  was what caused that death-dust smell that was new to the world, and what her compatriots were risking their lives to confront.

#figure(image("014_Promises to Keep/06.jpg", width: 100%), caption: [Ulamog, the Ceaseless Hunger | Art by Michael Komarck], supplement: none, numbering: none)
...
"Chandra?" Mother Luti scolded. "Are you #emph[ready?]  The Address! The chants have already started!"

Chandra's mouth hung open.

"You will #emph[not]  shirk your responsibilities here, Abbot Nalaar," said Mother Luti. "You will #emph[not]  break your promise." With that, Mother Luti stormed off down the corridor.
...
#emph[MY INSPIRING ORATION] , the top page read, scrawled in her own hand. #emph[BY ABBOT NALAAR.]
...
#emph[This is what it feels like to keep a promise] , she thought.
...
"Look," she said. "When I came here as a child, I was a mess. I had no idea what to do with #emph[this]  thing, at all." She raised her hand, and it blossomed with fire. She shook her hand and the fire went out again. "The people of this place—Abbot Serenok, Mother Luti, all of you—you #emph[showed]  me. You didn't try to control me. You didn't try to change me. You taught me how to express who I was in my own way."

She looked out at the dozens of individual faces before her. "If there's anything I can do to repay that favor, it's to encourage you to do the same thing. Each of you is a separate, individual #emph[you] . You are not the fire-monks of Keral Keep, not really. You are not the devotees of the teachings of Jaya. You are not here to listen to me or any other abbot. You are a unique person, with wild ideas about what's truly important. You're only here because it's a place where you're allowed to find out #emph[who you are] ."

#emph[Am I really saying this] , she thought. #emph[Am I saying what I think I'm saying? ] Chandra looked for Mother Luti's face, but couldn't find her in the crowd anymore.

"I'm sorry to those I'm disappointing right now," Chandra continued. "But the best way I know to honor the tradition of the Mount Keralia Address is to tell you to #emph[stop listening]  to this Mount Keralia Address."
...
#figure(image("014_Promises to Keep/07.jpg", width: 100%), caption: [Chandra, Roaring Flame | Art by Eric Deschamps], supplement: none, numbering: none)
...
"I #emph[do]  have a responsibility!" Chandra shouted. She jabbed a finger into the air, pointing anywhere. "There are people suffering out there right now, and I can help them. I can #emph[help] . I can't stay here and repeat exercises endlessly, knowing that I could go out and #emph[use]  what you've taught me to prevent a disaster."

Mother Luti's face suddenly glowed with quiet pride. "#emph[Now]  you're certain," she said softly. "Congratulations, Chandra."
...
"That's what #emph[you]  needed to #emph[know] ."
...
#figure(image("014_Promises to Keep/08.jpg", width: 100%), caption: [Ob Nixilis Reignited | Art by Chris Rahn], supplement: none, numbering: none)

#emph[Demons laughing] , she thought. #emph[Never good news.]
...
#emph[What else could go wrong today?]
...
#emph[OF COURSE] , she thought. #emph[WHY NOT? WHY NOT THIS NOW?]
...
#figure(image("014_Promises to Keep/09.jpg", width: 100%), caption: [Art by Lius Lasahido], supplement: none, numbering: none)
