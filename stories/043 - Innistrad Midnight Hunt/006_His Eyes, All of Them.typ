...
#show: doc => conf(
    ...
    story_date: datetime(day: 17, month: 09, year: 2021),
...
#figure(image("006_His Eyes, All of Them/01.jpg", width: 100%), caption: [Vadrik, Astral Archmage | Art by: Kieran Yanner], supplement: none, numbering: none)
...
#emph[Old StickfingersTerror-bringerKnows when children disobey]

#emph[If you're slackingHe's attackingDid you do your chores today?]
...
#emph[Old Stickfingers'sPresence lingersInside every hollow tree]

#emph[Don't sneak outOr you'll shoutAnd no one will remember thee]
...
#figure(image("006_His Eyes, All of Them/02.jpg", width: 100%), caption: [Rem Karolus, Stalwart Slayer | Art by: Francisco Miyara], supplement: none, numbering: none)
...
#figure(image("006_His Eyes, All of Them/03.jpg", width: 100%), caption: [Abandon the Post | Art by: Zoltan Boros], supplement: none, numbering: none)
...
#figure(image("006_His Eyes, All of Them/04.jpg", width: 100%), caption: [Old Stickfingers | Art by: Jehan Choo], supplement: none, numbering: none)
...
"#emph[Every time you break my skin] ," the new woman sang, her voice perfect, nearly angelic, "#emph[I will break another man.] "
...
Rem nodded, clearly uncomfortable with not running toward trouble, but surprisingly, willing to accede to the crone's command. "Stickfingers cannot be sent to some home, to some other place," Malynn said, "because he is from #emph[here] . A hearth spirit."
...
"#emph[Tall man, long man, will you guard this home?] " she sang, as she spun it. "#emph[Protect the one who calls, who dwells here all alone?] "

#figure(image("006_His Eyes, All of Them/05.jpg", width: 100%), caption: [Novice Occultist | Art by: Zara Alfonso], supplement: none, numbering: none)
...
"#emph[Old Stickfingers, of the alders, take this goat in lieu of me.] " Ariosa knew quite a bit more of the summoning than Vadrik had guessed.

"#emph[Aval vine lord, old destroyer, harm you none without my plea.] "
...
#emph[Sticky StickHe killed VikDon't go nearDon't go near]

#emph[Mister SticksHas lots of tricksHe can hearWhen you fear]

#emph[Old dame HilginLost her childrenWhere've they beenWhere've they been]

#emph[Old Stick BuddyIn the muddyDragged them inWears their skin]
