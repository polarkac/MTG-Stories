...
#show: doc => conf(
    ...
    story_date: datetime(day: 25, month: 05, year: 2016),
    author: "Mark Price",
    doc
)

#figure(image("001_The Prodigal Sorcerers/01.png", height: 40%), caption: [], supplement: none, numbering: none)
...
#figure(image("001_The Prodigal Sorcerers/02.jpg", width: 100%), caption: [Prodigal Sorcerer | Art by Eric Deschamps], supplement: none, numbering: none)

#emph[Deep breath. In control. Say the words. Clear the—]
...
#emph[Don't look there, look up. See it.]
...
#emph["Ashkara nix pulu..." ] The focus began to glow softly in his hand, his adrenaline rising with each perfected syllable.#emph[ "Sarko mar benosk..." ] Next an orchestrated gesture, like a grand symphonic conductor. #emph["Kahuga Duru..."]  Now, resolution.#emph[ "Tanare!"]
...
From the pirates, a double boom sounded—a heartbeat of iron and thunder. In an instant, he saw them: two cannonballs linked by a chain of crackling energy, spinning around each other like a bolo, so fast he could barely make them out. What make of magic was #emph[this] ?
...
#figure(image("001_The Prodigal Sorcerers/03.jpg", width: 100%), caption: [Prodigal Sorcerer | Art by Douglas Schuler], supplement: none, numbering: none)
...
"'#emph[Snap to] ' means get off your ass and help me before we sink."
...
Enthril shook his head. "I'm fine. Smart bastards. Waited until the last second to show their colors, #emph[Talas]  colors, and surprise. And with that, my curiosity with regards to their fancy new weaponry is permanently satisfied."
...
#figure(image("001_The Prodigal Sorcerers/04.jpg", width: 100%), caption: [Academy at Tolaria West | Art by James Paick], supplement: none, numbering: none)
...
"Control #emph[is]  the illusion."

The young man turned away from the bulkhead and looked Enthril square in the eye.

"What do you mean?"

"Boldt..." the old man began, with the slight edge that reminded the young apprentice that he'd never actually introduced himself to the ship mage—or any of the crew, for that matter. "That's all I wanted to do. Control the results, control the outcome. I left as an academy graduate, confident I'd be a great master and find my fortune—#emph[take]  my fortune. But all this ambition, all this mastery, in the face of true wisdom? It's like trying to tie waves against the beach."

If there was any regret in Enthril's eyes, he didn't let it show. He continued working the seams of the hull.

"Out here, I've learned to let subside my thirst for power and glory. To see myself as a conduit, a steward for something greater than myself. A #emph[custodian] ." He held up his trowel, covered in black tar, to punctuate the thought. "And I've learned you can know the heart of something without having to possess it."
...
"I'm fighting them with #emph[this] ?"
...
What were the words again? #emph[Avenkari ] was the root. He knew it, what was it?
...
"What the hell are you #emph[doing] ?" Boldt exhaled, barely concealing his panic. "We're about to get blown to kindling, and—"

"Don't speak. Don't command. #emph[Ask] ."

"But—"

"Boldt, the essence of it is there, waiting to help you. Find what's ready. When you see it, you'll know what to do."

"But I #emph[don't]  see it, that's what I'm trying to—"

"You'll know."

"#emph[Damn it, I don't see it!] "
...
#figure(image("001_The Prodigal Sorcerers/05.jpg", width: 100%), caption: [Island | Art by Adam Paquette], supplement: none, numbering: none)

"Enthril?"

Finally he uttered, "The Dire Waves. This is what #emph[worse]  looks like."
...
"All right," said Boldt, "#emph[Now ] what do we—"
...
#figure(image("001_The Prodigal Sorcerers/06.jpg", width: 100%), caption: [Scourge of Fleets | Art by Steven Belledin], supplement: none, numbering: none)
...
#emph[Find it. See it. See what? Never mind, just—]

And then the voice in his head, the voice of control, suddenly, inexplicably stopped. Or more accurately, shifted. Because he could finally #emph[see]  it.
...
#figure(image("001_The Prodigal Sorcerers/07.jpg", width: 100%), caption: [Eternal Dominion | Art by Shishizaru], supplement: none, numbering: none)
...
#figure(image("001_The Prodigal Sorcerers/08.jpg", width: 100%), caption: [Island | Art by John Avon], supplement: none, numbering: none)
