...
#emph[Cho-Akhan is a caretaker for the dead, living with her family in a small Cho-Arrim village in the depths of the Rushwood. Life in the village is quiet and peaceful, and the long arm of Mercadia City seems impossibly far away…]
...
#figure(image("002_All That Came Before/02.jpg", width: 100%), caption: [Horned Troll | Art by Christopher Moeller], supplement: none, numbering: none)
...
The troll was big, and very angry. Clods of dirt scattered down the incline and off the little earthen shelf over ‘Akhan’s head. She buried her face in the dead leaves. #emph[Go away,]  she thought insistently. #emph[Go away, go away, go away.]

After what felt like an eternity or two, the sound of the troll’s footsteps receded, tromp-tromping off through the trees and underbrush. #emph[Probably stomped all over my herbs, too] . That would figure. ‘Akhan moved into a crouch, brushing the worst of the dirt off of her clothing. She had just readjusted her bag on her shoulder when something caught her eye.
...
#figure(image("002_All That Came Before/04.jpg", width: 100%), caption: [Goldenglow Moth | Art by Howard Lyon], supplement: none, numbering: none)
...
#figure(image("002_All That Came Before/06.jpg", width: 100%), caption: [Cliffside Market | Art by Matt Stewart], supplement: none, numbering: none)
...
‘Akhan raised an eyebrow. "Shamans? Shamans just read the harvest and bless the hunt. Read nice words when people die. That sort of thing." #emph[They don’t push ceramic pieces into their skin] .
...
#figure(image("002_All That Came Before/08.jpg", width: 100%), caption: [Island | Art by Martina Pilcerova], supplement: none, numbering: none)
...
#emph[At least she’s got weird moths to remember her. Give her a light to see by…]
...
#emph[His journey] . The words soured against the back of ‘Akhan’s tongue, unspoken and bitter. There would be no garden, now. Mother ‘Fihad stroked her son’s hair, still damp with old sweat. "The river will guide him true," she said. "It will take him to rest."

A furry brown moth, trapped inside the house, battered against the ceiling, looking for a way out. ‘Akhan watched it struggle, feeling helpless and angry. "There’s nothing special about that river," she snapped. "‘Ran is #emph[dead] ." And then, quieter: "He’s not coming back."
...
The moth continued to struggle, its small body slamming into the ceiling again and again. ‘Akhan wanted to scream. #emph[There’s a window] , she thought. #emph[It’s right there. Just fly down, and you’re free.]

#emph[Just fly down.]

The mask leapt into her thoughts. The dead shaman’s mask, down down down under the ground, lit with old knowledge and a whisper of dusty wings. #emph[She would have seen this] , ‘Akhan thought. #emph[If she really did have power, if Mom is right, she would have seen this coming. Wouldn’t she?]
...
#figure(image("002_All That Came Before/10.jpg", width: 100%), caption: [Dismal Backwater | Art by Sam Burley], supplement: none, numbering: none)
...
#emph[Rushwood is afraid.]

#emph[Mercadia does not come here.]
...
She slumped against the dirt wall, exhausted. "Why?" she whispered between dry lips. #emph[Why did this happen? Why are we dying? Why are you here with your mask and your secrets, watching my world fall apart?]

She closed her eyes.

#emph["The Cho-Arrim don’t remember,"]  said a voice in her head. #emph["They knew, once. How to be many."]
...
#emph["The mask has power," ] came the voice again. #emph["You make it with pieces of your world. You become a reflection of your people." ] A hesitation. #emph["You lose yourself, though. You make yourself into a picture of everyone else, but it covers you."]
...
The voice sounded sad, when it spoke again. "#emph[It is always a great loss when a family loses a child.] "
...
#emph[For ‘Ran. For my mothers. For the Cho-Arrim.]
...
#emph[Mercadia is coming] , she thought through the haze of juddering power. #emph[Mercadia is coming, and mother ‘Shadi will try to drive them back.]
...
In the moment before she submerged, she thought she could see the surface of the water softly glowing. #emph[River full of souls] , she thought. #emph[Mother ‘Fihad would want me to cover my eyes] .
...
#emph[Oh, there you are] , she thought instead. She wished ‘Fihad could see. All of the ashes poured into the river, all of the rites…it wasn’t empty at all.

A lump formed in her throat. #emph[I thought you were gone. All of you, I thought you were gone.]
...
#figure(image("002_All That Came Before/12.jpg", width: 100%), caption: [Ancestral Mask | Art by Magali Villeneuve], supplement: none, numbering: none)

#emph[No, I need that…] she thought. More souls brushed against her, knitting her flesh and pushing out the mask. #emph[Stop, you can’t…]
...
"‘Akhan, what #emph[happened] ? Who did this to you?"
...
The Mercadians were expecting to find a single, weakened village, full of sickness and ripe for the taking. They were not expecting to find every Cho-Arrim that had ever called Rushwood their home. They were not expecting a #emph[fight] .

#emph[Won’t they be surprised?]
