...
#figure(image("005_Wool Over the Eyes/01.jpg", width: 100%), caption: [Inspiring Vantage | Art by Jonas De Ro], supplement: none, numbering: none)
...
The audience murmured as the person (#emph[the aetherborn?] ) drew back the cloth over the concealed object, revealing an ornate golden box.

"This is the aether regulator, an instrument #emph[not ] for the energy regulation of aether-consuming devices, but for aether-made #emph[people] . It is a medical device that will ease uncomfortable symptoms of dissipation and allow aetherborn persons a more dignified, pain-free transition back into the aether cycle!"
...
#figure(image("005_Wool Over the Eyes/02.jpg", width: 100%), caption: [Saheeli Rai | Art by Willian Murai], supplement: none, numbering: none)
...
The woman's eyes darted back and forth. She leaned in even closer. "#emph[Off of plane ] out of town?"
...
"#emph[Ixalan] . I haven't heard of that one before!" Saheeli smiled. "What is it like?"

Huatli paused. How could she describe her home to someone who had never seen it before?

#emph[The only way I know how.]

"It is a land as bright as the sun.#linebreak The air, thick with light,#linebreak And the soil, dark with life.#linebreak Endless trees coat endless vistas,#linebreak And dinosaurs answer the songs of my people."
...
"No, but I'd love to make one!" Saheeli grinned and pulled Huatli up off the bench. "We are going back to my workshop #emph[right now]  so you can describe them to me. I've been needing a new artificing project!"

Huatli allowed herself to be dragged up and smiled in response. "Can I help?"

"Of course you can! You're the expert. I need to know #emph[everything ] about dinosaurs!"
...
A little plume of smoke was rising from his foundry. A hand-painted window on the outside read "OPEN" in blocky lettering. The building was little more than a shack on the far end of town, but it had been #emph[his]  shack on the far end of town. Piles of iron and metal were stacked outside, and a number of items and weapons were hung on a rack, each tagged to mark which order was which.
...
#figure(image("005_Wool Over the Eyes/03.jpg", width: 100%), caption: [Pools of Becoming | Art by Jason Chan], supplement: none, numbering: none)
...
Nicol Bolas investigated every corner of her mind with a scrutiny she could #emph[feel] . He peered into each corner of her memories of Ixalan and replayed them all in the blink of an eye. Vraska winced at the feeling. It was like having her insides scrubbed clean.
...
#figure(image("005_Wool Over the Eyes/04.jpg", width: 100%), caption: [Highland Lake | Art by Noah Bradley], supplement: none, numbering: none)

bravely diving into the river that ran through the city . . .

#figure(image("005_Wool Over the Eyes/05.jpg", width: 100%), caption: [Resplendent Griffin | Art by Sam Rowan], supplement: none, numbering: none)

watching as a sphinx rampaged through Orazca . . .

#figure(image("005_Wool Over the Eyes/06.jpg", width: 100%), caption: [Sphinx's Decree | Art by Daarken], supplement: none, numbering: none)

and standing atop the Immortal Sun to turn said sphinx—along with dozens of other enemies—into gold.

#figure(image("005_Wool Over the Eyes/07.jpg", width: 100%), caption: [Golden Demise | Art by Deruchenko Alexander], supplement: none, numbering: none)
...
Nicol Bolas practically #emph[beamed ] with joy#emph[.]

His claws curled in pleasure.

"#strong[Well done, Vraska] ," he said. "#strong[You will be rewarded for your loyalty.] "

Vraska bowed, her mind her own once again, and felt the weight of something manifest in her pocket.

"#strong[A gift, faithful servant. You have earned a kingdom of your own design.] "

"Thank you for your trust."

"#strong[The thanks are all mine. I would very much like to work with you again in the future.] "
...
#emph[Captain is safe, but far away, ] Jace thought, choosing his words carefully. #emph[I'm leaving for a while, but need you to tell the crew how much you all meant to me.]

#emph[You'll always be a crewmate, Jace] , said a gentle tenor voice in Jace's mind. #emph[You were an excellent pirate.]

#emph[Who says I'm going to stop now? ] Jace thought with a grin. #emph[Raise hell, Malcolm.]
...
A thought halted Jace's inner momentum. #emph[What am I supposed to say when I meet the Gatewatch?]

Jace began to panic. #emph[Do any of them know Vraska? What if they're in the middle of something? What if they have already left for somewhere else and I can't find them to tell them about Ravnica? What if they went back to Innistrad, or Kaladesh, or Zendikar? What if they're with Ugin?! What the hell am I supposed to say to Ugin?! "Hey, so about your friend, you know, the one you haven't talked to in a thousand years; he's on an island now because he's terrible. Also, you were trying to use me to lure Bolas to Ixalan to be imprisoned, weren't you? What stopped you on Tarkir? Has ] everything#emph[ you've ever done actually just been about defeating Nicol Bolas? If so, we're going to need you to step up."]

Jace felt incredibly small. None of these questions would help him now. None of his hand-wringing would protect his home. He made a choice to set his questions aside. Ravnica must come first. He #emph[was]  the Living Guildpact, but he was more than that, too. Jace's mouth tilted in a half-smile#emph[. I am someone who devises a plan so a pirate captain can sabotage a dragon. ] That #emph[is who I am.]
...
#figure(image("005_Wool Over the Eyes/08.jpg", width: 100%), caption: [Omniscience | Art by Jason Chan], supplement: none, numbering: none)
...
#emph[How is he moving like that?!]
...
He couldn't see his destination, of course, but he had the general idea of the size and shape of the thing he was aiming for. What gave Jace pause was the fact that Gideon appeared to be traveling at a #emph[very]  high velocity. He swore and adjusted his vector once more. #emph[WHAT IS HE TRAVELING ON?]
...
#figure(image("005_Wool Over the Eyes/09.jpg", width: 100%), caption: [Looming Altisaur | Art by Lars Grant-West], supplement: none, numbering: none)
...
Despite Huatli's insistence on a peace agreement, Apatzec knew what was #emph[his] . He had immediately sent a battalion of his strongest knights to clear the city, and was now on his way to claim it in the name of the Sun Empire.

The mission had gone off without a hitch. The city was empty. The River Heralds hadn't even #emph[tried] .
...
#figure(image("005_Wool Over the Eyes/10.jpg", width: 100%), caption: [Rekindling Phoenix | Art by Jason Rainville], supplement: none, numbering: none)
