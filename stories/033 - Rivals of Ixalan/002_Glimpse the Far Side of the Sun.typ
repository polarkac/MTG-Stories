...
#show: doc => conf(
    ...
    story_date: datetime(day: 17, month: 01, year: 2018),
...
#figure(image("002_Glimpse the Far Side of the Sun/01.jpg", width: 100%), caption: [Radiant Destiny | Art by Emrah Elmasli], supplement: none, numbering: none)
...
The priest sighed. "Huatli, one day you will fight with a blade in your hand and speak with the power of the sun. What is on the far side doesn't #emph[matter] ."
...
The other young warriors #emph[aww] -ed in a chorus of disappointment.

The priest sighed. "Name the things you #emph[can]  see. Glorify the things you have done, and don't waste time on the unknown."
...
#emph[The empire is what matters] , she asserted to herself. #emph[Not whatever exists beyond the sun.]

#v(0.35em)
#line(length: 100%, stroke: rgb(90%, 90%, 90%))
#v(0.35em)

#figure(image("002_Glimpse the Far Side of the Sun/02.jpg", width: 100%), caption: [Blood Sun | Art by Emrah Elmasli], supplement: none, numbering: none)
...
Angrath was eyeing Huatli. "What do #emph[you ] get out of it?"
...
Angrath looked at her over his shoulder. "You need a title to do that? You think like an #emph[ant] ."
...
The minotaur was #emph[chuckling] . Huatli bit her tongue. He smiled at her as much as a minotaur could. "And what of the River Heralds? Doesn't their history deserve to be remembered?"

"Well . . . yes. I suppose it does. But the warrior-poet doesn't study theirs . . ."

"You're killing each other over who is powerful enough to decide what history #emph[is] . You argue and spit to decide who will rule, but no one is truly free. Who are you to say that you are right, fool?"
...
#emph[Sun above, he is rude] , Huatli thought with irritation.

The minotaur stilled, and Huatli felt a sudden bloom of heat in front of her. The minotaur was casting a spell. #emph[No, something different] . As a glow like that of warm coals began to illuminate Angrath's body from within, she realized he meant for her to follow in a way she had only tried once before.
...
#figure(image("002_Glimpse the Far Side of the Sun/03.jpg", width: 100%), caption: [Skybreen | Art by Wayne England], supplement: none, numbering: none)
...
#emph[I'm seeing what is on the other side of the sun] , Huatli thought to herself with a grin.
...
#figure(image("002_Glimpse the Far Side of the Sun/04.jpg", width: 100%), caption: [Elenda, the Dusk Rose | Art by Chris Rahn], supplement: none, numbering: none)
...
"Draped in the shadow of the East they came#linebreak In search of a treasure lost to time#linebreak The prickled rose, crusted blood smeared 'Adanto' on our south#linebreak Drinkers of life, devourers of names."

Angrath was quivering with anger and impatience. "We don't have time for chitchat, Huatli. We need to take the Immortal Sun so we can #emph[leave] ."
...
Huatli spat her words with vitriol. "To take what is not theirs. What did you #emph[think]  they came here for?"

"To retrieve the one thing that #emph[is ] ours," Elenda replied in a measured but angry tone. "And to leave all else in peace. That was our most holy mission."

Angrath growled. "You ought to tell the rest of your cronies that. Huatli, let's #emph[go] ."
...
The vampire bared her teeth. "I left the Church with the knowledge of the ritual to take on my burden, and they used that to become #emph[invaders] ?"

Huatli glared. "What were they meant to do with your gift?"

"They were meant to learn #emph[humility] ."

Huatli's jaw fell open. The Legion of Dusk? #emph[Humble] ?

#emph["] They were meant to search for salvation for us #emph[all] ," Elenda continued. "I see I must teach them what they forgot."
...
"She's a living #emph[saint ] who I wanted to give a #emph[piece of my mind] !"

"#emph[You swapping stories is not worth me wasting any more time!] "
...
(Gold scales. Sandstone. Heat. Rough sand on his lips and in his eyes and in his throat. Broken, doomed friends. He was trying to break into a dragon's mind. Sense what the dragon's plan was, stop him from doing harm, and for a brief moment, #emph[he had done it] , he saw the goal, the endgame—)
...
#figure(image("002_Glimpse the Far Side of the Sun/05.jpg", width: 100%), caption: [Zetalpa, Primal Dawn | Art by Chris Rallis], supplement: none, numbering: none)
...
#emph[I hope she is alive, ] he thought to himself.
...
#figure(image("002_Glimpse the Far Side of the Sun/06.jpg", width: 100%), caption: [Azor's Gateway | Art by Yeong-Hao Han], supplement: none, numbering: none)
...
Jace scanned the room again and froze. He did not know who was inside, but he instantly knew #emph[what ] was inside. This person's mind was familiar, labyrinthine, a mind like only one he had ever encountered before.

#emph[Was Azor a sphinx? ] he asked Vraska in her mind with hushed terror.
...
#emph[You'll never be hurt by a sphinx ever again, ] she said with resolution. A cruel hint of amber flashed in her eyes.

Jace could have hugged her there and then. He remembered her preferences, and settled for a thankful smile.

#emph[I'll start charging to petrify] , Vraska said. #emph[Give me the word and he's dead.]
...
#figure(image("002_Glimpse the Far Side of the Sun/07.jpg", width: 100%), caption: [Azor, the Lawbringer | Art by Ryan Pancoast], supplement: none, numbering: none)
...
"I am Azor, the Lawbringer," he growled, tipping his head as he stared at Vraska. "And you will be a prisoner for the third time in your life, #emph[gorgon] ."
...
#emph[He is so much like Alhammarret] , Jace thought, his chest tightening with the ache of memory. He stowed his fear. He was not ruled by a sphinx. Not anymore.

"You will refer to her as #emph[Captain] ," Jace said in a measured tone.
