...
#figure(image("276_Arcavios: A Radiant Heart/01.png", width: 100%), caption: [Art by: Alexey Kruglov], supplement: none, numbering: none)
...
#figure(image("276_Arcavios: A Radiant Heart/02.png", width: 100%), caption: [Art by: Dmitry Burmak], supplement: none, numbering: none)
...
#figure(image("276_Arcavios: A Radiant Heart/03.png", width: 100%), caption: [Art by: Dmitry Burmak], supplement: none, numbering: none)
...
#figure(image("276_Arcavios: A Radiant Heart/04.png", width: 100%), caption: [Art by: Eelis Kyttanen], supplement: none, numbering: none)
