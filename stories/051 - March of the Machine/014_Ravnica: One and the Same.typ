...
#figure(image("014_Ravnica: One and the Same/01.png", width: 100%), caption: [Art by: Leon Tukker], supplement: none, numbering: none)
...
#figure(image("014_Ravnica: One and the Same/02.png", width: 100%), caption: [Art by: Artur Nakhodkin], supplement: none, numbering: none)
...
#figure(image("014_Ravnica: One and the Same/03.png", width: 100%), caption: [Art by: Alex Brock], supplement: none, numbering: none)
