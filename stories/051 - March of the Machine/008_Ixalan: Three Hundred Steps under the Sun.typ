...
#figure(image("008_Ixalan: Three Hundred Steps under the Sun/01.png", width: 100%), caption: [Art by: Viktor Titov], supplement: none, numbering: none)
...
#figure(image("008_Ixalan: Three Hundred Steps under the Sun/02.png", width: 100%), caption: [Art by: Ryan Pancoast], supplement: none, numbering: none)
...
#figure(image("008_Ixalan: Three Hundred Steps under the Sun/03.png", width: 100%), caption: [Art by: Zezhou Chen], supplement: none, numbering: none)
