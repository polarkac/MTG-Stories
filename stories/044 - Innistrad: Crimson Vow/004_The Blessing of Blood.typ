...
#show: doc => conf(
    ...
    story_date: datetime(day: 05, month: 11, year: 2021),
...
#emph[The war is not over. Far from it. We thought the nightmares had been defeated, but something else has come, something far more powerful and evil. It's hard to explain. So much has happened. I will try to make sense of it for you as best I can.]

#emph[The vampires fought side by side with us. They wanted to save this Plane like we did. But I couldn't help thinking, "To what end?" To make slaves of us all? Food? But there was no time to think of the future, only the present. Only the present enemy that must be destroyed. We'll have to deal with them when this is all over.]

#emph[Among the fallen are the archangels, Bruna and Gisela, who were slain by their own sister and our last archangel—Sigarda. I cannot describe to you what this madness had truly done to them. They are gone now. And you are probably wondering why I have not mentioned Avacyn. She is dead, too.]

#emph[With the aid of Saint Traft, I was able to wield her divine spear and help defeat the first of the nightmares. But whatever it is that has followed. . .] #emph[it was strong enough to force the Saint out of me and leave me prey to the madness. I barely escaped with my life.]

#emph[Odric, you are the best of us, and we need you to lead us. We need your help to stop this. Before it is too late. I am on my way to you. And I will bring those cathars still loyal to the light with me.]

#emph[Please, do not forget who you are and have always been. We were all deceived at one time. I pray to see you soon.]

#emph[Your dearest friend,]

#emph[Thalia]

#figure(image("004_The Blessing of Blood/01.jpg", width: 100%), caption: [Thalia, Guardian of Thraben | Art by: Magali Villeneuve], supplement: none, numbering: none)
...
The revelation from him turned Odric's despair into unmitigated rage. He drew his sword, still glowing with angelic moonlight, and glared at the symbol of the angel emblazoned at the hilt. #emph["You—have—betrayed—us!"]  A moment later, he found himself hacking the altar to pieces, destroying every holy plant, relic, and artifact in sight.
...
#emph["Hide!"]  he ordered urgently to the man and child. They immediately rose from the pew and ran into a closet near the back of the building.
...
He whipped around, bending the light with him and sending it into the darkened door. The beam landed upon two soldiers, both wiping the monks' blood from their shimmering blades. Odric beheld them with surprise, as they stepped forward. Their faces were like stone with eyes flashing, without remorse for those they had just slain. #emph[Cathars murdering the innocent. . .and clergymen no less? ] Avacyn's madness had spread a greater distance than he thought.
...
"#emph[Leave?] " Henrika chuckled. She spun around gleefully, allowing her golden gown to dance in wild circles. "No. They are going to stay right here in this fine house of worship where they belong. Though I'd hardly call it #emph[fine ] myself. I have a mansion with thirty rooms, drenched in silken cloths, hewn out of marble, and an army of familiars to do my bidding." She shrugged playfully. "But demons, like angels, are gluttons for ceremony."
...
#figure(image("004_The Blessing of Blood/03.jpg", width: 100%), caption: [Vampire's Vengeance | Art by: Chris Cold], supplement: none, numbering: none)
...
"#emph[Domnathi ] is what we prefer to be called~"

"Never heard of you," Odric spat at her. "Yours must be one of those inferior bloodlines." The ever-present smile left Henrika's face for a moment. His tactic had worked as he knew it would. #emph[That is what she wants. ] He surmised immediately. #emph[What all minor vampire houses want—Supremacy.]

"#emph[Inferior]  is a word that denotes weakness and stupidity, cathar." She allowed her tongue to linger on her lips after her last rebuttal. "We kill the weak and stupid~"

"But spare the strong and willing." Odric stepped forward, another tactic in mind—#emph[make her feel small and the whole truth will expose itself.]  "So that they can be soldiers in #emph[his]  army." There was a stirring among the cathars in the windows as he approached her. "But you're not their leader as you seem to boast. These damned men and women are not marked for you. They are not familiars you can control. You are simply an errand girl~"
...
"Olivia Voldaren!" shouted Thalia. "Lady of Lurenbraum, progenitor of the Voldaren line, made a pact on behalf of all vampires on Innistrad. She agreed—she #emph[promised] —no vampire bite or blade would draw human blood until the war was over. She and the other vampires are still fighting out there. All other bloodlines are fighting so that this Plane can survive. You #emph[must]  honor that!"

"Unless that demon blood took all sense of honor, too," Odric added fiercely.

Henrika's eyes narrowed on Odric so sharply that she could have torn away his flesh with her stare. "I don't believe, Sir Odric, we #emph[inferior]  bloodlines were included in their lot~"
...
"But she means something to you, does she not, #emph[human] ?" She extended her finger and brought it to the girl's throat.
...
#figure(image("004_The Blessing of Blood/04.jpg", width: 100%), caption: [Hero's Downfall | Art by: Chris Rallis], supplement: none, numbering: none)
...
"MADAM HENRIKA!" came a cry for across the room, and all eyes turned in its direction. The pale Domnathi who had left the group was now standing in the middle of the room. Black veins were snaking up his neck like vines and had marred his face. His skin was smoking, charring in places, as if he were burning from the inside. #emph["Something is. . .something is wro—!"]
...
#emph["Blessed water—?!" ] she screamed in disbelief. #emph["There is blessed water in your blood—?!"]  The revelation was cut short, as the point of a thin sword speared her through the side.
...
#figure(image("004_The Blessing of Blood/05.jpg", width: 100%), caption: [Odric, Blood-Cursed | Art by: Chris Rallis], supplement: none, numbering: none)
