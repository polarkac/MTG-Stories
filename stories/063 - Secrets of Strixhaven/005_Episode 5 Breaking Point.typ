...
"Episode 5: Breaking Point",
    ...
    story_date: datetime(day: 28, month: 03, year: 2026),
...
She didn't quite #emph[plan]  what she would say; planning had never really been her thing. But she did run through the conversation in her head. When she could, at least. Often the blaring headache got in the way, or the memories, or the things that weren't memories but felt like them.

#emph[You always treat me like a child. I'm impulsive, but I'm not dumb.]

One step.

#emph[You never trust me. Haven't I proved myself enough to you?]

Another.

#emph[I've been teaching almost as long as you have.]
...
#emph[Please, just trust me on this. Trust me when I say that it's bad.]
...
Ajani caught her by the hood of her cloak. Once more she felt it welling up, the words she wanted to say. #emph[Thank you, but you didn't have to do that.]
...
#emph[Even if I was the one that hurt it.]
...
"You like interrupting, don't you? At least we're in agreement. No, it's not what's important—it's just a detail I needed you to know. What's important is that #emph[this]  archaic is the last. Someday it will be the last of #emph[my]  kind, the last oracle. So, you can imagine my surprise when I saw them in distress."
...
"But what if the archaic #emph[is]  his plan?" Chandra said. Then, far more quietly, "I'm begging you. Just stand aside."
...
Jadzi nodded. "Don't start your little fires until you know what's going to burn." She began to pace again. "There are so many unknowns we still have to contend with. What's causing this, yes, and why? But also #emph[how] . How it's being done, how we might undo it. The future of a plane is a complicated thing. You say that your friend is somehow behind this—"
...
"#emph[I]  get to decide who my friends are, Ajani," Chandra said. "You don't." She rubbed at her temple as another wave of migraine pain came over her. "I'm sorry, Oracle. Go on."

Jadzi looked between them. It seemed as if she might say something, but the words were lost in another wail from the archaic. Ajani's chest ached; the sound was so high and keening, it made his teeth feel as if they would jump out of their sockets. There was an awful #emph[lurch]  rippling through the cave. A #emph[wrongness] . For a moment he wondered what he was doing here with—
...
Now, as they scrambled to help her, she could strike. She'd fallen right in line of sight of the archaic. Staring at it, she felt a strange kinship echo between them—a weakness. Neither of them could hold on for much longer with the way things were going. Looking at that great eyeless face, she had the thought: #emph[it can only be one of us.]
...
"Are you #emph[that]  committed to this path, Chandra?" roared Ajani. "Violence is only going to make this worse. We need to work together if we're going to fix this."
