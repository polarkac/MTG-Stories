...
#show: doc => conf(
    "Episode 4: Something to Offer",
    set_name: "Secrets of Strixhaven",
    story_date: datetime(day: 26, month: 03, year: 2026),
...
Kirol slapped at their sternum. "I'm glad #emph[someone]  is listening to my advice!"

One of the most vital parts of solving any problem was knowing when to stop trying. If you kept bashing your head against a wall of equations, you were only going to end up sleepless and incomprehensible. Kirol was #emph[at least]  as stubborn as a wall. At least.
...
#emph[I wish I had more to share] , signed Abigale. Her signing was broad and expressive—sometimes she did that with new faces. It was a bit like raising her voice so they could hear her better. #emph[We're in a chamber of some sort—that much is obvious. But there are at least two dozen ways out of here, maybe more. I counted only the ones that were plainly visible. It's possible, even likely, that there are some we can't see, thanks to the roots or the rocks.]
...
#emph[Owlin have good vision, but not that good] , signed Abigale. She paired this with a very flat look to their vampire friend.
...
#emph[Who says chum? Who]  pulls off #emph[saying chum?]  If Kirol weren't so charming, they'd be the most annoying person in the Multiverse. But … Lluwen liked that about them. An adolescence filled with the pursuit of perfection had no need of people like Kirol.

#emph[But this new life I'm leading? This place where people can be strange and unique and wonderful?]
...
Something rose up in Lluwen's chest. #emph[Would any of my hunting pack have made a sacrifice like that for me?]
...
#emph[What are the others up to? Why did I agree to hang back?]  She should be out there with them. #emph[What if they get to Jadzi first? What if they charge ahead?]  Kirol would, and Lluwen would go along with them. Proving himself a hero was a surefire way to gain the approval of the other students, and it might go a long way toward fixing his reputation.
...
Kirol wasn't mad. #emph[I could never be mad! Lluwen is my best friend! Of course I'm not mad. What possible reason could there be for such a thing?]
...
#emph[Alone, alone, alone.]  The word rang over in her mind. It was foolish to dwell on any of this. Unreasonable. What was the point? What was the point of her hackles rising, of the pit in her stomach?
...
#emph[Let go] , he thought. #emph[It's fine. Elves from back home don't live that long anyway.]
...
"Of course you didn't. You're not a #emph[fool] ," answered Professor Fel. "Let me handle this. Out of the way!"
...
"You're not thinking," he said. "You're just acting. Acting #emph[rashly] ."
...
An unbidden flashback to the Grand Prix press: #emph[Chandra Nalaar, hero of the Multiverse.]
...
"Trying to … incarnate into it, maybe. I'm not sure. The memories are … it's all jumbled. Sometimes I can't tell what's mine and what's his." There was #emph[one]  easy way to tell, but she didn't need Ajani to know how much she now knew about Vraska.
...
Churning in the pit of her stomach. She didn't #emph[want]  things to be this way. But if he had just listened to her from the get-go, if he had let her attack the archaic when they'd had the chance …
...
"But if it does," he said, "promise you'll #emph[think]  before you start blasting away. You're better than that now. Wiser."

"No promises," she said. If she had blasted the archaic, they wouldn't be in this mess. If she had blasted #emph[Jace]  rather than try to talk him down, her head wouldn't be so screwed up.
