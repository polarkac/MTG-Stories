...
#show: doc => conf(
    "Episode 2: Travels and Travails",
    set_name: "Secrets of Strixhaven",
    story_date: datetime(day: 24, month: 03, year: 2026),
...
#emph[Do the lumarets I saw have schools, too? Maybe they favor some kind of private tutoring? The first one had a map, so that means they must have some system of writing, and some system of sharing it. But what is it like?]
...
Ivarin turned away from the others. He gathered himself up and stared right down at Lluwen. "I #emph[asked]  if you wanted to #emph[graze] , ram-clan."
...
No, they called for Fel instead. Soon, everyone was calling for the professor. He was there before Lluwen could even find his footing, a presence that sprang forth like an arrow from the dark. #emph[Something]  pinned the back of Lluwen's coat to the base of a tree. When he looked up at it, he saw that it was … a thorn. A massive, hand-sized thorn.
...
"Why does he get care?" Lluwen snapped. He couldn't stop himself from that, either. "He called me ram-clan. He's been tormenting me for #emph[weeks] . But I strike back, and now #emph[I'm]  the problem?"
...
He took a step forward. Maybe there was something to this creature that was moving around? Fel seemed to want to know what it was in specific. #emph[Which]  way …
...
#emph[This has got to be something no one else has ever seen] , he thought. While his gaze followed the lines of the archaics' hands, he tried to remember if he'd ever heard of anything like this. Not that he'd been here very long. But it had to be unique, right? People would have written about this.

Professor Fel couldn't brush #emph[this]  away. No. It was way too big.
...
It didn't stop him. It #emph[couldn't] .
...
#emph[I can't give up here. What would Kirol say?]

Lluwen tried to picture his friend at the top of this makeshift rope. Even if no one else doubled back for him, he knew Kirol would have. #emph[Come on, Lulu, you're almost there!]
...
Lluwen's fear bubbled up inside him again. When he blinked, he saw the faces of the archaics overlaid on Fel's—the eyeless eyes, the mouthless mouth. The echoes of the strange chant he'd heard became Fel's words: #emph[don't waste my time.]
...
#letter_block(border: true)[
    ...
    I'm so sorry to hear of your troubles. And I'm sorrier to say that I had some of my own. There was a bit of a translation error the other day. When I meant to say, and what I #emph[did]  sign, was a polite request for one person to speak at a time. And it turned out that some Arcavian signs resemble rude gestures to Kamigawans. It took all day to sort out the misunderstanding. But on the bright side, I've learned a lot about Kamigawan culture.
...
How could he speak to Jadzi like that? Still, whatever he'd been talking about earlier felt #emph[personal] . A thing not meant for everyone's ears. Certainly not an errant student. Lluwen wasn't sure whether he wanted to melt away into the gloaming or if he wanted to hold this secret precious as fresh dew.
...
People said the name Kasmina on campus the same way Lluwen's clanmates used to whisper #emph[Oona] . What he knew about the situation wasn't much—some gossip about the first class of interplanar students like himself and Tam—but it was enough that Jadzi's comparison hit him like a rock to the temple.

#emph[This is bad. I shouldn't be here] , he thought.
...
Lluwen imagined himself doing it. His tongue stuck to the roof of his mouth. #emph[I saw the archaics, too.]  Start easy.
...
#emph[Are you sure this must be done, Teacher?]

#emph[It's a hopeful thing to ask that kind of question. I wish that I could—]
...
#emph[But it's fine] , she told herself. Lluwen was lonely. Jadzi must have sensed that about him. Probably didn't even need magic to see it, either, with the way he'd been skulking about recently. If you called his name, he was just as likely to flinch as he was to smile.
...
She looked up at him, and she wondered, wished, hoped he would ask. That #emph[anyone]  would ask. Because of her powers, the odds were often in her favor—even if she wasn't actively manipulating them. Not today, though.
...
Tam steepled her fingers. #emph[That certainly complicates things, doesn't it?]  She ran through the options in her head, each facet of the problem part of a fractal she could turn this way and that.
...
She swallowed. #emph[That thing was big enough to blot out the stars, and it wasn't even at full height?]  Once more she forced herself to look upon it and realized that Lluwen was right: It was standing. Compared to the ribs of Titan's Grave, it looked natural, where most things seemed infinitesimal.
...
#emph[I guess heroes don't get to live quiet lives] , Kirol thought.
...
#emph[I'll steal a cart and maybe a horse. No, I can't do that, that's a crime! Wait. If I requisition it, that's not a crime at all! Hah. Good thinking, Kir—]

The rest was lost in a grumbling #emph[oof]  as they walked straight into Ajani Goldmane.
...
#emph[To explain or not to explain?]  Kirol knew they could take on anyone who got in their way. But they trusted Ajani—at least, they were pretty sure they still did—also, Ajani was huge.

"Promise you're not going to try and stop me."

A deep laugh. "You know I can't do that."

Kirol hung their head back and worked a circle into the dirt with the ball of their foot. "Lluwen and Tam might be in trouble. Oracle Jadzi #emph[definitely]  is. Some kind of huge archaic showed up and carried her away, and Professor Fel is acting really weird and talking about eternal oaths of devotion, and—"
...
"Alone?" said Kirol, their voice cracking a little with urgency. "No, you can't! You need someone to watch your back, and I need to make sure my friends are okay. I have to go #emph[now] ."
