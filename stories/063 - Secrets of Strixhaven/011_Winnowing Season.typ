...
#show: doc => conf(
    ...
    story_date: datetime(day: 08, month: 04, year: 2026),
...
#letter_block[
    #set align(center)
    #emph[Ripe fields crude-cut and strewn with chaff]

    #emph[Where shadows light her wanting path]

    #emph[She shoulders harvest, looks toward home]

    #emph[Yet I stumble, starving, toward unprov'd road]

    —Excerpt from #emph[Winnowing Season]  by Embrose Lu
]
...
Saffron leaves shadowed low tables cleared of tea sets, and the scent of cardamom and pepper wafted through the Adumbral Gardens. #emph[The tea ceremony had been a lovely affair] , Killian thought as he readied himself for the duel. Alas.
...
#figure(image("011_Winnowing Season/01.jpg", width: 100%), caption: [Killian, Decisive Mentor | Art by: Billy Christian], supplement: none, numbering: none)
...
"#emph[Now risen sun, cut deep the sky.] "
...
"#emph[You call, I heed. You cry, I cleave.] "
...
"Crown#emph[flower] ," said a teasing voice. That voice came with a cool hand on Killian's forehead. A sweet ribbon of healing power slid through deft fingers into his aching skull. "Does your mother know you're nearly killing people?"

"I didn't think I'd get him!" Crown protested. "He was so #emph[fast] . I got—frustrated."
...
Dizzy heat rose in Killian's skull, warning him not to dump all this on strangers. But Verdis and Crown regarded him with such interest that he thought, #emph[Fine! Whatever!]  and decided to blame his loose tongue on the concussion.

"I don't think it's that the duels have #emph[never]  worked. The Forum's still here, isn't it? But … it's like something's wrong with us. With Arcavios. Like no one knows how to let things go anymore."
...
#emph[—his breath trapped in his chest; the frantic panting of his friends as they fled; the last glimpse of his father's back before—]
...
#letter_block[
    #set align(center)
    #emph[My feet find purchase, soles wear thin,]

    #emph[Thundering heart and rabbit-whim,]

    #emph[No burrow ahead, no hart at bay,]

    #emph[No well, no wine, no bed, no ache.]
]
...
Gossip in the Page's Common had it that the Silkmeadow and Kathorran delegations had already snarled and snapped their way through two weeks and four rituals, and that the Forum's permanent staff had sent for Dean Lu in a desperate bid for #emph[someone]  to bring them in line.
...
"Oh, yes, because if you force someone to do something time-consuming #emph[and]  boring, they'll be in the #emph[most]  diplomatic mood."
...
Killian did an excellent job of not touching the pocket where he kept the pamphlet of poetry. He realized belatedly that he had never before discussed his father's work with the man himself. Killian had in fact been afraid to read it, pathetic as it was to admit. He didn't know what had possessed him to say anything. But #emph[Winnowing Season]  was his father's first publication in three years. It felt … relevant?
...
#letter_block[
    #set align(center)
    #emph[Where once she, froth'd in bridal lace,]

    #emph[Drew near my kiss in keen embrace,]

    #emph[Now fog seeps in down to my bone,]

    #emph[And makes of me reluctant groom.]
]
...
"#emph[I]  see infants. I see bullies. Pitiable, selfish children squabbling over a toy neither can bear to see the other touch. It is my job to tell you so, and so to tell you: no more. You cannot have all you desire. Neither of you can be more precious. You must live in this scarred world, as we all must, and you must live beside each other."
...
#letter_block[
    #set align(center)
    #emph[As crocus bloomed from unkind snow,]

    #emph[Requires frost to cut the road,]

    #emph[I cup my hands, drink iron dew,]

    #emph[And abide here, ever, guard anew.]
]
...
Killian took a slow, deep breath. "#emph[I bear witness … in the shelter of a shadow, borne by sweet wind.] "
...
#figure(image("011_Winnowing Season/03.jpg", width: 100%), caption: [Killian's Confidence | Art by: Jodie Muir], supplement: none, numbering: none)
...
#figure(image("011_Winnowing Season/04.jpg", width: 100%), caption: [Eager Glyphmage | Art by: Cristi Balanescu], supplement: none, numbering: none)

"I know what they're doing," said Embrose in tones that meant, #emph[I am not without eyes, thank you] . "I am asking you to explain the lack of formal precedent and procedure #emph[here] , at the Forum of Amity—the beating heart of precedent and procedure."
...
The draft in his hands described the ritual unfolding before them as an iteration on the traditional duels—one that moved past competitive catharsis and into something more like competitive #emph[communion] .
...
"#emph[Someone]  has to have the patience for it."

Embrose paused, and Killian tensed, thinking: #emph[Oops.]  When his father snorted, Killian allowed himself a wry smile.

"What I don't know," Killian said with a bit more caution, "is if you'll appreciate where I got the idea. '#emph[I cup my hands, drink iron dew, and abide here, ever, guard anew.] ' It made me think of how if something isn't working right, we'd better start building something new."
...
"What #emph[I]  don't know," said Embrose, "is if I've ever properly expressed what I appreciate about you." He was silent again. "I …" Again. "You …"
