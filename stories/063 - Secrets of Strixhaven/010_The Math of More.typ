...
#show: doc => conf(
    ...
    story_date: datetime(day: 06, month: 04, year: 2026),
    author: "Alison Lührs",
    doc
)
...
There's a bundle of kale in the back. #emph[Kale goes with noodles, right?]  It does tonight. Zimone grabs the bundle, artfully plucks out the one with the yellowing sides, and scavenges a lone egg and a nub of ginger in the back.

There were proper meals at Strixhaven. She remembers goat curries and lamb pies, crisp layers of croissant, and as much cider as she could guzzle. How many perfect meals did she absentmindedly horf down while researching her thesis? Zimone dumps her noodles and broth into a repurposed coffee mug and douses it in white pepper and red mystery pepper flakes, then cracks an egg in the middle. See? A balanced, hot, perfectly normal dinner. Zimone is #emph[fine] .

#figure(image("010_The Math of More/01.jpg", width: 100%), caption: [Zimone, Infinite Analyst | Art by: Carly Milligan], supplement: none, numbering: none)
...
Zimone stares at them, counting four letters in the stack. She grimaces, and her stomach roils with guilt. #emph[You should be happy. You should be proud. What would your parents think if they knew all those letters were just sitting there?]
...
She hasn't left the house in two weeks. Just look at the spread of Duskmourn in the corner—how does she know she won't come across the other door? Just look at the pinpricks of Omenpaths sprinkled as a dusting of flour—what if she overlooked one that led to the worst of places? Just look at her stack of apprenticeship offers—what if she fails to live up to their expectations? What if she works on someone #emph[else's]  big idea instead of her own? What if. What if. The what-ifs have become a barricade at her doorframe, a moth in the carpet, potent paradox magic all on their own. The what-ifs have manifested into words of power that keep her safe. Zimone is #emph[fine] .
...
#figure(image("010_The Math of More/02.jpg", width: 100%), caption: [Planar Engineering | Art by: Liiga Smilshkalne], supplement: none, numbering: none)

But Zimone sees something else. Just above Arcavios.

A shadow.

She narrows her eyes. It is curling like clouds, more of a trick of the eye than anything else. If she focuses, eases the spell's formula a bit, she can sort of make out the spread. What #emph[is ] that thing? She climbs on her bed and tries to get close; but the shadow has no form. Just the suggestion of distortion.

"What #emph[is]  that?" she sneers aloud, annoyance at the mystery overriding all else.
...
A shadow? No, stupid. Maybe it's a fault in the spell? A new phenomena of the Multiverse? What the #emph[hell]  is it? Zimone furiously fiddles with her spell, accepting that finding the source of this shadow is now her entire personality.
...
She had tooled it to track the spread of Duskmourn like a disease, but is Duskmourn causing that shadow? Is the shadow forming without direct contact to the original plane? #emph[If so, what does that mean about the spread of Duskmourn from one plane to the other … and if it isn't Duskmourn … then what is it?]
...
#letter_block[
    ...
    #emph[The Omenpath Project awaits your response to the offer of apprenticeship. You will work under Lumia Voj testing methods of transplanar proximate disarticulation. Respond within twenty-four hours. The Firemind and Guildmaster Zarek have recommended you for this program. Do not disappoint them.]

    #emph[Respectfully,]

    #emph[Chamberlain Maree]
]

Zimone's anxiety spikes.

Twenty-four hours to say yes; she'll do someone else's work. Twenty-four hours because she has dallied too long in responding. The cold air is comfort that she is safe from the House, but the letter is a reminder that she cannot remain on her own forever. Zimone is safe. Zimone's status is unstable. She feels like she has vertigo and, in her uncertainty, releases the glamour on the room. Her map, #emph[her ] map, the miracle.
...
She grazes her fingers past her familiar texts before landing on one praestigial book she was lent by Dean Kianne before … before everything. The book is still fresh, not a crease or mark on its pages. Zimone is pleased—all she wants is to get #emph[some ] version of her to cover what she doesn't want to do while the rest of her focuses on solving the mystery in her model.

#emph[How to achieve both goals at once] , Zimone frames for herself. She reads.
...
The third way feels best: duplication. A shallow double made in the inverse; someone who can do what she cannot but not be an entire person at the end of the day. #emph[This must have been Riku's method!]
...
The initial cut appears to be the most difficult. She keeps trying, again and again, visualizing the metaphor the spell describes (cut out a slice of yourself as an orange, press that slice to paper, breathe life into the impression it creates). #emph[It's a fruit metaphor! It's easy! So why is this ] hard#emph[? ] Zimone growls with frustration and ditches her outer sweater as she opens her window further.

A thin yellow line silhouettes the horizon. It's morning.

Zimone grimaces. Niv-Mizzet will expect an answer to his offer. And, simultaneously, a notion of #emph[expectation ] butts up against her fear. Suddenly, a crease forms within her mind, and Zimone seizes it—#emph[there] !
...
Zimone realizes instantaneously that she is a monumental dumbass. Of course the fruit one was actually the hard one. This isn't the work to create a duplicate, a simple copy, no, she's her, which means she has overcommitted in the stupidest way possible, and by nature of her dumbassery has instinctually made a double the difficult way. Duplication is Riku's method, the easy way. #emph[This ] can only be option two: division.

The most overwhelming headache of her life sends her to the floor. Zimone howls, can see flashes of blue from behind her eyelids, and the more she uses the spell to tear in twain the more she feels something #emph[of ] herself #emph[outside ] herself build matter and take form. It feels like surgery, it feels like vomiting, and as soon as she coughs out a breath of life she hears an entire body collide with the floorboards.
...
#figure(image("010_The Math of More/03.jpg", width: 100%), caption: [Command Tower | Art by: Constantin Marin], supplement: none, numbering: none)
...
"I have already received word from your Izzet advisor that the Firemind does not recommend pursuing study at the moment. Their models do not predict any further virality—that is, #emph[intrusions ] into other planes."
...
Zimone's first two weeks of duplication are #emph[spectacular] .

She's been able to stabilize her model, clarify the shadow growing within it, avoid her roommates, #emph[shower] . It is an hour past dinner, and she managed to make something other than eggs or noodles for the first time in months. The sun has been down for hours, and by the time she's heading back to her freezing cold bedroom for round six of spell calibration, her double finally arrives home.

Apprentice Zimone leaves her coat on as she arrives, bags under her eyes and a smile on her face.

"Hello, #emph[me] ," she says wearily.

"Hey,#emph[ me] ," Zimone says back. The Apprentice drops her bag and heads for the fireplace. She doesn't need to eat (thank goodness; until her first paycheck they can only afford to feed #emph[one ] actual body). The Apprentice groans a bit as she sits down and pulls out a leather-bound folder.
...
#emph[Annoying—why would the other one say it in that tone?]
...
Zimone's next week is #emph[irritating] .

The two doppelgängers are out in the world, one achieving her dream, the other #emph[aggressively achieving] , and from under two sweaters Zimone is getting annoyed. Is her voice #emph[that]  annoying? Does she really #emph[never ] relax?

Worst was dinnertime; now that she technically had four jobs, Zimone could finally afford good produce, quality eggs, the #emph[nice bread] . And every time she brought it home, she was irritated by company. Apprentice Zimone would insist on sitting at the table despite not needing food, and Overachiever Zimone (what else was she to call her?) would suggest increasingly indulgent alternatives to whatever she #emph[was ] eating. It was annoying. It was rude. It made Zimone increasingly self-conscious … Did all of her friends notice how she never shuts up about her workday? Did they all secretly hate the way she started every sentence with "look"? Zimone couldn't help but fixate. Their flaws were hers. And with them on the outside they were now unignorable.
...
Zimone feels herself clench, her instincts sudden and possessive, says #emph[no]  she will not share, not when it's getting interesting. And it #emph[is]  getting interesting—all this time at home has allowed her to begin tracking the spread. Because the shadow in her model isn't a shadow. There's matter there, the most solid version of it mirrored above Arcavios. Is this a second Duskmourn? Her gut says … no. It bears a thumbprint. A distinct pattern. It made itself, as Duskmourn did, but it does not share the same roots.

"I'm not sharing with him unless he pays me to," Zimone says stiffly.

"Atta girl," affirms the Overachiever from the desk in the corner. #emph[Again, ] annoying#emph[, why won't she stop working—]

"The right thing to do is to share," the Apprentice mumbles. "Look, it's not ethical to hold back information that #emph[could ] help the Multiverse." Annoying!
...
She doesn't know when to stop talking, she critiques but never offers another option, she does this #emph[thing ] where she always #emph[laughs] ? Like whatever she's saying always has a half-breathy giggle nestled within the sentence? It's infuriating, it's bizarre, she isn't saying anything #emph[funny] , she's just always on the edge of making herself laugh—
...
She half-gasps, half-sobs, and bruises her knuckles diving over the bed to open it again. Precious sacred #emph[cold ] blows in. The outside exists, the sky is real. She can smell her neighbor's dinner, and her heart is beating faster and faster, and she was so close to being captured, so close to death.

She can't breathe.

She can't breathe.

Friend Zimone is next to her telling her she's okay, and Friend Zimone is a #emph[useless doorknob] —

Zimone imagines Tyvar's hand on her forehead, ice cooling her down, the ground firm and solid beneath her. #emph[Who closed the window?]  Her doubles wouldn't do that.
...
"Stop," Dina says. She leans forward. "What did you #emph[do] ?"
...
Zimone explodes, "I can't #emph[stand]  her. She never knows when to shut her mouth, she laughs halfway through sentences, she thinks she's so quirky and interesting but she isn't interesting! She just reminds you what her hobbies are all the time! And I can't even focus on work without her nearby offering #emph[help ] and #emph[advice ] and—"
...
#emph[But "me" isn't enough.]  The thought hurts. Zimone finds herself lowering to the couch.
...
#figure(image("010_The Math of More/04.jpg", width: 100%), caption: [Commander's Insight | Art by: Carly Milligan], supplement: none, numbering: none)
...
"Okay, yeah, #emph[well] , spell says she knows whoever made the second Multiverse. I know where to find her."

#emph[A purpose.]  Zimone blinks. She feels cold. Her friend is in the room, a goal is in front of them, and the only adults in the room are them.
