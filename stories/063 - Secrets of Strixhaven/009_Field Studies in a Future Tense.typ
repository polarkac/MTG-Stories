...
#show: doc => conf(
    "Field Studies in a Future Tense",
    set_name: "Secrets of Strixhaven",
    story_date: datetime(day: 03, month: 04, year: 2026),
...
#figure(image("009_Field Studies in a Future Tense/01.jpg", width: 100%), caption: [Quintorius, History Chaser | Art by: Darren Tan], supplement: none, numbering: none)
...
"She is," said the secretary. "You know, er, reports of #emph[her]  death were #emph[not]  exaggerated, yes?"
...
#figure(image("009_Field Studies in a Future Tense/02.jpg", width: 100%), caption: [Augusta, Order Returned | Art by: Bryan Sola], supplement: none, numbering: none)
...
"I don't #emph[want]  to go to the fields with Dean Plargg," said Quint. "I like him, but he's not my academic advisor, and he wouldn't understand the importance of doing this correctly. And I know that only current students are covered by the protection spells, but that's just #emph[students] . Teachers are allowed."
...
Quint straightened, beginning to relax. This was easier than walking through some of the better-understood areas near the camp. #emph[He could do this. He could—]
...
But not #emph[these]  things. This was a trove that could justify any number of deeper expeditions into the fields, riches beyond even the primary sources represented by the dead. And he'd simply … fallen into a major historical find. Again.
...
Quint wasn't honestly sure Mica remembered who he was. He wasn't #emph[entirely]  sure Mica was actually the geomancer's name. It didn't actually matter. He almost lurched across the fields, sidestepping ghosts with eerie ease. Quint had given him rough directions, and it seemed like that was all the man needed, because he was heading the right way. Quint followed briskly in his wake, taking advantage of the brief break in the endless parade of ghosts that Mica's passage created.
...
"That's … These things #emph[do]  have an owner. They belong to Arcavios. They belong to history." He paused. "Mostly history, I think. You can't take them."
...
#figure(image("009_Field Studies in a Future Tense/05.jpg", width: 100%), caption: [Flashback | Art by: Flavio Greco Paglia], supplement: none, numbering: none)
