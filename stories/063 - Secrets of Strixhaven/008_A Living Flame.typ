...
#show: doc => conf(
    ...
    story_date: datetime(day: 02, month: 04, year: 2026),
...
The wind off the gorge attempts to lift my hair, my braids heavy enough that it can't quite manage it. #emph[See? The plane is still here. There are no metal monsters.]  I repeat it, my mantra. #emph[Nobody here is relying on you.]

#figure(image("008_A Living Flame/01.jpg", width: 100%), caption: [Rootha, Mastering the Moment | Art by: Lie Setiawan], supplement: none, numbering: none)
...
#emph["Rootha, darling. What is it that you always tell me? Your worries that you'll never be good enough?"]
...
#emph[Okay, surly. ] I don't say it loud, though, since he did save my life. And a giant, magic-stuffed whale probably #emph[would]  be popular in the Summitfest showcase, though I'm not sure how he plans to get it onstage.

Maybe this is who Nassari is here to help. I feel a pang in my chest, somewhere between jealousy and exhaustion.

#emph["You know that voice in your ear, Rootha?"]
...
#emph["They're not going to help you, Rootha. You're on your own."]
...
#figure(image("008_A Living Flame/02.jpg", width: 100%), caption: [Spectacle Summit | Art by: Andreas Zafiratos], supplement: none, numbering: none)
...
#emph["That voice, Rootha? Maybe you should open yourself up to it."]
...
#figure(image("008_A Living Flame/03.jpg", width: 100%), caption: [Spectacular Skywhale | Art by: Serena Malyon], supplement: none, numbering: none)
...
#emph["You know that voice in your head, Rootha?" ] they purr.#emph[ "The one that tells you you're not good enough? That insists you'll never be all of the things you pretend you are?"]

Their mouth gleams cherry red when they smile, with blood or fire, I'll never know which.

#emph["I think you should let it in. It's good to trust your instincts sometimes, isn't it? Your instincts are right."]

#emph["You think you're a unique talent, someone who just takes a different approach to things?"]

#emph["You're a burden. You cling. You can't finish anything, and it's not because of your perfectionism. You're just. No. Good."]
...
It's what Nassari had just said that makes me think of it. #emph["I need more force." ] I'm used to having their voice echoing in my head. It feels right at home.

Slowly, I raise my hand. Nassari takes a step back, like they think I'm about to cast at #emph[them] . I close my eyes, trying to block out the sounds of water and people fleeing and the haunting, chaotic bellow of the elemental. All I see behind my eyelids is a bright, dancing, #emph[living]  flame.
