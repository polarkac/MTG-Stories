...
#show: doc => conf(
    "Episode 1: Penmanship Practice",
    set_name: "Secrets of Strixhaven",
    story_date: datetime(day: 23, month: 03, year: 2026),
...
#letter_block(border: true)[
    ...
    We're off to the Fields of Strife. Best name of the whole bunch by far, even better than Sanar's, and I'll fight him on that. (He'll lose.) You would not believe the safety lectures they're giving us. We've got to attend no less than #emph[five]  before they'll let us on the trip at all.

    See, time and magic don't work the way they should over there. The place is haunted by all kinds of old warriors who are stuck re-enacting old wars—but the wars aren't contemporaneous. It's #emph[centuries ] of war. Why shed so much blood over this place? That's what we're trying to find out!

    I tell you, there's nothing like being surrounded by history. Lectures are one thing; books teach you a bunch, sure. But watching #emph[real ] warriors #emph[really ] duking it out all around you? I can't wait.
    ...
    They didn't answer me, which I thought was pretty boring. But they #emph[did ] rear back their sword arm for a swing. I shifted the statue so that I could take the brunt of the hit instead. I locked eyes with the ancient warrior and let out my best war cry.
...
#letter_block(border: true)[
    ...
    This is Abigale again. Sanar has a point. Two, really. Kirol's letter was #emph[two ] pages, which is unfair to Sanar. One page, everyone! Poetry is about describing a single flower petal that calls to mind an entire garden for the reader. Letter writing is more casual, of course, but still. Consider the words you want to use for the greatest effect.

    The other point, though—I can confirm that Professor Fel is dark-tempered. Unlike Kirol, I can promise that #emph[my ] recollections are completely accurate except for an adjustment or two made for the sake of good prose. Last semester I took a course on poisonous flora so that I better understood which flowers to reference when. I've rarely seen a professor look so bothered to stand at the lectern. It was as if we were pelting him with stones and not questions.
    ...
    I raked my claws against my upper arm, puffed my feathers, and went a little limp. #emph[Professor Fel, what if we drink the wrong one?] 
    ...
    It wasn't until #emph[he ] let out a breath that #emph[we ] all did. The classroom broke out in cheers.
...
#letter_block(border: true)[
    ...
    Also, the other students #emph[totally ] ratted on us having seen a spirit, so now I have to find an "academic advisor" for this trip or else I'll lose my seat.
...
#letter_block(border: true)[
    ...
    I didn't know what to say. What #emph[could]  I say? Though there were plenty of people around, it was just me and him talking. I looked down at my feet and the ground underneath, and I wondered what had happened to the Planeswalkers I knew.

    He must have known what I was thinking. "I lost my brother, Jazal. The only member of our pride who cared about me. He died simply because he was #emph[my]  brother."
...
#letter_block(border: true)[
    ...
    "Keep #emph[you]  company? Why?" they'd say, or something like that. I don't know how accurate you guys expect me to be about this sort of thing.
    ...
    "Welcome to Jawdocks!" she said. "Now, I know you're all eager to get knee-deep in the dirt as Witherbloom students, but please make sure you're good and rested first. Pick up your gifts from the shops #emph[before ] you start your travels, and you'll have less to worry about on the way back. Trust me."
...
#letter_block(border: true)[
    ...
    "You know, I think she cares more about the flow of #emph[knowledge] ," I said. Just as I was about to give Tam a friendly shove forward, I heard Oracle Jadzi laugh.
