...
#show: doc => conf(
    ...
    story_date: datetime(day: 09, month: 03, year: 2026),
...
#figure(image("007_Off the Record/01.jpg", width: 100%), caption: [Art by: Billy Christian], supplement: none, numbering: none)
...
"Jilesa Clarus," she said, holding out her hand. "Reporter from the #emph[Strixhaven Star] , here for the interview. A pleasure to meet you, Professor Zarek."
...
"I'm in." A secret project sounded ideally suited to her skills, and it might eventually make an incredible story for the #emph[Star] , depending on how it unfolded. "Esmun, you can get another flash portrait and go. I know you have other homework."
...
"#emph[Accounts of the Dawning Age: Vortex Formations and Egomagical Adaptations] , by Scavrana the Oracle."
...
#emph[A ritual would definitely be more effective] , Jilesa thought. She retrieved her grimoire from her knapsack and flipped to the necessary page.
...
No. Even if she could never write this story for the #emph[Star ] without breaking her promise to keep this secret, she'd at least prove Professor Goss was wrong to hold her back. Someday, when she was a famous lumimancer, she would—
...
A flash and sulfurous scent announced that Esmun had committed an image to canvas. A pity they couldn't use it for the story in the #emph[Star ] unless they were released from their confidentiality promise.

"Let's get that tome," Professor Zarek said. "Remember, it's #emph[Accounts of the Dawning Age: Vortex Formations and Egomagical Adaptations] , by Scavrana the Oracle."
