...
#figure(image("011_Stories and Endings/01.jpg", width: 100%), caption: [Tamiyo, the Moon Sage | Art by Eric Deschamps], supplement: none, numbering: none)
...
#strong[He Who Frightens the Sun]

#emph[This is the story of the world gone dark, and He Who Frightens the Sun. His shadow brought night to those in his wake, and his hunger was never sated. The akki knew what the oni concealed, a lifetime of loot and of plunder. But none dared risk the oni's wrath, save one who felt no fear.]

#emph[When that akki came upon a long flat stone, she held it above her head. From high up above, when the oni looked down, she seemed no more than such a stone. And so disguised she went to his cave, assured that she was safe.]

#figure(image("011_Stories and Endings/02.jpg", width: 100%), caption: [], supplement: none, numbering: none)

#emph[But the oni was curious.]

#emph["It is strange, little stone, the way that you move! Are you here to steal my riches?"]

#emph["I have never heard, great one," the stone replied, "of a stone stealing riches, have you? I promise that if I see any thieves, I will let you know!"]

#emph[The oni heard truth in the akki's words, and decided that all was well. He went to sleep, and the akki proceeded to take as much as she could carry. Gold, jewels, and a shining platter, in which her reflection grinned.]

#emph[The next day, the akki returned, and the oni confronted the stone.]

#emph["Little stone, little stone! Someone has stolen my treasure! Did you see the thief?"]

#emph[Remembering her promise, the akki replied, "Yes! I saw the thief, a clever little akki! Perhaps you should go and search for her, and punish her for her wicked ways!"]

#emph[The oni agreed, and went off in search, and while he was gone, the akki once more made off with more stolen treasure.]

#emph[If she had only ended there!]

#emph[The greedy little akki came back to the oni's cave a third time, stone overhead and greed in her heart. The oni's heart held only rage.]

#emph["Little stone! It has happened again! I could not find the thief, but once more my treasures vanish! I do not know what to do, except to go to the akki warrens to the west, and devour them all, just to be sure I get the right one!"]

#emph[Fearing for her home and friends, the akki replied, "Great one! Akki are tough and bitter, not at all delicious! It is best to leave them be, and continue your search for the thief!"]

#emph[But while the oni did not know a stone, he knew a lie quite well. He scooped up the little akki, stone and all, and swallowed her in one bite.]

#emph[The akki tell this tale to remember that the truth is a better deception than any lie ever told.]
...
She gestured, and a slight push of wind opened the heavy door a few degrees more. She stepped into a deeper stance, her feet now gripping the stone evenly (though she still #emph[thought]  of tiptoeing, for reasons she could not explain), and crept toward the door, equally ready to flee or to pounce.
...
#figure(image("011_Stories and Endings/03.jpg", width: 100%), caption: [Jace, Unraveler of Secrets | Art by Tyler Jacobson], supplement: none, numbering: none)
...
#figure(image("011_Stories and Endings/06.jpg", width: 100%), caption: [Fact or Fiction | Art by Matt Cavotta], supplement: none, numbering: none)
...
He saw her burden. The terrible burden of #emph[knowing] , and the need to protect truths too dangerous to be spoken aloud, yet too important to be forgotten. Three iron-bound scrolls, each with a power...
...
"I will attempt to communicate with Avacyn. Distract her. #emph[Emphatically ] distract her if I must. You will not have long to stop her before she kills us both."
...
#figure(image("011_Stories and Endings/07.jpg", width: 100%), caption: [Avacyn's Judgment | Art by Victor Adame Minguez], supplement: none, numbering: none)
...
#figure(image("011_Stories and Endings/08.jpg", width: 100%), caption: [], supplement: none, numbering: none)
...
#emph[She's adapting. We don't have long.]
...
#figure(image("011_Stories and Endings/09.jpg", width: 100%), caption: [Avacyn, the Purifier | Art by James Ryman], supplement: none, numbering: none)
...
#emph[Tamiyo. The scroll. The iron scroll. You showed it to me. An old story. A powerful story. The survivors of a place that was lost...Serra's realm. That cataclysm, that power...the story fits. You know it does. You can stop this.]
