...
#emph[Dark and deep, Lake Zhava lies in the highlands of Nephalia, near the border with Gavony. Villagers who live on the lake's shores and fish its waters have long spoken of a monster living in its depths. But despite the villagers' pleas, the church of Avacyn has sent no cathar or angel to protect them. As the madness in Innistrad grows, how will the villagers face the horrors of the lake?]

#figure(image("004_Sacrifice/01.png", height: 40%), caption: [], supplement: none, numbering: none)
...
"It is #emph[too]  real," he insisted, pounding his fist on the grass. "Veryl said he saw it once—just a glimpse, but it was as wide as his ship."
...
Mia shrugged as she walked toward her flock. A few had straggled farther afield than she liked. "There's no sense in being afraid of the dark, Wil. What you should be fearing is what's #emph[in]  the dark."
...
"Too busy to deal with the whining delusions of small-minded townsfolk!" Mia whipped around, brandishing her crook. "Look around, Wilbur. None of this matters. This village doesn't matter. #emph[We]  don't matter. This stupid little hamlet isn't even #emph[big ] enough for real terrors to haunt it! We're just a no-name nowhere mountain town slowly driving itself to madness through runaway imaginations."

#figure(image("004_Sacrifice/02.jpg", width: 100%), caption: [Art by Andreas Rocha], supplement: none, numbering: none)
...
"We both know I can take you in a fight. You #emph[didn't]  mean that."
...
#figure(image("004_Sacrifice/03.jpg", width: 100%), caption: [Art by John Stanko], supplement: none, numbering: none)
...
Veryl sidled up behind Kalim, greasy blond hair flopping across his eyes. "Rude words from a shepherd girl. Talking like #emph[you]  are the slayer."

"I'm more of a slayer than you are a fisherman, Veryl." As much as she wanted to knock the smugness (and just a #emph[few ] teeth) from Veryl's face, she knew better than to throw a punch with Kalim watching. She turned her attention to him.

"Surely #emph[you]  of all people do not believe Veryl's tall tales about actually #emph[seeing]  the Gitrog, Elder Kalim."

"I believe. For I #emph[have]  seen it."
...
Kalim took the coriander and ruffled Wilbur's hair. Wilbur looked around sheepishly until he caught Mia's eye. His face went from goofy embarrassment to serious in an instant, his brow furrowing. #emph[You okay] ? he mouthed.
...
#figure(image("004_Sacrifice/04.jpg", width: 100%), caption: [Midnight Guard | Art by Jason A. Engle], supplement: none, numbering: none)

Mia stood, throwing her hands in the air in exasperation. "We still don't know if there #emph[is]  a monster!"

Wilbur gaped at Mia, dumbfounded. "You still don't believe?"

"I still don't #emph[know]  for certain. It's all anecdotal evidence—"
...
Mia looked up over her bowl at Wilbur, curious. Wilbur stared into his. "Boats destroyed. Property damaged. And recently, livestock going missing. Pa says we're lucky no #emph[person]  has been hurt."
...
#figure(image("004_Sacrifice/05.jpg", width: 100%), caption: [Mausoleum Guard | Art by David Palumbo], supplement: none, numbering: none)
...
#figure(image("004_Sacrifice/06.jpg", width: 100%), caption: [Wolfhunter's Quiver | Art by Daniel Ljunggren], supplement: none, numbering: none)
...
#figure(image("004_Sacrifice/07.jpg", width: 100%), caption: [Sharpened Pitchfork | Art by Winona Nelson], supplement: none, numbering: none)
...
#emph[At least it isn't snowing] , she thought.
...
#figure(image("004_Sacrifice/08.jpg", width: 100%), caption: [Art by Florian de Gesincourt], supplement: none, numbering: none)
...
A loud #emph[snap-crack!]  rang outside the cabin. Mia sat up with a start, heart racing. She listened intently, peering out into the silvery semidarkness, senses on alert, mind racing. Nothing but silence.
...
#figure(image("004_Sacrifice/09.jpg", width: 100%), caption: [To the Slaughter | Art by Christine Choi], supplement: none, numbering: none)
...
#emph[If a menace is confirmed as monster and not man, a slayer must track and isolate it if possible. Slay it away from townsfolk and cities—avoid the panic and mayhem of frightened innocents.]
...
"Tell me more later." Mia grabbed his hand, fired the crossbow at another villager charging toward them with a pitchfork—#emph[Verna, flower girl] —and ran for the aft of the boat.

"Where are we going?" Wilbur shouted.

"I—I don't know!" Mia looked out at the chaos surrounding her. With each swing of the Gitrog's tongue, more villagers were knocked into the water or grabbed and swallowed whole. Some just cowered in the boat, trying to hide. A few had dived into the water and were now trying to swim away. Mia considered jumping overboard as well—until she saw one swimmer (#emph[Elder Ethan's son] ) disappear beneath the water, leaving nothing but a trail of bubbles in his wake.

#figure(image("004_Sacrifice/12.jpg", width: 100%), caption: [Art by James Paick], supplement: none, numbering: none)
...
A wet #emph[plop]  sounded from behind Mia.
...
Another #emph[plop] , and suddenly Wilbur was dragging her to her feet, pulling her away. The two didn't make it far before they collapsed on the stones. Mia's muscles screamed. The adrenaline had worn away, leaving nothing but stiff bodies locked with terror. Slowly, she rolled over.
...
#figure(image("004_Sacrifice/13.jpg", width: 100%), caption: [The Gitrog Monster | Art by Jason Kang], supplement: none, numbering: none)
