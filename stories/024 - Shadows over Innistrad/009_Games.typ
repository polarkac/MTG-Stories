...
#figure(image("009_Games/01.jpg", width: 100%), caption: [Stitcher Geralf | Art by Karla Ortiz], supplement: none, numbering: none)
...
#figure(image("009_Games/02.jpg", width: 100%), caption: [Zombie Apocalypse | Art by Peter Mohrbacher], supplement: none, numbering: none)
...
#figure(image("009_Games/03.jpg", width: 100%), caption: [Ghoulcaller Gisa | Art by Karla Ortiz], supplement: none, numbering: none)
...
Given these recent happenings, I wish to add an addendum to the laws of necromantic warfare to exclude use of relations or family pets in battle (I #emph[know]  you still have what is left of Spot). Respond with your desired time and location of our next duel.

Your loving sister,

Gisa

#figure(image("009_Games/04.jpg", width: 100%), caption: [Ever After | Art by Ryan Alexander Lee], supplement: none, numbering: none)

Gisa,

You are being #emph[incredibly]  irresponsible. Put Mummy and Father back in the ground#emph[ where they belong] .
...
#figure(image("009_Games/05.jpg", width: 100%), caption: [Geralf's Masterpiece | Art by Daarken], supplement: none, numbering: none)
...
I am absolutely #emph[sick ] of games.
...
#figure(image("009_Games/06.jpg", width: 100%), caption: [Gisa's Bidding | Art by Jason Felix], supplement: none, numbering: none)
...
Why aren't you answering my letters. It's because you have a #emph[girlfriend] , isn't it.
...
#emph[Please]  do not bring that up. Lili was never my girlfriend! She took Mikaeus's body back in Thraben and absconded. I never saw her again after our brief acquaintance. She is terrible and I hate her.
...
#figure(image("009_Games/07.jpg", width: 100%), caption: [Drownyard Temple | Art by John Avon], supplement: none, numbering: none)
...
Hear #emph[that] ? We are making a monument to our greatness!
...
I have no clue what you mean by "thank you for helping me escape," but I'm certain it is just you trying to get inside my brain #emph[as per usual] . Your silly tricks won't work on me!
...
I was the one who sent the skaabs to free you from the prison caravan. I went through the trouble of building an attack force to overtake your captors and not #emph[once]  have you thanked me for your release.

Who else in this bloody hellhole of a parish has the capability to raise dozens of skaabs?! Did you think you were #emph[lucky]  enough to just #emph[happen across]  the very creatures I have made my name creating?!
...
#figure(image("009_Games/08.jpg", width: 100%), caption: [Prized Amalgam | Art by Karl Kopinski], supplement: none, numbering: none)
...
You are an arrogant, hubristic, #emph[feculent]  bastard. How dare you naively assume I could not free myself?!

I am an idiot for not seeing the truth sooner and recognizing those skaabs for what they were. Keep your presumptuous morality to your own damn self. I have #emph[never]  needed your help, and I will #emph[never]  be dependent on you for rescue.
