...
#show: doc => conf(
    ...
    story_date: datetime(day: 12, month: 07, year: 2017),
    author: "Ken Troop",
    doc
)

#emph[The God-Pharaoh has returned, and the five Hours have arrived as foretold. The Hours of Revelation, Glory, and Promise unleashed disaster upon Naktamun, and now the Hour of Eternity brings an unimaginably personal terror to the city's denizens.]
...
She had never understood faith itself. She thought it weakness, an affectation of piety for those weak of character. What use was faith when the gods were so abundantly #emph[true] ?
...
But still her heart quickened when the gate to paradise had opened. To know that #emph[someday]  was now, that eternity was #emph[here] . She craned her neck, eager to witness divine bliss . . . but there was no bliss revealed behind those gates, only horror.

#figure(image("006_Hour of Eternity/01.jpg", width: 100%), caption: [God-Pharaoh's Faithful | Art by Bastien L. Deharme], supplement: none, numbering: none)
...
Nylah's most wicked thought came to her then, unbidden. #emph[The gods have failed their trial. They deserve their death.]

A moment's pause, and then the abyss stretched, beckoned. #emph[We all do.]
...
#figure(image("006_Hour of Eternity/02.jpg", width: 100%), caption: [Angel of the God-Pharaoh | Art by E.M. Gist], supplement: none, numbering: none)
...
#figure(image("006_Hour of Eternity/03.jpg", width: 100%), caption: [Hour of Eternity | Art by Tyler Jacobson], supplement: none, numbering: none)
...
"Now I believe!#emph[" ] she shouted to her desired brethren. Each blade sunk into her flesh with a cold kiss, a greeting from the other side of glory, a sharpness that could not be imagined, only felt. Only lived.

#emph[Now I believe,]  she thought with each blow. Her kin swarmed over her, stabbing, stabbing. #emph[Now I believe.]
...
Eventually. But not now. Not #emph[right]  now. #emph[One more breath.]
...
#emph[I love you, here at the end, whether I know you or not. I love you all.]
...
#emph[There must be somewhere safe, yes? There has to be . . . ] she killed the thought.#emph[ One more breath.]

A few minutes ago, #emph[an eternity ago] , panic had threatened to overwhelm her. She was strong, skilled and used to fighting for hours over the course of a day in her normal training . . . but never without stopping, never without a single moment to catch her breath, never against opponents who were faster, stronger, and did not sweat or tire or slip.
...
#emph[One more breath. One more breath. One. More. Brea] —

#figure(image("006_Hour of Eternity/04.jpg", width: 100%), caption: [Act of Heroism | Art by Magali Villeneuve], supplement: none, numbering: none)
...
#emph[As long as we are together] , he thought, and he clung to that thought desperately. If he was with her, then everything would be alright.
...
#figure(image("006_Hour of Eternity/05.jpg", width: 100%), caption: [Spellweaver Eternal | Art by Jason Felix], supplement: none, numbering: none)
...
#emph[There! ] Through a desolate, broken plaza he sprinted, her brown hair and bronze-striped dress unmistakable. Even as he ran to her side, he saw the gathering crowd of Eternals flanking her, but nothing would stop him this time, even if he had to fight them all.
...
#figure(image("006_Hour of Eternity/06.jpg", width: 100%), caption: [Threads of Disloyalty | Art by Yongjae Choi], supplement: none, numbering: none)
...
#figure(image("006_Hour of Eternity/07.jpg", width: 100%), caption: [Without Weakness | Art by Alex Konstad], supplement: none, numbering: none)
...
#figure(image("006_Hour of Eternity/08.jpg", width: 100%), caption: [Omniscience | Art by Josh Hass], supplement: none, numbering: none)
...
#emph[This dragon is not an impostor. This dragon is our God-Pharaoh. This is the being we have served all our lives. ] Her stomach roiled, her head feverishly hot.

She screamed her challenge into the darkening heavens, raising her spear to the God-Pharaoh#emph[, no, that title no longer] , to the #emph[dragon] . "I will kill you!" She sprinted toward him.
...
#emph[Oketra, protect me. Give me strength. ] Kawit did not know, really, to whom she was praying, but that did not lessen her confidence that Oketra would provide.
...
#emph[Oketra, help me strike true] . Kawit launched the spear into the air and it flew with speed and accuracy she knew she could never have achieved alone. It shone in the air as though launched directly from Oketra's bow as it hurtled toward the side of the unsuspecting dragon's neck.

#figure(image("006_Hour of Eternity/09.jpg", width: 100%), caption: [Oketra's Avenger | Art by Anthony Palumbo], supplement: none, numbering: none)
...
#figure(image("006_Hour of Eternity/10.jpg", width: 100%), caption: [Merciless Eternal | Art by Mathias Kollros], supplement: none, numbering: none)
...
Even as the blood poured out of his mouth, it made him realize how thirsty he was, how much a cup of water would do to heal him. #emph[I will be fine, I just need a cup of water] , he thought.
...
He had been running away. They all had. The locusts, the Hekma destroyed, the deaths of the gods. It was all too much. Their world, everything they #emph[thought]  about their world, ripped away from them in the time of a day.
...
#emph[Don't cry for me] , he wanted to say. #emph[Just take the child.]  But his mouth refused to work.
