...
#emph["And so the Hour of Revelation broke upon the land, and the promised time arrived when all questions would be answered. And lo, the Gate to the Afterlife opened, and from behind its gleaming walls, the true visage of the coming tide poured forth."]
...
#emph[I'm too old for this nonsense.]
...
#emph[Jace? Can you hear me? ] Distantly in her mind, she heard a response.

#emph[Lili? Where are you! We're coming! The crowd] #emph[—]

#emph[—] #emph[was too large, I know. I'm on the bank of the river, before the gate. Jace, it's Razaketh, he's] #emph[—]

"Where are you, #emph[crone] ?"
...
It was a scare tactic, that's all. #emph[She ] refused to feel fear. Liliana purposefully thrust the same hand down toward the left side of her dress, toward the Chain Veil.
...
Liliana abruptly stopped speaking. The demon lowered his wings. His words—smooth, steady, #emph[calm—] #emph[poured over the crowd] .

#emph["] #emph[Come to me] #emph[."]
...
#figure(image("002_Feast/01.jpg", width: 100%), caption: [Art by Titus Lunter], supplement: none, numbering: none)
...
But it was to no avail. No matter how much she mentally fought, her hate never reached her face. Her anger never pulled at her muscles. Liliana had no control over the one thing that was ever actually #emph[hers] .

#emph[Damn it all to the depths of the hells!]

She railed and screamed in her own mind, but the tether between her will and her limbs remained severed.

#emph[Chandra and Nissa reached out to pull Liliana's wandering body back, and a flare of necromantic energy pushed back their hands. The two women recoiled back, hands withdrawn before the decay and rot seized them.]

#emph[In Liliana's head, she could hear Jace yelling, and in her ears Gideon's voice echoed, but her attention remained fixed on Razaketh before her.]

#emph[Go to him]  was the only command her body knew. The Chain Veil remained tucked away, the demon too close, her allies unable to halt the urge to wade forward.
...
#emph[I will not be afraid. He is weaker than I am, and I can survive this.]

A voice creaked through her mind: "#emph[You can only survive this if you ] #strong[kill]  #strong[him] #strong[.] #emph["]

The Raven Man.

Liliana screamed. #emph[Get out! Not now! I do not want to hear from you!]

#emph["You are only free if you kill each of your demons, Liliana. Only then will I leave you be."]
...
A part of her felt foolish. No other demon wielded this sort of control over her body. How could she fight someone who could maneuver her like a puppet? What kind of tactic could she use to #emph[fight]  #emph[that] ?

Razaketh looked down. His face was reptilian and unreadable, but he seemed pleased all the same to encounter his contractor. Where Kothophed and Griselbrand were distant, Razaketh was #emph[playful] .
...
#emph[Liliana! We see you. We're coming!]
...
"You really ought to read contracts before you sign them, you know. People hide all #emph[sorts ] of nasty clauses into them. The other co-authors were so straightforward, but I like a little flair in my dealings."
...
Liliana's jaw popped with returned agency. She shifted it from side to side. The rest of her was still out of reach, but at least her words were again #emph[hers.]
...
Internally, Liliana sighed. #emph[Is that a joke?]

A pause. #emph[Maybe] #emph[.]
...
Jace's voice suddenly bloomed again in Liliana's mind, laced with panic. #emph[Wait, Chandra, don't rush ahead] —
...
The demon unfurled his wings and launched into the air. He barreled down at Chandra at full speed and rammed into her side, knocking the pyromancer into the side of the Necropolis with a bruising #emph[thud] .
...
#emph[Jace! ] Liliana yelled in her mind.
...
Liliana tried again but found herself unable to #emph[breathe] #emph[.]
...
Jace's voice reappeared in her mind, frantic and distracted. #emph[Gideon on your left!]
...
#emph[Jace,]  #emph[I need you to interrupt his control over me.]

Jace's voice resounded with frustration. #emph[What do you think I've been trying to do for the last ten minutes?]

She didn't have time for this.

#emph[Drop the invisibility and focus on that while he's distracted!]

Razaketh's eyes went unfocused.

#emph[Got him, move fast, ] Jace said, his mental voice full of strain.
...
#emph[You don't need that, ] Jace said in her mind, #emph[it will only hurt you] #emph[—]
...
Liliana slipped the veil back into her dress. If the situation became dire she could always pull it back out, but for now she wanted to test her own abilities. The dying demon before her made her feel particularly #emph[indulgent] .
...
Liliana held her head high, peering down at Razaketh in a way she hoped he could #emph[feel] .
...
Liliana felt him brush against the side of her mind with a cautious touch, asking for an invitation to peer in. Liliana welcomed his mental gaze. #emph[Look Jace, ] she thought, #emph[at what I plan to do next.]
...
She feasted, and he #emph[screamed] .
...
#emph[Liliana, that's enough] #emph[,]  Jace pleaded.#emph[ Liliana, he's dead. Please stop.]
...
"I agree," Gideon said, "but we intervened to #emph[save you] , despite your deception about the demon's presence."
