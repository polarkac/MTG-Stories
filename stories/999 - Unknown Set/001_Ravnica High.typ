...
#figure(image("001_Ravnica High/03.jpg", width: 100%), caption: [Isperia, Supreme Judge | Art by Scott M. Fischer], supplement: none, numbering: none)
...
#figure(image("001_Ravnica High/05.jpg", width: 100%), caption: [Shattering Blow | Art by Steve Prescott], supplement: none, numbering: none)
...
#figure(image("001_Ravnica High/06.jpg", width: 100%), caption: [Dynacharge | Art by Matt Stewart], supplement: none, numbering: none)
