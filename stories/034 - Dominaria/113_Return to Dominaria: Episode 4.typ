...
#figure(image("113_Return to Dominaria: Episode 4/01.jpg", width: 100%), caption: [Art by Chris Rahn], supplement: none, numbering: none)
...
#figure(image("113_Return to Dominaria: Episode 4/02.jpg", width: 100%), caption: [Art by Dimitar], supplement: none, numbering: none)
...
Tiana's first real flight was wonderful, and she played the wind against her wings as she followed the other angels. They flew past hills dotted with small towns and villages, and then over heavy forest, and finally out over broad grassy plains. Tiana spotted a well-worn road winding along beneath them and knew they were getting close. Her heart pounded with excitement. She was about to see the reason for her birth. Which was not to fight at the side of Lyra Dawnbringer and the other battle angels to destroy the forces of darkness, but to protect a large and complicated machine. #emph[But it's an important machine] , she told herself. #emph[And I'm sure it'll be attacked a lot.]
...
#figure(image("113_Return to Dominaria: Episode 4/03.jpg", width: 100%), caption: [Art by Eric Deschamps], supplement: none, numbering: none)
...
She hadn't even wanted the mission to watch over the revival of the #emph[Weatherlight] 's Powerstone. She had been picked for it because she had been created to protect a machine and the #emph[Weatherlight]  was a machine and this was the only thing the Church of Serra could think of to do with her. She had never expected to feel this way about the skeletal remnant of a skyship, no matter how legendary its reputation.
...
And if Serra didn't want her to do it, she wouldn't be sending her this new knowledge. Tiana loved fiddling with the skyship's mechanical systems, loved figuring things out and fixing them. She thought maybe she loved the #emph[Weatherlight] .

It was well past midnight and Tiana was taking a break, perched up on the scaffold to contemplate the waves rolling up the beach and the stars, when she heard someone run toward the #emph[Weatherlight] . She rolled off the platform and dropped to the ground as Farim, Hadi's young cousin, sprinted into the torchlight. "What is it?" Tiana said, keeping her voice low.
...
"Who are you?" Tiana asked. It might be more accurate to say #emph[who were you] , but that also seemed like adding insult to injury.
...
#figure(image("113_Return to Dominaria: Episode 4/04.jpg", width: 100%), caption: [Worn Powerstone | Art by Henry G. Higginbotham], supplement: none, numbering: none)
...
#figure(image("113_Return to Dominaria: Episode 4/05.jpg", width: 100%), caption: [Art by Lius Lasahido], supplement: none, numbering: none)
...
"Mmm," Tiana said. She didn't want a rest, she wanted to work on the #emph[Weatherlight] 's systems while she still had a chance.

But at least with Arvad she had someone to talk to at night who didn't sleep either, and who shared her fascination with the #emph[Weatherlight] . She sat down on the beach with him during her break from night patrol, and they both contemplated the skyship. With bright moonlight and their night vision, it was almost as good as looking at it in the daytime.
...
Arvad paused. "She isn't . . . #emph[the]  Jhoira? The one from the legends about the original #emph[Weatherlight] ?"

"She #emph[is]  that Jhoira, and those aren't legends, they're all true." Tiana admired the way the moonlight glanced off the new glass in the #emph[Weatherlight] 's ports.
...
Arvad nodded toward the #emph[Weatherlight] . "That's a great machine."

Tiana sighed in exasperation. "But it's also not my assignment. Serra is giving me the knowledge to help rebuild it, but the #emph[Weatherlight]  is not my reason for existence."
...
Tiana didn't respond. In a month or so the #emph[Weatherlight]  would be ready to fly again. Could she let it fly without her? #emph[You'll have to] , she told herself. She was an angel, and joining Jhoira's crew wasn't her purpose.
...
#figure(image("113_Return to Dominaria: Episode 4/06.jpg", width: 100%), caption: [Art by Daarken], supplement: none, numbering: none)
...
The creature shrieked and twisted in midair. Determined to keep it from falling on the #emph[Weatherlight] , Tiana shoved it toward the beach. She kept pushing until her skin started to singe and the primal fear of burning her wings off made her disengage. Flapping to stay aloft, she watched the phoenix tumble, try to right itself, then fall into the waves in a broken heap.
...
"Arvad saved us," Tien said, still breathing hard. She pointed toward the smoking ruin of a tent. "He lifted the canvas so we could get out. And he saved the #emph[Weatherlight] . I think he saved you, too."
...
And Tiana had acted exactly like a guardian angel. The #emph[Weatherlight] 's guardian angel. The thought of the skyship being destroyed had almost destroyed her. She knew now she would defend it to the death. #emph[Is this what you want, Serra?]  Tiana asked, but there was no answer. Maybe because she already had her answer, when Serra had empowered her sword with enough force to kill the phoenix in one blow.

When Jhoira returned, Tiana would offer to serve her as crew on the #emph[Weatherlight] . It wasn't the purpose she had been born for, but it was the one she wanted more than anything.
