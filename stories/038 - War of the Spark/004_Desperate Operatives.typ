...
#figure(image("004_Desperate Operatives/01.jpg", width: 100%), caption: [Nissa, Who Shakes the World | Art by: Chris Rallis], supplement: none, numbering: none)
...
As we moved deeper into Selesnya, I watched Teyo's eyes get progressively wider and wider. I don't think he'd seen anything like this before on that desert world he came from. That Gobakhan. #emph[Everything]  about Ravnica seemed to amaze him, which was adorable.
...
#figure(image("004_Desperate Operatives/02.jpg", width: 100%), caption: [Emmara, Soul of the Accord | Art by: Mark Winters], supplement: none, numbering: none)
...
But ultimately, Mistress Ses acquiesced with a nod: #emph[Trostani is once again in Harmony. It is the will of Mat'Selesnya that the Conclave join the other guilds to defeat Nicol Bolas.]
...
Before Mistress Kaya could even mention my name, Gan Shokta barked out: "I need no reminders of my~#emph[momentary failing] . I owe you. I acknowledge that. But don't think for a moment I'm any happier to see you than the cyclops. Believe me, you couldn't have come at a worse time."
...
Gan Shokta turned: "#emph[Here? Where?] "
...
#figure(image("004_Desperate Operatives/03.jpg", width: 100%), caption: [Borborygmos Enraged | Art by: Aleksi Briclot], supplement: none, numbering: none)
...
I said, "It probably won't work, but~point his head at exactly where I'm standing." I was watching Master Zarek, as Teyo and Mistress Kaya listened to me. He #emph[still ] thought they were teasing him, I guess, and he rolled his eyes at their pathetic "prank."
...
#figure(image("004_Desperate Operatives/04.jpg", width: 100%), caption: [Kraul Harpooner | Art by: Kev Walker], supplement: none, numbering: none)
...
We all scanned back and forth for signs of an ambush. I watched Master Zarek check the Accumulator he wore on his back. I leaned in and looked at the gauge. It was a few degrees past maximum capacity. Draining the Beacon must have meant sucking in a #emph[lot ] of juice.
...
With some formality, he said, "We appreciate the greeting, Storrev." The Erstwhile looked mildly surprised and maybe a little flattered that Master Zarek knew her by name. And again, he gave off the clear thought—and this time, maybe a little less begrudgingly—#emph[Thank you, Rat.]
...
#figure(image("004_Desperate Operatives/05.jpg", width: 100%), caption: [Vraska, Swarm's Eminence | Art by: Anna Steinbauer], supplement: none, numbering: none)
