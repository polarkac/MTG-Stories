...
Anyway, nine guilds secured. One to go. And four missions down. Two to go. Well . . . three, really. Can't forget the final mission. 'Cuz when all this, you know, #emph[easy stuff]  has been gotten out of the way, there was still the dragon.

#emph[Yeah. There's still the dragon.]
...
The skeleton whispered, "You've got us all wrong, Mistress. We're just trying to #emph[entertain]  you."
...
#figure(image("005_Operation Desperation/01.jpg", width: 100%), caption: [Dead Revels | Art by: David Palumbo], supplement: none, numbering: none)
...
#emph[I hate them! Why are they still here when she's gone?]

#emph[Why am I still here when she's gone?]
...
#emph[What a dumb, obvious thing to say. Yet what else ] is#emph[ there to say?]
...
We were all sweating #emph[a lot]  now. Even Teyo, the boy from the desert. He shrugged and said, "It's not the heat; it's the humidity."
...
#emph[I wonder if she mourns her mistress, too.]
...
#emph[I never liked her very much.]
...
But in that moment, Rakdos's booming voice echoed throughout the entire cavern: "#emph[WHERE IS OUR EMISSARY?] "

#figure(image("005_Operation Desperation/02.jpg", width: 100%), caption: [Rakdos, the Showstopper | Art by: Viktor Titov], supplement: none, numbering: none)
...
#emph[No. No, no, no, no, no] #emph[ . . .] #emph[ Why would you do that to me?]
...
Dame Exava knelt beside Hekara and jerked her shroud away. Exava flung it into the air, and it burst in flames dramatically—#emph[overdramatically] . Its ashes rained down on us all.
...
"That is #emph[not ] the Cult's concern."
...
Mister Vrona looked right at Mistress Kaya: "I am executive assistant to the #emph[true ] guildmaster of the Orzhov. For years, I believed that to be Teysa Karlov. Now I know it is Kaya. And so I have been about the business of serving my mistress."

Kaya smiled and thanked him. Then the epiphany hit: "Tomik, #emph[you're ] the one who actually rallied the Orzhov troops into battle."

"That was mostly the giant Bilagru. You made a good impression on him."

"After you sent him to me and primed the pump."

Mister Vrona tilted his left hand as if to say, #emph[Such is my duty.]
...
Dame Exava interrupted, "#emph[Emissary]  Hekara died because she placed her trust in you three." She pointed from the queen to Master Zarek to Mistress Kaya. "One of you betrayed her, one of you denied her, and one of you simply failed her."
...
"#emph[WE ALREADY KNOW EVERY DETAIL OF THE LATE FIREMIND'S LATEST GRASP AT POWER] ," echoed Rakdos's voice. "#emph[WE'LL HAVE NONE OF IT!] "

Dame Exava smiled dangerously. "I think you should go," she said.

"But—"

"Before you #emph[really]  piss him off."
...
But I wasn't really listening. I smelled something or heard something or sensed #emph[someone] ~I was staring at the opening of the Jester's Crypt. Somebody behind me gasped.
...
"Stop it," Hekara said. "You'll embarrass me. #emph[Just kidding!]  I never get embarrassed. Be as mushy as you want. It's horrible theater but we all have our guilty pleasures, right?"
...
"There's no need," Dame Exava said. "#emph[I'm ] doing that."

But #emph[Dame ] Hekara just wagged her finger at Exava. "But you're not the Boss. Not the boss of me, anyway. You're just a blood witch. And since I'm a blood witch now, too, I'm thinking I don't need to follow your orders. You don't outrank me anymore, Exava. You just kinda side-rank me."

"Witch, I'll kill you all over again!" Dame Exava leapt, her bloody hands reaching for Hekara's throat.

Hekara cartwheeled away. The cartwheel morphed into a somersault, which morphed into a backflip. Hekara landed on the stage, and I #emph[applauded] !
...
#figure(image("005_Operation Desperation/03.jpg", width: 100%), caption: [Blade Juggler | Art by: Dmitry Burmak], supplement: none, numbering: none)
...
"#emph[C'mere, baby-cakes, gimme some sugar.] "
...
#emph[I just lost her all over again] ~
...
I guess at some point I #emph[must ] have resumed breathing.

I mean, she was alive, right? That's what really mattered. #emph[I]  had lost her, but at least she was back, you know?

#emph[There are worse things than finding out that someone you love is still in your world] ~#emph[even if you're no longer in hers.]
...
I pretended I couldn't hear them. I just decided to, I dunno, #emph[bask]  in Hekara's presence for a bit.

And at some point, I must have resumed breathing.

A part of me probably thought she'd see me again.

#emph[Just give it time] ~
...
Master Zarek, Mistress Kaya, and Queen Vraska were already present, as was Hekara, of course. Miss Lavinia arrived next. It seems Master Dovin Baan had fled Ravnica, and #emph[Mistress ] Lavinia was now acting guildmaster of the Azorius Senate.

#figure(image("005_Operation Desperation/04.jpg", width: 100%), caption: [Lavinia, Azorius Renegade | Art by: Steven Belledin], supplement: none, numbering: none)
...
#emph[But that's fine, right? It's fine!]
...
#emph[Krokt knows I can't afford to lose anyone else.]
...
Master Lazav "reassured" Master Zarek in a lazy drawl, "Your accomplished chief chemister is sleeping one off. He'll be just fine come morning—assuming this succeeds, and #emph[any]  of us are just fine come morning."
...
Mistress Kaya said, "Five minutes? Time is precious, but at five minutes we can't afford #emph[not ] to make the effort."
...
#emph[An odd number, 'cuz, you know, Borborygmos is a cyclops and only has one.]
...
As the light from the fire had gleamed brighter and brighter, it had attracted the attention of one of the God-Eternals. I couldn't remember its name, but it had a kinda bird-shaped head and only one arm. The giant creepy crossed the plaza in tremendous strides and was soon looming over the ruins of the former embassy, peering down on Operation Desperation, still in progress, and all of #emph[us] !

#figure(image("005_Operation Desperation/05.jpg", width: 100%), caption: [God-Eternal Kefnet | Art by: Lius Lasahido], supplement: none, numbering: none)
...
The eleven were just beginning to come out of their trances. Master Zarek shook his head to clear it and then looked up . . . #emph[just in time to see Master Niv-Mizzet fall.]
...
Master Zarek looked stunned, and everyone else looked stricken, angry, or both. Suddenly, the notion that Master Niv-Mizzet would somehow have the power to defeat Nicol Bolas seemed foolish and, well, #emph[desperate] .
