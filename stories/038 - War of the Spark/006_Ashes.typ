...
I thought maybe they'd all have a common Oath, but Mister Beleren was briefer: "Never again. For the sake of the Multiverse, #emph[I will keep watch] ."

#emph[Right. Variations on a theme. That keeps it more interesting, at least.]

Miss Nalaar stepped forward and spoke: "Every world has its tyrants, following their own desires with no concern for the people they step on. So, I say, never again. If it means folks can live in freedom, #emph[I will keep watch] . With all of you."

Mister Teferi intoned: "From time out of mind, the strong have plagued the weak. Never again. For the lost and forgotten, #emph[I will keep watch] ."
...
#figure(image("006_Ashes/01.jpg", width: 100%), caption: [Chandra, Fire Artisan | Art by: Yongjae Choi], supplement: none, numbering: none)
...
We rushed toward the Citadel, most of our forces shouting battle cries. (Though not me. Not much point in shouting a battle cry that no one can hear.) My knives were still in their sheathes, as my mother had insisted I borrow a light battle axe from her. I'm not actually sure if it was an improvement. "Light" or not, it was still a heavier weapon than I was used to, and my arm strength probably isn't what it should be for the daughter of Ari Shokta. But it made her feel better to see me better armed. And since she #emph[could ] see me and might worry, I complied.
...
Borborygmos was sweeping the area ahead of him, using two large maces to shatter the creepies left and right. Mister Fayden fought in the cyclops's shadow, using a hex that magnetized the Eternals' lazotep coating, causing the creepies to crash into each other and, well, #emph[stick] . In their attempts to free themselves, they usually tripped and fell, leaving themselves open to attack. Mister Fayden would then move in and finish the clump of Eternals off with his sword. It was extremely effective.
...
#figure(image("006_Ashes/02.jpg", width: 100%), caption: [Samut, Tyrant Smasher | Art by: Aleksi Briclot], supplement: none, numbering: none)
...
Hekara clapped her hands, jingled her bells, and cheered loudly for her unholy guildmaster: "Go get 'im, Boss!" She turned toward Master Zarek, Mistress Kaya, and Queen Vraska, shouting, "Toldja he was on board. He #emph[loves ] this plan!"
...
#emph[But can he match Nicol Bolas?]

And then I spotted Mister Jura, riding atop the demon's head. #emph[Rising up ] within the very flames of Lord Rakdos's crown. Mister Jura's white aura of invulnerability must have been protecting him from the hellfire, but from where I stood, he seemed only to be at the white-hot center of a hellish blaze.

#figure(image("006_Ashes/03.jpg", width: 100%), caption: [Unlikely Aid | Art by: Viktor Titov], supplement: none, numbering: none)
...
Blackblade #emph[shattered ] against Nicol Bolas's invincible brow.
...
But I wasn't too far away to see her take a few steps forward as dark mana began to swirl around her. And as it swirled, the Eternals—once again—#emph[stopped]  fighting us. Instead, they stood at attention for a full five seconds~before all the creepies and the two God-Creepies about-faced to march on Nicol Bolas.

I knew then that Miss Raven-Hair had switched sides. No way to know why—any more than I understood why she had been fighting #emph[for ] the dragon in the first place. But Miss Vess controlled the Eternals, and the Eternals had clearly turned on their master, at their mistress's command.
...
Then from somewhere, Mister Goldmane called out, "#emph[Look!] "
...
#figure(image("006_Ashes/04.jpg", width: 100%), caption: [Liliana's Triumph | Art by: Kieran Yanner], supplement: none, numbering: none)
...
#figure(image("006_Ashes/05.jpg", width: 100%), caption: [Planewide Celebration | Art by: Wisnu Tan], supplement: none, numbering: none)
...
#figure(image("006_Ashes/06.jpg", width: 100%), caption: [Oath of Kaya | Art by: Wesley Burt], supplement: none, numbering: none)
...
Then we all watched as the two women and Mistress Aurelia lovingly, #emph[tenderly] , wrapped Mister Jura's armor in the leaves.
