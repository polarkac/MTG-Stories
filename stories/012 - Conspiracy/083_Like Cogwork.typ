...
#figure(image("083_Like Cogwork/01.jpg", width: 100%), caption: [Muzzio, Visionary Architect | Art by Volkan Baga], supplement: none, numbering: none)
...
#figure(image("083_Like Cogwork/02.jpg", width: 100%), caption: [Iterative Analysis | Art by Winona Nelson], supplement: none, numbering: none)
...
#figure(image("083_Like Cogwork/03.jpg", width: 100%), caption: [Muzzio's Preparations | Art by Karl Kopinski], supplement: none, numbering: none)
...
#figure(image("083_Like Cogwork/04.jpg", width: 100%), caption: [Deal Broker | Art by Cliff Childs], supplement: none, numbering: none)
...
#figure(image("083_Like Cogwork/05.jpg", width: 100%), caption: [Cogwork Librarian | Art by Dan Scott], supplement: none, numbering: none)
...
#strong[Members present:] #linebreak() Vice Chancellor Alendis#linebreak() Professor Fimarell#linebreak() Professor Muzzio#linebreak() Professor Regness
