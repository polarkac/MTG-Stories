...
#show: doc => conf(
    ...
    set_name: "Kaldheim",
    story_date: datetime(day: 08, month: 01, year: 2021),
    author: "Setsu Uzumé",
    doc
)

#emph[Note: This is Part 1 of a two-part story to be continued. . .]
...
#figure(image("002_Know Which Way the Wind Is Blowing/01.jpg", width: 100%), caption: [Art by: Eric Deschamps], supplement: none, numbering: none)
...
#figure(image("002_Know Which Way the Wind Is Blowing/02.jpg", width: 100%), caption: [Art by: Eric Deschamps], supplement: none, numbering: none)
...
#figure(image("002_Know Which Way the Wind Is Blowing/03.jpg", width: 100%), caption: [Art by: Raoul Vitale], supplement: none, numbering: none)
...
They'd had greatness already. An undefeated champion of countless competitions and tournaments, their accuracy with the javelin was unmatched. Back home, they were famous. It was nice to be unknown for a change. "I have proper boots now. #emph[Ice-foot]  will have to go to someone else."
...
"Winks #emph[out] ," Kjell finished. "The Cosmos Serpent will break its cage and the first thing it swallows will be the light."
...
#figure(image("002_Know Which Way the Wind Is Blowing/04.jpg", width: 100%), caption: [Art by: Kieran Yanner], supplement: none, numbering: none)
...
#figure(image("002_Know Which Way the Wind Is Blowing/05.jpg", width: 100%), caption: [Art by: Aaron Miller], supplement: none, numbering: none)
...
~#emph[For only death draws the attention of the Valkyries.]

#figure(image("002_Know Which Way the Wind Is Blowing/06.jpg", width: 100%), caption: [Art by: Campbell White], supplement: none, numbering: none)
...
The Valkyrie barely had time to turn. The trap hit home right between his wings, shattered the illusion of his body into a thousand mirrored shards—and finished its arc with a soft #emph[chuff] , landing harmlessly in the snow.
...
Niko didn't like the hunger in the way he said #emph[it] . "They're trapped, but they can hear you."
...
"I #emph[kept]  frith," said Niko, jerking a hand back toward the longhouse where the fighters still swarmed like ants. "I'm the only one who didn't leap into this fight and as far as I can tell I'm the only one trying to stop it."
...
#figure(image("002_Know Which Way the Wind Is Blowing/07.jpg", width: 100%), caption: [Behold the Multiverse | Art by: Magali Villeneuve], supplement: none, numbering: none)
...
"#emph[I]  won't. As to what happens on the other side~that's your responsibility."
...
Youths on both sides vociferously scolded by their elders about 'blood-payments' and 'owed for unworthy reasons.' Others kept gesturing to Birgi, 'And in front of the #emph[goddess] ! Shame on you.' Still others laughed about their wounds.
...
Birgi leaned in close. "What kind of mortal steals into another world to play with #emph[cats] , when they can do what you do?"
...
"Fynn saw you. Said you were a threat. Commanded me to keep you close. Stop you, if needed." Kjell flexed his fingers. "Deep roots, stone veins—they all speak to me. When the sky can't, birds tell the rest. The wind breathes, and I hear—but #emph[I]  choose what Fynn hears."
...
#figure(image("002_Know Which Way the Wind Is Blowing/08.jpg", width: 100%), caption: [Niko Aris | Art by: Sara Winters], supplement: none, numbering: none)
