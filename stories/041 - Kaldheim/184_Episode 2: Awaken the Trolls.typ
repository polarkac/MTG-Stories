...
#figure(image("184_Episode 2: Awaken the Trolls/01.jpg", width: 100%), caption: [Mistgate Pathway | Art by: Yeong-Hao Han], supplement: none, numbering: none)
...
All in all, it sounded like precisely the sort of event she told herself she'd avoid from now on. #emph[Stay focused, Kaya. You've got a possibly extraplanar, certainly dangerous monster to find. Plenty to keep you busy.]

A soft #emph[thump ] woke Kaya from a dreamless sleep, and her hand went to the hilt of her dagger before she realized where she was.

Wait. Where #emph[was ] she, though?
...
The forest seemed to go on forever. All the while, Kaya searched for the silvery, organic-looking veins of metal she'd seen in that cave deep in the Aldergard. #emph[I'd take a big, spooky footprint instead. Or maybe some claw marks. ] But there was nothing. No sign that the monster had been this way at all.
...
Hunched over, they stood about as tall as she was, meaning they'd probably be a good bit taller if they ever stood up straight. All of them were green—some a pale green, some a deeper shade, some an ugly mottled pattern—with long, dark hair wrapping their bony forms like a shawl and formidable tusks that clacked together as they opened and closed their mouths, speaking in a language she didn't understand. #emph[Trolls. ] Hadn't seen any on Kaldheim, yet, but there was no mistaking them. And, if the Omenseekers were to be believed, the local variety were a foul-tempered bunch.
...
#figure(image("184_Episode 2: Awaken the Trolls/02.jpg", width: 100%), caption: [Valki, God of Lies | Art by: Yongjae Choi], supplement: none, numbering: none)
...
#figure(image("184_Episode 2: Awaken the Trolls/03.jpg", width: 100%), caption: [Tibalt, Cosmic Impostor | Art by: Yongjae Choi], supplement: none, numbering: none)
...
Tibalt shrugged. "I could ask you the same question. We planeswalkers are meddlers by nature, aren't we? But as you can probably tell, I happened to be in the middle of something before you #emph[so rudely ] interrupted, so if you'll excuse me—kill her!"
...
The trolls glanced at each other. A moment later, both dropped their weapons and ran. She looked up just in time to see Tibalt turn and run into the woods. #emph[Jerk's really going to make me chase him.]
...
"You run like the #emph[devil] !" he said, laughing and wheezing.
...
The thought had occurred to her, yeah. But she #emph[did ] have business here. "There's a monster in Kaldheim. Something from outside of the plane. You wouldn't have had anything to do with that, would you?"

Tibalt cocked his head. "A #emph[monster?]  Why, I'm shivering in my boots! I positively must find somewhere to hide! Let me just—"

"You're not going anywhere, and your troll minions aren't around to help this time. Not like they were able to slow me down."

"Oh, clearly not!" said Tibalt, grinning in a way that made Kaya uneasy. "At least, not the #emph[Hagi]  variety. You proved yourself quite capable of dispatching them. But as far as their cousins, the Torga—well, I like their odds a bit better."
...
#figure(image("184_Episode 2: Awaken the Trolls/04.jpg", width: 100%), caption: [Art by: Simon Dominic], supplement: none, numbering: none)
...
Her head was ringing when she pushed herself back to her feet. It had been a long time since she had been hit that hard. She flipped her remaining dagger tip-down, in a reversed grip. "I #emph[liked ] that blade."
...
Pain exploded along her left side, and then she was tumbling, rolling across the ground. The troll she had #emph[just ] put down—the one who had apparently swatted her—was lurching to his feet; she could see the scratch she'd put on his leg closing up. #emph[They heal too] , she thought, in between the waves of nausea. Why did everything on this plane heal?
...
#figure(image("184_Episode 2: Awaken the Trolls/05.jpg", width: 100%), caption: [Tyvar Kell | Art by: Chris Rallis], supplement: none, numbering: none)
...
"Tyvar, then," she said, trying not to roll her eyes. "I'm Kaya. I appreciate the help, but what's a #emph[great hero ] like yourself doing out in the middle of the woods? Any chance you were following me?"
...
#emph[Oh, ancients. ] "The Doomskar. Alrund said there was a Doomskar coming," said Kaya.
...
"Immersturm," said Tyvar. The name dropped into her stomach like an iron weight; she'd heard Inga whisper stories about that place. #emph[The realm of demons.]  Tyvar, bafflingly, seemed excited at the news.
...
She took a step closer, and something caught her eye. In the bundle of charms around his neck, among the bones and gems and little twisted bits of metal, was a small octahedron of dark stone. Covering the sides was a minute, precise etching—a design she had seen before. #emph[But not here.]
