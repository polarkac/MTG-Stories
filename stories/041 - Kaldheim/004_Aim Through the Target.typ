...
#figure(image("004_Aim Through the Target/01.jpg", width: 100%), caption: [Niko Aris | Art by: Winona Nelson], supplement: none, numbering: none)
...
#figure(image("004_Aim Through the Target/02.jpg", width: 100%), caption: [Art by: Jonas De Ro], supplement: none, numbering: none)
...
#figure(image("004_Aim Through the Target/03.jpg", width: 100%), caption: [Niko Defies Destiny | Art by: Bastien L. Deharme], supplement: none, numbering: none)

"Fate itself sent an agent to punish and push me back, to #emph[correct]  the weave I had unraveled," said Niko.
...
#figure(image("004_Aim Through the Target/04.jpg", width: 100%), caption: [Gods' Hall Guardian | Art by: Sidharth Chaturvedi], supplement: none, numbering: none)
...
#emph[Kick the door in. Punch one in the face.]
...
#figure(image("004_Aim Through the Target/05.jpg", width: 100%), caption: [Stalwart Valkyrie | Art by: Jason Rainville], supplement: none, numbering: none)
...
"Evot, Tove, will you let this affront go unpunished? What about you, Gisla? If Alsig had been attacked by a mortal under the auspices of #emph[keeping frith]  in the middle of a pitched battle, would you have abandoned her? Of course not—you would have fought! This #emph[vision]  they speak of is nothing but Fynn Snakehunter chasing his lost youth. Could you imagine that blowhard flailing against a creature whose body encircles the World Tree itself? Outrageous."
...
#figure(image("004_Aim Through the Target/06.jpg", width: 100%), caption: [Koma, Cosmos Serpent | Art by: Jesper Ejsing], supplement: none, numbering: none)
...
"Someone must have released it—sent it—but who would attack us?#emph[ Why?] " Avtyr stammered.
...
#figure(image("004_Aim Through the Target/07.jpg", width: 100%), caption: [Starnheim Unleashed | Art by: Johannes Voss], supplement: none, numbering: none)
