...
#show: doc => conf(
    ...
    story_date: datetime(day: 04, month: 09, year: 2020),
    author: "Miguel Lopez",
    doc
)
...
#figure(image("002_Red Route/01.jpg", width: 100%), caption: [Clearwater Pathway | Art by: Daarken], supplement: none, numbering: none)
...
A small thing. A moment unwelcome: fear, the old friend, always there. Should the hook miss (impossible) or the earth break (quite possible, but unlikely given the rock that composed the gorge), then Akiri would not #emph[fly] , she would #emph[fall] , and that would be the end of her. Another kor swallowed by the Umara. Another kor who forgot what Zendikar thought of them now; even those born to walk tripped once in a while.
...
The fear was there yes, always. But the #emph[freedom] !
...
#figure(image("002_Red Route/02.jpg", width: 100%), caption: [Akiri, Fearless Voyager | Art by: Ekaterina Burmak], supplement: none, numbering: none)
...
#emph[That] , Akiri thought,#emph[ is likely not far from the truth.]
...
An overwhelming burst of anger barely contained: #emph[This is why] , she thought. #emph[Sea Gate, and the climb to Murasa. This is why you're doing this—remember!]
...
Zareth laughed. "Hey now," he said, "#emph[allegedly] ."
...
#emph[The skinless titan, eclipsing the sun. Waterfalls of ocean water spill from its looming form. It spreads its arms as wide as the horizon, and Sea Gate shakes and shimmers with heat.]

—she knew.

"No," Akiri said, "they're gone from this world. We won." Her throat was dry as dust, even now, at the thought of them.

Zareth ate, regarding the map—but not really looking at it, Akiri noticed. Looking #emph[through ] it. She knew that look, the faraway way that caught those who had seen things no one should—

#emph[Nighttime stained orange with fire, the stink of quick-rotting dead and the screams of the living. Her sword heavy and slick with steaming blood. The Eldrazi killed with a touch—some with their mere presence. Comrades crumbled to white ash, choking the air she struggled to breathe. The first rush of the brood beasts nearly overwhelmed them, but somehow, they held, and the air sizzled with energy and the next wave crashed into them.]
...
#emph[The sound of the ocean never still. The rough, gutter fights of human, kor, and merfolk against dust-making Eldrazi drones and lesser spawn. Above, the crack and flash of the walkers' magic blasting apart more terrifying beasts.]
...
#figure(image("002_Red Route/03.jpg", width: 100%), caption: [Umara Skyfalls | Art by: Jesper Ejsing], supplement: none, numbering: none)
...
Akiri shook her head. "This is our world, all of its agonies and sickness. Fixing what has been done to her is our struggle, our charge, our #emph[place] ," Akiri said. "We can't leave."
...
Akiri regarded Zareth for a moment, a long moment. Zareth did not see Akiri the Fearless Voyager, decorated veteran and storied line-slinger, but Akiri unnamed, the young kor officer who pulled him through the darkness at Sea Gate. Her gray skin caked in the flat ash of their dead friends and the decayed landscape. Her eyes, lit by firelight, blank with terror—but still pulling him forward. Akiri who pressed a dead man's spear into his hand and told him that he needed to #emph[fight ] the things that killed the world with a touch, otherwise no one would be left alive when the Battle was done.
