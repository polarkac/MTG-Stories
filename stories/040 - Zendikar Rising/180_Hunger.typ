...
#figure(image("180_Hunger/01.png", width: 100%), caption: [Anowon, the Ruin Thief | Art by: Magali Villeneuve], supplement: none, numbering: none)
...
#figure(image("180_Hunger/02.jpg", width: 100%), caption: [Skyclave Colonnade | Art by: Johannes Voss], supplement: none, numbering: none)
...
#figure(image("180_Hunger/03.jpg", width: 100%), caption: [Grakmaw, Skyclave Ravager | Art by: Filip Burburan], supplement: none, numbering: none)
