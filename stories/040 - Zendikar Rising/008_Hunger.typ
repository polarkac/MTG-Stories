...
#figure(image("008_Hunger/01.png", width: 100%), caption: [Anowon, the Ruin Thief | Art by: Magali Villeneuve], supplement: none, numbering: none)
...
#emph[Ondu] . Anowon's ears perked up at the mention. Even if he didn't get the job, perhaps meeting this particular party was still a small serendipity.
...
#emph[Serendipity indeed] , Anowon whispered to himself.
...
"Bonus?" The emissary grinned. "My client is willing to offer payment #emph[per head] ."
...
#figure(image("008_Hunger/02.jpg", width: 100%), caption: [Skyclave Colonnade | Art by: Johannes Voss], supplement: none, numbering: none)
...
#figure(image("008_Hunger/03.jpg", width: 100%), caption: [Grakmaw, Skyclave Ravager | Art by: Filip Burburan], supplement: none, numbering: none)
