...
#show: doc => conf(
    ...
    story_date: datetime(day: 10, month: 09, year: 2020),
    author: "Miguel Lopez",
    doc
)
...
#figure(image("004_The Magosi Steps/01.jpg", width: 100%), caption: [Zareth San, the Trickster | Art by: Zack Stella], supplement: none, numbering: none)
...
The falling water of the Magosi exploded to steam as it drummed off the titan's sinewy body. It should not have been able to move as it did, flowing up and down the Magosi without effort. This was a beast of legend, some #emph[thing]  that defied classification and stood alone, a being unlike any other, without community or kin. A world unto itself.
...
Akiri holds on. The serpent rises into the falling column of the Magosi. The water hammers down, buffeting her. All she can hear is the roar—the roar of the world, of the beast itself, of #emph[pain]  unimaginable and, cruelly, not endless, but ageless—before the segment of the serpent, she clings to burst free of the water. It is as if Zendikar itself attacks her: the world's anger is in the wind of the falling river that hammers her, the bitter cold, and the beast itself.
...
#emph[And her line caught the anchor. Akiri grinned. Her first. "Good," the slinger captain nodded, her voice a gravel-tint growl. "See it set? Give it a pull to be sure. Put all of your weight on it, kor; you need to trust the line will hold you up!"]
...
#figure(image("004_The Magosi Steps/02.jpg", width: 100%), caption: [Verazol, the Split Current | Art by: Daarken], supplement: none, numbering: none)
...
#emph[A night of fever and ash dust lit only by fire and the chromatic explosions high above, each blast like a dawn in a heartbeat.]

#emph[—] but not Zareth, and even with all her grace and skill, not Akiri.
...
#emph[To be a bloom of the coming spring.]
...
Akiri's first fall was from a short height to a soft mattress stuffed with raw lambswool. This was a planned fall, the first part of any line-slinger's training. Learn to feel what #emph[falling]  feels like.

Her second fall came along a slingers' practice course in the far north of Tazeem. Sturdy anchors lined both sides of the shallow canyon, which was filled with still and deep water, a lake fed by numerous natural springs. There, Akiri learned how to suppress and—in time—ignore the fear of falling for the precious seconds one had at the #emph[top]  of a fall. At height, should an anchor fail, a line snap, or a throw miss, you had a window of time to save yourself; slingers learned not to waste that time being afraid.
