...
#show: doc => conf(
    ...
    story_date: datetime(day: 04, month: 01, year: 2017),
    author: "Chris L'Etoile",
    doc
)

#strong[This story contains references to suicidal thoughts.]

#v(0.35em)
#line(length: 100%, stroke: rgb(90%, 90%, 90%))
#v(0.35em)

#emph[The renegades of Kaladesh rose against Tezzeret's corrupted Consulate. Led by Pia and Chandra Nalaar, armed by the criminal mastermind Gonti, allied with inventors and aether pirates, and supported by the Planeswalkers of the Gatewatch, they have seized Ghirapur's vital Aether Hub. Now they must hold it against Consulate counterattack until the airship ] Heart of Kiran#emph[ can be fueled.]

#v(0.35em)
#line(length: 100%, stroke: rgb(90%, 90%, 90%))
#v(0.35em)

#emph[Skysovereign] 's plotting table was an impressive display of engineering brilliance, decorative artistry, and the Consulate's seemingly inexhaustible funding. It showed, in clear-eyed detail, how poorly the struggle for order proceeded.
...
Overhead, an arm-length replica of the dreadnought #emph[Skysovereign]  dangled from the fixtures at the end of an array of wires, pulleys, and servos. Simulated internal lighting winked out from ranks of pinhole viewports.
...
"So help me," Tezzeret growled. "If you give me #emph[one]  more excuse. Just. #emph[One] . I will #emph[personally]  ram your head through the—"

Baan stepped forward, heels clicking smartly on the steel deck plates. To have the Grand Consul threaten the life of a messenger, as if he were some criminal thug instead of a minister of the apparatus of state, would unacceptably undercut the moral authority of the Consulate for all those present. Not the #emph[legal]  authority, of course, but one was oft-mistaken for the other.
...
#figure(image("005_Burn/01.jpg", width: 100%), caption: [Dovin Baan | Art by Tyler Jacobson], supplement: none, numbering: none)
...
"I predict they will withdraw defenders from the Hub to keep this corridor open. The architect of their defensive strategy exhibits a certain...two-dimensional thinking. I think it likely to be the—to be our #emph[guest] , Mr. Jura." Tezzeret lifted a brow at his dissembling, and glanced around at the command crew. If any had noted Baan's tilt to the word, they did not look up.
...
A flight of miniature thopters whirred to life on the deck of the model #emph[Skysovereign] . They wobbled across the table, and delicately alighted atop the model Aether Hub.
...
Tezzeret drummed his living fingers on the edge of the table, then pushed himself back. He tossed a careless gesture at the model Aether Hub, at the brass figures with their colored flags. "What of your #emph[guests] , Baan? They complicate things."
...
The Grand Consul yanked a speaking tube down from the overhead tangle. "Chief of Compliance Baral to the command deck. #emph[Now] ," he bellowed into the tube. He heard the words reverberate through the halls of the ship.

"Your plan is acceptable." Tezzeret examined his false arm and drew a finger down the length of it. The impossible metal flowed like water under his touch. "I'm #emph[improving]  it slightly. The Nalaars have other weaknesses."
...
The Chief Inspector's eyes narrowed. He glanced to Tezzeret, who, uncharacteristically, said nothing. At last, Baral grunted, "The fire the child started. It #emph[confused]  things. We discovered the mother among the survivors later."

"Indeed?" Baan said, noncommittally. "It troubles me that the reports do not reflect that."

"Paperwork's your business, Minister," Baral growled. "I #emph[work]  for a living. If you spent a day on the streets—"
...
"#emph[Annoy]  the Nalaars. Lure them away from the Aether Hub. Them, and as many of their friends as you can get to follow."

Baral chortled through his ruined half-nose. "Easy enough. Then what?"

Tezzeret waved a dismissive hand. "Whatever you want."

The Chief Inspector raised his remaining brow. "#emph[Whatever] , huh?"
...
Baral straightened, and one canine showed between his lips. Baan couldn't decide if it was a smile or a sneer. "Sure enough. Can't have any dangerous #emph[mages]  running about." He turned to leave.
...
"I'll oversee its execution. Don't worry," he smiled unpleasantly. "I'll credit you. Failure #emph[or]  success." The Grand Consul hunched over the display, his claws etching fine lines across the polished brass.
...
That's where all the other Big Names are. Gonti and Kari and Saheeli and probably some people who don't have names that end in #emph[-i] . She's in total and complete Renegade Prime mode, so she's not mom right now. She's an engineer, solving a problem. All of them at the top of the Aether Hub are trying to figure out how to punch the Consuls in the nethers.
...
Everything's #emph[taller] . The white stone walls and flat roofs I ran across got sunk under brass and turquoise and swirly bits, all glinting and shimmering under noon sun.

#figure(image("005_Burn/02.jpg", width: 100%), caption: [Aetherflux Reservoir | Art by Cliff Childs], supplement: none, numbering: none)
...
But she never does and I can't be #emph[over it]  anymore.
...
That was what the Purifying Fire showed me, back on Regatha. When I last had nightmares. I thought, #emph[I'm responsible, I did it, I screwed up and got everyone killed] . Dad. The villagers. Mom. That was why the cold of it stopped burning. Why the hiss of the flame whispered, "You can be forgiven." But I never forgave me.
...
I haven't thought about what I did on Ravnica. Every time I do, I wanna curl up and pull a blanket over my head. She was nothing but nice to me and I—#emph[It's just, you've been staring at me.]  I watched her die a little inside.

My cheeks and hair ignite. I slap out the flames. The footsteps get closer, slower.

Then we got here, to Kaladesh, all I did was yell at her about my mom. I didn't even think about her. Why did she even #emph[come] , after I made her so uncomfort—

Oh #emph[crap] . I hugged her when we were looking for mom. #emph[Twice] . Without even thinking, because when do I ever? Even though I #emph[know]  how she twitches just when someone brushes past her. She must have been mentally clawing the ceiling. I'm such a—
...
A small breath escapes him, half laugh, half sigh. "Chandra, it's...This is none of my business. I know that. I'm sorry. You've had a lot of shocks. Coming home. Finding your mother alive...That's a #emph[good]  shock, but still a lot to adjust to. Then the man who—then a man tried to murder you. Now your home's in the middle of a civil war. That's more than anyone should have to deal with in two months."

"So you're saying I'm, what, #emph[unstable? ] That it?" Are my hands shaking? My hands are shaking. Damn it, stop that.
...
He's so damn #emph[sincere] . I liked that about him when we met. After I was done being mad at him, anyway. A very sincere, bossy, kind, preachy, thoughtful, annoying, adorable stick in the mud. With muscles in all sorts of potentially interesting places. And eyes with a million colors, like a landscape by...some artist who's real good at landscapes. Also abs you could grate cheese on, which I totally did not think about running my hands over for like six months afterward, so far as he knows.
...
"Sorry," he says quietly, blushing at the deck. "I shouldn't have done that. Not without asking first. I just woke up, and you were...#emph[hurting] ."

"Yeah, I was." I punch his arm, but I'm not feeling it. It's more a tap. At least not a whiff. "If I hadn't been all right with it, you #emph[better]  believe I'd have told you. Then set you on fire."
...
My brain brings old thoughts back, foggy and full of holes. A darkened cell, lit by shimmery moon-on-water light from spells that kept me from casting. #emph[You face the things you've done] , he said, #emph[and accept the weight of your responsibility for your deeds. Without lies, or excuses. What did you do that left you with ghosts to carry?]
...
"I didn't know you, Gids. Not enough, not then. Everything I said was true, it just wasn't #emph[all]  the truth. I told you the important bits. The fire. The screams and—and the smells, and how it felt. How it was my fault. H-how I got them all killed." I clear my throat to hide the break in my voice, which he probably heard, but wouldn't ever say, because that's the sort of Gideon he is. I rub under my nose with a shaking hand, sniff, and wipe it off on my shawl.
...
"I blew up a museum," I blurt. #emph[WHAT?]

He looks back to me, wide-eyed. "#emph[What?] "

#emph[Roll with it, Chandra.]  "I didn't mean to! When we met. On Kephalai. Remember? The Sanctum of Stars. Trying to steal the Dragon Scroll? You turned me in for it. Prison, snake-head guys, all that?"

He winces.

#emph[Wait, no, wrong direction, put the thopter in reverse, ARG!]  "You were right, though. When you said I was hurting innocents. I—I don't know about the #emph[guards] . I don't trust guards. Not anymore, maybe not #emph[ever] . But the Sanctum was all full of people, and—"

When the walls came down, I thought of all the people I'd seen inside. The grandmothers pointing to displays and saying I remember that, in those days, now here's a funny old story, in exactly the same way Mrs. Pashiri used to, and the children rolling their eyes, bouncing in their fraying shoes and looking for a place to run, someplace not dusty and faded but full of light and impossible things. The stones came down on all of them. My fault. Not what I wanted, but #emph[my fault] . Another screw up.

I think I've been quiet too long, because he takes a step toward me. "Chandra." He does lay his hand over mine this time. It's warm and dry, rough with old callouses. "You didn't #emph[mean]  it."

"But I #emph[did]  it, Gids. There are these times when I'm sitting in the bath, and the memory comes up on me outta nowhere. I cringe and I say 'stupid,' like actually out loud, and then I sink under the water. And, um, usually the bath turns into a sauna at that point..." When was the last time I took a bath, anyway? After the last few weeks, I must smell like a goblin blacksmith. "You of all people—"

"I know." He takes his hand away and passes it through his hair, settling the bits I left standing up. I kinda want to ruffle it again. "Chandra, you didn't think about them at the time. Now you do. That you regret it now...it means you've grown. And that you're a good person. #emph[Fundamentally] ."
...
He takes a breath, and winces again. "Sometimes," he says, "yes. #emph[Sorry] . But you're always...doing your best. That doesn't always help, but it matters. It means you can make it right."
...
He looks at me dubiously. "#emph[That]  was your point?"
...
#figure(image("005_Burn/03.jpg", width: 100%), caption: [Oath of Gideon | Art by Wesley Burt], supplement: none, numbering: none)
...
He's five steps away when I blurt out over the rail, "Wait! This is dumb, but I could use a—a hug. If you don't mind. I know; that's weird. I was just thinking how I hadn't had any time with mom, not even #emph[just]  #emph[ten minutes] , and—"

"Chandra."

"You don't have to. Hugs are super personal, right? I mean, you saved my life and all, but that's not a hug. Anyone would save anyone, that's just what you #emph[do] . Maybe not Lili. And anyways I saved you back, so that doesn't even count—"

"Chandra."

"And I know #emph[asking]  for hugs isn't normal. You're supposed to #emph[offer]  them. There's this moment when I'm looking at someone, and it's like gravity or something. It's like I just #emph[know] , but I don't know, you know? #emph[Sorry] . This is all coming out wrong, and—"

"#emph[Chandra] ."

Am I shaking again? I clench my twitching fingers. What the actual hell, Chandra? I swallow hard, wipe my eyes, and turn. He's standing with arms wide, smiling. His fingers wiggle #emph[come on, come on, you big silly] .

Right. Now I have to be cool. Walk over slow, like it doesn't matter #emph[whoops]  I'm already up against him with my arms around his waist. I'm absolutely sure that I didn't run over, so don't you tell me teleportation magic doesn't exist anymore.

He's so damn huge. My head fits under his chin. He smells like sweat and oil, the grime of a long day #emph[lifting]  things.
...
I open one eye and peer over a bicep to see—#emph[OH CRAP] .
...
"Don't mind me, then." She pulls apart the stem of the mango—was she growing that out of her #emph[clothes?] —and places it beside the plate. "I brought this in case you were hungry." She straightens and looks straight at me, calm, hands clasped before her. A million years of suspended green.

#emph[BLINK] . #emph[BREATHE] . Don't screw this up. Just have a normal conversation with her.
...
How do I keep screwing up like this? Innistrad gone all explodey? Perfectly fine, thanks. Talking to Nissa? #emph[Human trash fire] .
...
"No?" she says, cautiously, testing the word. "#emph[No] . There is...much I don't understand. But I'm not upset with you. Believe that."
...
I should be more freaked out about freaking Nissa out by brushing her arm as I whirl around, but I'm too busy looking out across Ghirapur because "The Gremlin's Wedding March" has finally fallen silent and #emph[I know that voice] .

"#emph[I know you can hear me.] " A deep rasp, magnified and tinny, bouncing off the stone and steel around us.
...
"#emph[I was wondering.]  #emph[Have you told your friends the story? About how you got daddy killed? How you got mommy locked in a cell for five...long...years?] "

Everything goes white. Sparks are flying from my eyes. I don't care.

"#emph[Mommy and I talked every day. Oh yes, we did. I reminded her of everything you did. Every day. Did she tell you?] "

Mom?

"#emph[Maybe she was too ] ashamed#emph[.] "

No!

"#emph[Some days she cried. When I told her how your flames took daddy. How he died screaming, skin black and cracking. How he died cursing your birth.] "

"#emph[THAT'S A DAMN LIE!] " It comes out shrill and ragged. The voice of an eleven-year-old.
...
Baral's laughing. "#emph[So many died that day, little monster] ."

"I'm gonna kill him. I'm gonna burn him." The words hiss through gritted teeth, falling like the stars from my eyes.

#figure(image("005_Burn/04.jpg", width: 100%), caption: [Exquisite Firecraft | Art by Chase Stone], supplement: none, numbering: none)
...
He clenched his fists. "This is—She could get herself #emph[killed] . Calling her out like that? He's riling her up for an ambush. She's not thinking, just feeling, and we should be the ones who..." His stomach pulled taut, stabbed by ice, suspended in free-fall. Why wasn't he halfway down the stairs already?
...
#emph[There comes a time, boy, ] Hixus' voice echoed forth from years long gone, #emph[when you must choose between what you want to protect, and what you ] need#emph[ to.]
...
The location had been Baan's suggestion. A maze of old-construction stone buildings along the river, stripped and bare, their yards long dried up and blown away. Nothing #emph[combustible]  anywhere.

He swung around a corner, tipped up the filigree mesh of his helmet, and bellowed over his shoulder, "All that time your mother #emph[suffered] . Thinking you were #emph[dead] ."

She sprinted around the far corner, wreathed in a crimson cometary nimbus. Lips pulled back from her teeth as she spread her fingers, stretched out her arm, and #emph[shoved] .
...
"And what were #emph[you]  doing while she rotted?" he sneered. "Off enjoying life?" He ducked around the corner as she stumbled and swore, sparks streaming from her flaming hair.
...
#emph[She set the thorns on fire!]
...
Thopter buzz set pebbles of old pavement into clattering migrations. "#emph[Chief!] " a voice called down over the din, flat and tinny with mechanical amplification.
...
#figure(image("005_Burn/05.jpg", width: 100%), caption: [Art by Min Yum], supplement: none, numbering: none)

#figure(image("005_Burn/06.png", height: 40%), caption: [], supplement: none, numbering: none)

His arm was yanked to a halt, wouldn't move.

He glanced to it—#emph[wrapped in]  #emph[a flaming vine?] —and that was all the mistake she needed. The fire held in her hand burst open, flaming petals licking across his armor, searing through his faceplate.
...
"#emph[Two hundred meters south!] " Baral bellowed over the din, waving toward the silhouette. "#emph[Elf on the roof!] "
...
#figure(image("005_Burn/07.jpg", width: 100%), caption: [Guardian of the Great Conduit | Art by Christine Choi], supplement: none, numbering: none)
...
The elf had reached the girl, who stumbled toward her, nostrils flaring. "I can't move my arm, #emph[I can't move my arm!] " she panted, eyes wide.
...
Baral swung into the cabin as the pilot lifted away. "I want a Gearhulk on the elf. #emph[Now!] " he snapped.
...
He swore at the fireball. #emph[Just goddamn dirt!]  "The Torrential could #emph[wash]  this damn thing away—"

"We are a #emph[diversion!] " Baan insisted.
...
"#emph[Does ] she#emph[ know, little pyromancer?] " he bellowed down at them. "#emph[Did you tell her? About the village that burned because of you? The screams of the children?] "
...
Baan yanked the megaphone to his mouth. "#emph[Those devices are certified for external use only. A malfunction could seriously injure one's sph—] "

She gestured up at him, emphatically.

"#emph[I am only interested in the safety of all citizens] ," Baan said, huffily.

Baral slapped the megaphone out of the Minister's hands. It pinwheeled into empty space. "She's #emph[diverted] . Get me someplace visible from the Aether Hub." He grinned. "Someplace we can inspire #emph[mommy]  to join us."
...
Baral followed his glance. High above them, the black specks of thopters lifted from the decks of #emph[Skysovereign] .
...
Nissa. #emph[Chandra] . Where were they?

#emph[No time for that. On your feet, hoplite. Observe the situation. Keep moving. Turn the initiative.]
...
#emph[Well, hoplite, it appears there's a giant mechanical man strolling down the street, malleting parked vehicles through the renegade positions ahead. There are four other giants out there, pressing in. Three on this side, two on the other. You don't know exactly where, though. City streets are canyons, and you're at the bottom of one. Tactically, the worst place to be. Water and fire flow downhill.]

#emph[What do you do, Gideon? There are lives at stake, and you're standing in the open like a child in their first sparring match.]

#emph[First, you need to understand what's going on.]

He needed a view from high ground. It would take too long to get to a roof. The front line would have moved on. If Ajani were here, #emph[he'd]  be able to—

#emph[Focus on the possible.]

The Gearhulk #emph[was]  the front line, and it towered over the roofs. He sprinted after it, timing the shudders of its ponderous footfalls. There were rungs leading up one of its legs, for maintenance or inspections.
...
Jace would have planned this better. #emph[Chandra]  could have planned this better.
...
#figure(image("005_Burn/08.jpg", width: 100%), caption: [Art by Daarken], supplement: none, numbering: none)
...
"'White Cat' said that wasn't your codename, but 'Night Queen' was #emph[quite]  insistent it should be."
...
"Yes, hallo! Call me 'Shadowblayde.' Spelled with a #emph[y] , thank you ever so much I'm sure." Gideon was clinging to the waist of a giant mechanical man, but this conversation had quickly become the most surreal thing to happen today. "With 'Cloak Boy' away, I'm running communications."

"Where's Liliana?" he asked the butterfly.

"#emph[Night Queen] ," Shadowblayde's voice said, firmly.
...
#emph[What are you going to do about it, hoplite?]
...
A portion of the darkness lifted away. Warm brilliance flooded his stinging eyes. #emph[Chandra..?]

A grinning face eclipsed the sun. "Who's a big hero?" Shadowblayde-with-a-#emph[y] .
...
#figure(image("005_Burn/09.jpg", width: 100%), caption: [Art by Winona Nelson], supplement: none, numbering: none)
...
#emph[...like harpies over Akros.]

"Get back to the Hub!" he shouted, breaking into a run. "#emph[Double time!] "
...
Mommy. Daddy. #emph[Monster] . Dead. Suffer. Murder. #emph[Monster] . Village. Fire. Children. #emph[Monster] .

I don't hear them anymore. Can't assemble them into thoughts. Just sounds. Just #emph[kindling] .
...
"Look. What. You. #emph[Did] ."

Baral, his ruined face split with a shatter-toothed grin. The lifting thopter blows grit into my eyes. "Maybe it would have been different if you'd been there." Sun gleams on the edge of his blade. He angles it into my face. "Or maybe...#emph[more]  of them would be dead."

I feel the hair lifting off my scalp. Scalding, frigid light floods the roof.

"You're not exactly #emph[accurate] , after all. Are you, #emph[monster?] "
...
Nissa has a #emph[sword?]

#figure(image("005_Burn/10.jpg", width: 100%), caption: [Sword of the Animist | Art by Daniel Ljunggren], supplement: none, numbering: none)
...
His stupid #emph[metal-covered]  face. I scream at the crunch.

"Idiot monster," he mutters, and kicks. Hard.

Pain explodes from my gut.

I retch into hot, stinking slime, struggling to inhale, every breath another endless agony. I'm not crying because #emph[screw that guy.]
...
The blade falls. I want to look away. I want to #emph[move] .
...
"Stay away from that child, you #emph[son of a donkey!] " Mrs. Pashiri thunders.
...
#figure(image("005_Burn/11.jpg", width: 100%), caption: [Ajani Unyielding | Art by Kieran Yanner], supplement: none, numbering: none)

I can only puff weakly, sparks falling from my eyes.

The crowds on the Hub are running to #emph[Heart of Kiran] 's gaping hatches. Half-fitted turrets spark and crack at ranks of faceless inspectors. Consulate thopters drop gleaming aerial torpedoes, coughing to life on wide contrails of hissing exhaust.
...
"That's the face," Baral grins. His breath smells of cheap vendor meat and too much sugared chai, weeks of meals alone. My arms strain against him. "#emph[Despair] . Just like when I had you in the arena, monster. My blade on your little neck."

The third crack shatters the world.

Mrs. Pashiri seizes and topples, smoke-colored braids flying apart.

He laughs. "Is there #emph[anyone]  you haven't killed?"
...
I gather the air, set it alight, and #emph[squeeze] . Between my hands, sparks ignite, blazing golden fish swarming. They shudder, frantic, turning arsenic-white. Like I've done a thousand times before.

Baral tips his dented helmet back. It clatters across the roof. He's smiling. "I killed your daddy, renegade," he says. "I killed your #emph[auntie] ."
...
"And now I'm going to kill you." He pulls a dagger from his sash. A simple dagger, with old stains on the blade and a charred grip. "And the best part, the absolute #emph[best]  part, is that there's nothing you can do about it."
...
"There #emph[is]  something I can do," I tell him.
...
"...Something I can #emph[always]  do..."

I can take out Baral. The ships and the Gearhulks. Tezzeret and the Consuls. I could take out all of Ghirapur, if I want. It's so #emph[easy] . I just have to bottle it up, and release. I just have to #emph[let go] .
...
I close my aching eyes on Kaladesh, and whisper, "...I can #emph[burn] ."

#figure(image("005_Burn/12.jpg", width: 100%), caption: [Chandra's Fury | Art by Volkan Baga], supplement: none, numbering: none)
...
Her arms squeeze tighter. "#emph[No] ."
...
The fire's gone strange. It's still getting hotter, collapsing inward. It's burning on its own, burning #emph[itself] , without anything from me. I blink, and scratches of light claw through the brief dark.
...
"Fine." He limped toward them, favoring the leg she'd seared. Sometimes you just had to get your hands dirty. Like father, like daughter. He tightened his grip on the stained old blade. "All you have is fire. If you're not willing to burn, what are you going to do?" he sneered. #emph["Punch]  me again?"
...
"#emph[Leave] ," the elf said coldly, and turned away.
...
"She is a #emph[citizen] ."

"A monster!" he barked, and was left breathless by the words. "All mages are monsters," he whispered to the sky.

Baan sighed and tented his fingers, forearms resting across his knees. His face was grave, stained with nauseating pity. "Chief Inspector Dhiren Baral, I charge you with one count of murder—possibly with more yet to be uncovered—and one count of #emph[attempted]  murder. I charge you with one count of extrajudicial incarceration—again, possibly with more to be revealed. Finally, I charge you with multiple counts of falsification of the public record, with the express intention of obscuring your crimes.
...
"#emph[Up]  we go," he grunted, staggering to his feet. She didn't weigh much, not really. He was just...sore. The throbbing fever-heat of her felt good against the bright red bruises hidden under his shirt.
...
#figure(image("005_Burn/13.jpg", width: 100%), caption: [Solidarity of Heroes | Art by Eric Deschamps], supplement: none, numbering: none)
...
"Perhaps," he said. "It is to be hoped that you do. But you still need to #emph[hear]  it."
...
"But I never #emph[asked!] " she snarled, slamming a fist into her own knee. She wobbled to her feet, took a step toward the door, and collapsed. Ajani caught her with one arm. "Damn it!" she said, through gritted teeth. "I can't even—I just...I wanna #emph[leave] . I shouldn't be here. I don't deserve—"
...
"#emph[Child] ," Mrs. Nalaar said, in a voice high and tight as a lyre string.
...
She pulled back and looked Chandra in the eye, cupping dark hands on sunburnt cheeks, pressing her forehead to her daughter's as tears rolled across the old grief-lines etched in her face. "Do you hear me? I #emph[can't] . It would break me. #emph[I love you] ."
