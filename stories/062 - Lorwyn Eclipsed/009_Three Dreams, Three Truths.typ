...
#show: doc => conf(
    "Three Dreams, Three Truths",
    set_name: "Lorwyn Eclipsed",
    story_date: datetime(day: 07, month: 01, year: 2026),
...
#figure(image("009_Three Dreams, Three Truths/01.jpg", width: 100%), caption: [Art by: Omar Rayyan], supplement: none, numbering: none)

#emph[But what is it they are whispering?]  The thought should not occur to him. And #emph[yet] .
...
"Boring, boring, #emph[boring] ," says the Meadowsweet faerie. They fly up to Morecote. A grin on their face, they wave a rapier in front of him. "How about we make this more interesting? We know things you don't. If you duel all of us at once and win, we'll tell you something."
...
In the false quiet of the woods no one can hear the #emph[pop]  that follows—only Morecote, close as he is. The others hear only the laughter's cold cessation—and the cry of pain from Sigric. Blood spills upon the white Meadowsweet and upon the bark of the ash tree.
...
Erewaker is upon Sigric within an instant. Her brows knot in concern as she frantically tries to figure out what's happened to him. Burr and thorn, she searches. "What did you #emph[do] ?"
...
Yes—mold. #emph[Wasn't it with him in the dream, too?]
...
But the moment Kellan laid his hand along the shapes, an unseen axe hewed the tree in one fell stroke. And what he saw inside was what had frightened him: sloughs of mold, a blanket of rot balled up within something that had seemed so proud and unshakable. And as the tree fell to the ground, it #emph[screamed] .

#figure(image("009_Three Dreams, Three Truths/02.jpg", width: 100%), caption: [Art by: Forrest Schehl], supplement: none, numbering: none)
...
He starts with the voice he'd heard at the end of the dream, a woman's strange and distant echo: "#emph[Rotten trees may yet bear sweet fruit.] "
...
Erewaker glances to her side. Morecote has not said a word since the duel, if one could call it a duel at all. Grief and guilt have stitched his mouth shut; the proud ash has given over to consideration. Better for all of them that way. Still, part of her wishes that he would say something. #emph[Anything] . That she could yell at him for his mistakes and berate him and let loose the anger that burned within her. Respite, of a kind. Catharsis. But it would not be worth the cost.
...
#emph[No, it really cannot wait, can it?]
...
Each word is an axe against her trunk; she has to bite back a wince. #emph[But what to say instead?]  Before she can figure it out, the giant groans and shifts.
...
Morecote takes another step forward—and it is then that he points at the giant's head. #emph[What? What could possibly—]
...
She looks to Morecote with a silent question. #emph[Will you be all right?]
...
Who could stop them from doing what they meant to do? So high up, they were, and so far from even Morecote's grasping hand. All Erewaker can do is watch in horror as they harry the giant. Something in her goes cold. They need to #emph[move] .
...
He hears a woman's voice. "#emph[Crowns fall like acorns, from one tree to another.] "
...
What was once lively now stalks the dark in search of food; what was bright and welcoming now foretells only misery. Or perhaps that is a trap of her own making? With every step the relic swings against her bark and she thinks: #emph[all of us should be safe.]
...
It has to work. It has to mean #emph[something] .
...
Dread rises in her heart. Her tongue feels leaden. Something is wrong. #emph[Has this whole journey been cursed from the start?]  A pained whine leaves her; a moment of weakness that echoes and haunts her.
...
#figure(image("009_Three Dreams, Three Truths/03.jpg", width: 100%), caption: [Art by: Jesper Ejsing], supplement: none, numbering: none)
...
"#emph[Home has its horrors. And its welcome. I await you with high hopes.]"
