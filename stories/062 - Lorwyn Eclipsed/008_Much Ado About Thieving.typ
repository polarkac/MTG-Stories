...
#show: doc => conf(
    "Much Ado About Thieving",
    set_name: "Lorwyn Eclipsed",
    story_date: datetime(day: 06, month: 01, year: 2026),
    author: "Tobi Ogundiran",
    doc
)

#emph[Gather round, my lovelies. Have a seat and listen to your Auntie Grub impart some boggart wisdom. Since you all have nothing better to do than loiter around and make a mess of my hut, I will tell you a tale. One story, after which you all must leave, yes? Okay. Today's tale is the story of four enterprising boggarts and how they raided a giant's lair—Nitwik, come down from there! Goodness, you'll break your neck hanging out the window. There's a good boggart. And return that rabbit's foot to where you found it. Don't think I didn't see you.]

#emph[Now, where was I? Ah, yes. Four friends—Flib, Lugg, Ygril, and Naance—were faffing about one morning, as young boggarts do, as you ] all#emph[ do]  …

#v(0.35em)
#line(length: 100%, stroke: rgb(90%, 90%, 90%))
#v(0.35em)

#figure(image("008_Much Ado About Thieving/01.jpg", width: 100%), caption: [Art by: Karl Kopinski], supplement: none, numbering: none)
...
"We've all heard terrible things about Boeb," said Ygril a tad too dismissively. "Don't mean it's true." But when the others shifted uneasily, unconvinced, she said, "Don't be cowards. Come on, think about it! We'll be the first boggarts to successfully rob Boeb. We'll be as famous as—no, #emph[more]  famous than Horp."
...
"Now wait a moment!" Flib leapt forward, blocking Lugg's path. The fur around his left eye had been singed off in an experiment gone wrong, exposing the wrinkled gray skin beneath, which he now squinted at Ygril in suspicion and indignation. "Why does #emph[he]  get to scout?"
...
#emph[(Thank you, Nitwik, but that was a rhetorical question.)]
...
"We should go back," said Naance to Ygril. "I #emph[told]  you Boeb is the worst of them all."
...
#emph[(And if you wonder how Ygril came to know so much about name sleep, it is because she is smart and listened to her aunties and did not question their wisdom. You hear that, Nitwik? She listened to her aunties.)]
...
Ygril skidded to a halt before Boeb of Boldwyr. The giant was stretched out in his cot, looking like a small mountain. Upon entering the cave, Flib, Lugg, and Naance stopped next to Ygril to regard the giant. It wasn't so much his size—for he #emph[was]  massive, and indeed this was the first any of them had seen a giant—but that instead of the formidable and hateful creature they were expecting, Boeb was ruddy and plump, with a face that could only be described as genial. And, as if he were in the throes of a happy dream, a most contented smile was playing on his lips, which they could only see when he exhaled and ruffled apart his forest of a mustache.
...
#figure(image("008_Much Ado About Thieving/02.jpg", width: 100%), caption: [Art by: Jorge Jacinto], supplement: none, numbering: none)
...
#emph[(Yes, Nitwik, they went without clothes, and all their bits were showing, but that's not what's important here.)]
...
But Flib was smiling, tongue lolling from his lips. #emph[Oh, this idiot!]  Ygril thought. #emph[This idiot is going to kill us all! ] She had just opened her mouth to admonish Flib when he hefted a giant shimmering scale over his head.
...
"No!" cried Ygril. "No, just—wait a moment!" A wrong swing, a swing wide off the mark, and Flib would chop straight into Boeb's flesh. "We have to remove it #emph[together] , and we must be careful!" She began to get down from the table—
...
"Where in #emph[infernal bogs]  did that come from?" squealed Flib.
...
Yes, it took some effort to rouse a giant from name sleep, but they #emph[could]  be roused, and the combination of the cloudgoat's mad bleating and stamping and Flib's sharp axe sinking into his flesh jolted Boeb awake. He twitched, slapped his chest, and crushed poor Flib.
...
#emph[(You say they're cowards? Well, you wouldn't fare any better with a rampaging giant, particularly one who has been so rudely roused from name sleep.)]
...
#emph[Now that's just rude] , thought Ygril.
...
#emph[(Is dismemberment a better death than being crushed, you ask? I can't say. I have neither been dismembered nor crushed.)]
...
Within moments, the bucket began to grow warm. The #emph[milk]  began to grow warm. Boeb began to hum good-naturedly as he waited for the milk to boil.
...
#emph[What happened to the friends? Well, Nitwik, they gathered their loot and went home, where they shared the loot with the rest of their swamp burrow. They celebrated Flib—who died foolishly, yes, but in service of something greater. And they basked in the experience and shared the tale of how they robbed Boeb of Boldwyr. Boeb the Terrible. There is a very clear lesson here. Can you tell me what it is? No, no! That is ] not#emph[ the lesson. Goodness, have I just wasted my entire afternoon? Don't laugh, Nitwik. I worry about you.]

#emph[Now, away with you. Away with you all! Auntie Grub has things to do.]
