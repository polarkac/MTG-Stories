...
#emph[Needs focus] , read Tivash's final note. #emph[Requires proper motivation to maximize potential.]
...
#figure(image("196_The Chains That Bind/02.jpg", width: 100%), caption: [Art by: Randy Vargas], supplement: none, numbering: none)

"The root of the esis tree," she whispered, her finger at the bottom of the ingredient list. No plant on Arcavios bore the name #emph[e] #emph[sis] , nor did any leaf she knew of resemble the delicate, feather-like shape drawn on the page.
...
#figure(image("196_The Chains That Bind/03.jpg", width: 100%), caption: [Art by: Randy Vargas], supplement: none, numbering: none)
...
If her experiment proved a success, she'd be able to go back to where her glade had been and bring it back. Bring them back. All the plants, animals, and dryads, just as she remembered. #emph[L] #emph[ife from lifelessness.]
...
"#emph[Dissatisfied?] " a voice shouted. "Do you even know the meaning of that word?" A second later, a sleek, black projectile hit the ground in front of her. #emph[Ink magic?]  she thought. Another shadowy bolt came out of the night and splashed into the mud precariously close to the water's edge where the pests were blissfully playing. It was absolutely ink magic, the signature spell style of Silverquill College. But what was someone from Silverquill doing out in Detention Bog? The answer was obvious: it was a student, one who was being punished.

"You weren't even there! Where the hell were you?"

Inky coils reached out from the darkness like twin claws, gripping a pair of high tree branches and ripping them down to the ground. This time the trees did speak. Their howls filled Dina's mind. #emph[What did we do? Why is this happening? ] Their wails of pain spurred her to action. She crawled out of hiding and cast her ghostlight hoping that the sight of another student would give the intruder pause.
...
The pests! Dina's heart dropped. #emph[If they're hurt] ~Dina prepared for the grisly scene and turned to look. But instead of dead pests, sitting on the ground was a jet-black sphere of ink magic quivering as if alive. Prominences of green mist leapt from point to point on its surface.
...
Dina stopped short of saying it: #emph[To save everything I ever loved in this world] . It was the kind of statement that sounded either megalomaniacal or at least deeply ridiculous, even if it was the truth. So she sidestepped his question.
...
"No, he gave me a detention for not #emph[applying myself] ," he said. "You should go back. I can handle myself."

"I'm not leaving you out here alone."

"Then help me fix your mistake."

"#emph[Our]  mistake," said Dina. "Remember that part with yelling and the careless spellcasting?"
...
#emph[Back here. Like you never left.]
...
Dina knew better than to take his nonchalance at face value. She knew what it was to lose those she loved, and moreover to have that ache of the #emph[never knowing] . It was a profound awareness of how empty you would always be, like a whirlpool draining into a bottomless chasm. No width of smile or depth of laugh could hide that wound from those who also bore it.
...
#emph[Nature] , Lisette had explained, #emph[is drawn to balance. Magic is simply a way to slightly alter this balance without destroying the elements you're working with. The key is to start small. A mountain can rest on a single pebble. An ocean begins as a drop of rain.]
...
#emph[Beware of taking too much on] , warned Lisette.#emph[ Nothing is without cost.]
...
"You do know that this is an institution of learning, eh?" said Valentin. "I trust that you have learned something this night—that #emph[you]  are the student, and #emph[we]  are the instructors. #emph[We]  painstakingly assemble lessons, and #emph[you]  follow them to the letter. Venturing outside of that dynamic is~fraught. Such a lesson will be valuable in your future coursework."
...
#figure(image("196_The Chains That Bind/04.jpg", width: 100%), caption: [Art by: Andrey Kuzinskiy], supplement: none, numbering: none)

#v(0.35em)
#line(length: 100%, stroke: rgb(90%, 90%, 90%))
#v(0.35em)

Professor Serafina Onyx blew air at the flame, causing it to dance. At the beginning of the night, the candle on her desk had stood tall and solid. But by the time it had melted down into a nub, she had only graded a handful of her students' exams. How long had it been since she herself was subject to the judgment of an instructor? Lady Ana had been a strict mentor, one widely recognized for her prowess in the healing arts. And what did that get her? A husband who left her. Children who shunned her. A swift end at the hands of a patient charged to her care. And worst of all, being utterly forgotten by everyone save the person who hated her most. Onyx dipped her quill into a jar of ink and proceeded to cross out a whole page of the exam in front of her. In the margin, she wrote one word: #emph[Pathetic] .
...
Onyx stopped on the final page and read over the spell. It, like all the others, had been a failure. #emph[Life from lifelessness. ] With her fingertip, she traced the outline of the esis leaf, caressing its edges like the cheek of a long-lost love. A black rot spread outward from where she touched it, consuming all the pages in the book, leaving nothing but the chains that had bound them.
