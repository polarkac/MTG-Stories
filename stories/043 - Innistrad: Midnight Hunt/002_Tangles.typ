...
#show: doc => conf(
    ...
    story_date: datetime(day: 03, month: 09, year: 2021),
...
#emph[Here?]  Wrenn inquired, asking without opening her mouth. How the question ached and burned at her, how it #emph[ached] . This part was always painful.

#figure(image("002_Tangles/01.jpg", width: 100%), caption: [Wrenn and Seven | Art by: Heonhwa Choe], supplement: none, numbering: none)
...
#emph[No. Close] , replied the tree. Wrenn nodded their vast head and continued into the wood, away from the place where they had arrived, looking for a clearing large enough to support Six's glory.
...
They had taken another five steps when the tree spoke again, saying, #emph[Here. Stop.]
...
#figure(image("002_Tangles/02.jpg", width: 100%), caption: [Art by: Heonhwa Choe], supplement: none, numbering: none)
...
Teferi put his own hands up. "Peace, please. They're not with me." Then he grimaced. "Well, they are, I suppose, but I'm not with #emph[them] . If we go deeper into the wood, we can slow them down. Can you walk?"
...
#figure(image("002_Tangles/03.jpg", width: 100%), caption: [Art by: Piotr Foksowicz], supplement: none, numbering: none)
...
"Yes," said Wrenn. "Oh." Then, with more anger in her voice, she said, "The tree that called me is gone. I can't hear it anymore. Do you know what you've #emph[done] ?"
...
"It doesn't #emph[work]  that way," protested the woman, voice growing even more ragged. "Dryads walk the Planes with our trees to keep and anchor us. Because my heart is made of fire, when I walk, my tree walks with me. I can have no partner too small to accommodate me, nor can I convince any unsuitable tree to carry me into the Plane. I #emph[must]  find a tree, and I don't have as much time as I would prefer!"
...
#figure(image("002_Tangles/04.jpg", width: 100%), caption: [Art by: Isis], supplement: none, numbering: none)
...
"Pick them apart #emph[how] , exactly?"
...
#figure(image("002_Tangles/05.jpg", width: 100%), caption: [Art by: Mila Pesic], supplement: none, numbering: none)
