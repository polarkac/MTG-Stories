...
#figure(image("001_Under the Cover of Fog/01.jpg", width: 100%), caption: [Wall of Mist | Art by: Tianhua X], supplement: none, numbering: none)
...
"I brought home a dozen apples yesterday," I remind her, hoping it will stall the next question. #emph[Where's the pay from today?]  The job at the docks may be a covert assignment, but the money's real, and it's the only thing keeping us afloat.
...
I stand there for a moment, trying to figure out how #emph[this]  has become my life. Fog seeps in from under the gap in the front door, twirls around me, like the dreariness of the streets has come to claim its stake inside my home. Inside me.
...
#figure(image("001_Under the Cover of Fog/02.png", width: 100%), caption: [Art by: Wesley Burt], supplement: none, numbering: none)
...
#figure(image("001_Under the Cover of Fog/03.jpg", width: 100%), caption: [Unexplained Disappearance | Art by: Izzy], supplement: none, numbering: none)
...
It takes a moment for the fog #emph[inside]  my head to clear, but soon as I'm able, I reach out between me and Grimbly Wothis, trying to pull those magic threads, trying to shield myself from sight, but it's useless. Now, Grimbly Wothis is standing over me, brow bent, his stare as sharp as the tips of his horns. Bits of flotsam cling to his body, and he smells like a striking combination of dank river and wet fur.

"You owe me, Merret." He takes one look around my home and laughs his roaring laugh, as if the idea of me possessing anything of value were a huge joke. "I'd take it out of your pay, but you'd spend three lifetimes earning back the cost of that whiskey. Then I thought I'd just take it out on your hide, but it seems you #emph[do]  have something of considerable value after all."
...
#figure(image("001_Under the Cover of Fog/04.jpg", width: 100%), caption: [Smelt-Ward Minotaur | Art by: Wisnu Tan], supplement: none, numbering: none)
...
#figure(image("001_Under the Cover of Fog/05.jpg", width: 100%), caption: [Lazav, the Multifarious | Art by: Yongjae Choi], supplement: none, numbering: none)
