...
#show: doc => conf(
    ...
    story_date: datetime(day: 15, month: 08, year: 2016),
    author: "Kelly Digges",
    doc
)
...
#figure(image("003_Proclamation by Queen Marchesa/01.jpg", width: 100%), caption: [Art by Kieran Yanner], supplement: none, numbering: none)
