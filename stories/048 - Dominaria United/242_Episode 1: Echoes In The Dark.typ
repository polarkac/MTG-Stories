...
#figure(image("242_Episode 1: Echoes In The Dark/01.jpg", width: 100%), caption: [Art by: Chris Rahn], supplement: none, numbering: none)
...
#figure(image("242_Episode 1: Echoes In The Dark/02.jpg", width: 100%), caption: [Art by:  Jarel Threat], supplement: none, numbering: none)
...
Once, when he'd been new, he'd reached out and touched the fire blazing in Urza's hearth. He'd dropped the cherry-red coal, shocked by the sensation, then examined his hand for damage. He'd found none. He'd looked up to see Urza watching him with glittering eyes. Urza hadn't tried to stop him, yet he'd known this would hurt Karn. #emph[Why did you give me intelligence if you do not value my personhood?]  Karn had felt ashamed the moment he'd asked the question, and yes, Urza had chuckled. #emph[You're more valuable to me if you can react intelligently. ] Karn had stared at his aching, undamaged hand. #emph[Then why give me pain? ] Urza had smiled and stroked his white beard. Karn had later learned how to recognize that expression as one Urza made when he thought he was being particularly clever. #emph[People are more reluctant to damage something if it causes that thing pain.]
...
#emph[Karn] , Jhoira would say, #emph[you were right all along.]
...
#figure(image("242_Episode 1: Echoes In The Dark/03.jpg", width: 100%), caption: [Art by:  Volkan Baga], supplement: none, numbering: none)
...
#figure(image("242_Episode 1: Echoes In The Dark/04.jpg", width: 100%), caption: [Art by:  Igor Kieryluk], supplement: none, numbering: none)
...
A single figure attended Sheoldred: a young woman with platinum-brown skin and dark umber curls who wore the cloak of the Tolarian academy. When she turned, Karn saw the red dot from a mechanical eye. Below, an acolyte hurried forward and offered up gobbets of flesh. The young woman sorted through them, twisting some into the morass that supported Sheoldred. Karn traced the line of acolytes carrying materials from the immense monstrosity to Sheoldred and her helper. She was #emph[mining]  the monstrosity to repair Sheoldred's damaged biological components.
...
#figure(image("242_Episode 1: Echoes In The Dark/05.jpg", width: 100%), caption: [Art by:  Ryan Alexander Lee], supplement: none, numbering: none)
...
He would tear her to pieces. He would crush her while she was still weak. He would do anything—#emph[anything] —to stop Sheoldred from Phyrexianizing this plane. Karn reached up and seized Sheoldred's torso, determined to finish this. He would tuck this device between the vulnerable plates of her body and destroy her.

At his touch, Sheoldred stirred. Her helmeted head craned down toward him. He could #emph[feel]  her with the same senses he used to determine the elemental composition of a compound. Her inorganic components stretched out before him like the pages in a book. Her biological parts lay like dark tumors nested within the metal's luminescent glory. He could read her thoughts—some of them.

#emph[Welcome, Father] , Sheoldred whispered into his mind, one mechanical being to another. #emph[What plans I have for you.]
...
#emph[Welcome] , her whisper echoed within him. #emph[Welcome.]
