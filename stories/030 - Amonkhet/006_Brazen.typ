...
#show: doc => conf(
    "Brazen",
    set_name: "Amonkhet",
    story_date: datetime(day: 03, month: 05, year: 2017),
    author: "Michael Yichao",
    doc
)

#figure(image("006_Brazen/01.png", width: 100%), caption: [], supplement: none, numbering: none)

#emph[The Gatewatch had come to Amonkhet to uncover the machinations of the malicious dragon Planeswalker Nicol Bolas. What they found instead was a flourishing civilization at the height of its power, watched over by benevolent gods. While Gideon Jura had many lingering questions about the world, the presence of the divine most captured his attention and curiosity.]
...
#emph[This is how it's supposed to be.]

And yet, in the back of my mind, Chandra's mistrust and Nissa's curiosity nagged at me. They were right to be cautious. This world belonged to Nicol Bolas, and despite his current absence, his #emph[presence]  lingered over everything. I glanced at the massive horns in the distance, visible through the closer buildings, a looming silhouette marring the horizon. I caught snippets of conversation as I trailed behind Oketra, and occasional mentions of the God-Pharoah—"May his return come quickly, and may we be found worthy"—floated by. The whole city had a rigidity and structure that was simultaneously impressive and worrisome, a confluence of achievement and glory against a lingering unnaturalness and unease.

But then there were the gods . . . I shook my head. #emph[I'm thinking myself in circles.]

I realized my thoughts slowed my steps and looked ahead. Oketra stood, stopped in her path, looking back. I broke into a light run to catch up. An unfamiliar weight bounced against my chest as I ran, and my hand reached up to the gold and blue cartouche hanging around my neck. #strong[The first step in your journey through the Trials] , Oketra had told me.
...
"#strong[These crops now prepare for the Trial of Ambition.] " Oketra's eyes were unblinking, yet her stare soothed rather than unnerved. "#strong[If you truly seek to embark upon the Trials, this is where you will begin.] "
...
"Greetings, Kytheon! I am Djeru of the #emph[Tah]  crop." The young man clapped his hands on my shoulders, his eyes gazing directly into mine, alight with a smile, and kissed me on both cheeks. I fumbled slightly to return the greeting.
...
#strong[I leave you to this Trial, Kytheon.]
...
#figure(image("006_Brazen/02.jpg", width: 100%), caption: [Sparring Mummy | Art by Ryan Pancoast], supplement: none, numbering: none)
...
#figure(image("006_Brazen/04.jpg", width: 100%), caption: [Tah-Crop Skirmisher | Art by Victor Adame Minguez], supplement: none, numbering: none)
...
My mind raced as we walked, trying to piece together all this information. I had myself witnessed the dead returning to life on this plane, but the way Djeru spoke of the fallen returning sounded different. #emph[Restored] , he said. Was this true—or even possible?
...
#figure(image("006_Brazen/05.jpg", width: 100%), caption: [Seeker of Insight | Art by Magali Villeneuve], supplement: none, numbering: none)

Meris started to reply—when a commotion behind us drew all our attention.

I turned to see a woman #emph[lift]  a minotaur overhead with a roar, then throw him tumbling to the ground. The initiates crowded around them cheered, some grumbling and handing over jewelry and gems to others.
...
My confusion must have shown on my face. "She is a #emph[dissenter] ," Djeru added. The others winced at the word.
...
I looked at Meris, Imi, Hepthys. #emph[You're all still children.]
...
#figure(image("006_Brazen/06.jpg", width: 100%), caption: [Approach of the Second Sun | Art by Noah Bradley], supplement: none, numbering: none)

A memory leapt to mind. #emph[A young woman, pushing her way through a crowded street, shouting as she was pursued by soldiers. "The gods lie! The hours are a lie!"]
...
#figure(image("006_Brazen/07.jpg", width: 100%), caption: [Bontu the Glorified | Art by Chase Stone], supplement: none, numbering: none)
...
"#strong[Time draws short] ," she rasped. Every face in the square was turned toward her now. "#strong[Not all will have the chance to earn my favor. Who deserves to compete in my Trial?] "

A burst of noise exploded from the assembled initiates, roaring assertions of their worth. Bontu's smile widened.

"#strong[Only the strong will triumph. But strength is learned.] " Narrowed eyes surveyed the raucous initiates. "#strong[None are born strong.] "
...
She turned to address all the initiates in the square. "#strong[Even I am greater than I once was] ," she rasped. "#strong[Because I desired to be so.] " Her words were answered by murmurs of admiration and acceptance.
...
"#strong[Initiates of the Tah crop. You shall be next to face my Trial] ."
...
"Looks like Oketra was right to have you join us after all." With that, he grabbed and thrust my hand in the air. Around me, the roaring cheers of his—#emph[my] —cropmates danced across the square. As they pulled me toward more food and drink, I couldn't help but notice the scowls and envious stares of other initiates.

#emph[The Trial of Ambition has already begun, I suppose] . The thought lingered as the rest of the evening passed in a blur of mirth, stories, and celebration, all under the strange, impossible red glow of the second sun.

#v(0.35em)
#line(length: 100%, stroke: rgb(90%, 90%, 90%))
#v(0.35em)

#figure(image("006_Brazen/08.jpg", width: 100%), caption: [Bontu's Monument | Art by Jonas De Ro], supplement: none, numbering: none)
...
#emph[A glorious death?]  I clenched my teeth. Nothing about Dedi's death felt glorious.

We walked on in silence. Grim faces, sullen atmosphere. #emph[They had not lost anyone in a Trial before this,]  I remembered. #emph[And yet, here we are, minutes into the first obstacle]  . . .
...
#figure(image("006_Brazen/09.jpg", width: 100%), caption: [Baleful Ammit | Art by Seb McKinnon], supplement: none, numbering: none)
...
A series of plans flashed through my mind. #emph[If the corridor is too narrow for the ammit, Hepthys could simply join us as we cross into the next challenge. Or if not, I could stay behind and—]

A squawk and the sound of teeth tearing flesh cut my words short.

I turned to see the ammit falling from an impossible height, its mighty leap just high enough to clamp onto one of Hepthys's wings. The ammit's teeth sliced through bone and tendon and it landed with a ground-shaking #emph[WUMPH] , swallowing its prize in two snapping bites. A torrent of blood dripped down as Hepthys wobbled in the air, then plummeted toward the ground. The ammit approached slowly, savoring its prize.
...
"There's bladed pendulums ahead," Djeru said, and for the first time I noticed the strange whirring sound. The corridor was dark, with no light source, but from the ambient glow of the room behind us, I could just make out blurs of #emph[something]  flashing by in intervals. Djeru shook his head. "The corridor narrows, and soon only one can cross at a time. The first few have already made it across, but the blades get faster with each person that passes."
...
#emph[You are a stranger to this world, Gideon. Things are different. Death is different. ] I shook my head.#emph[ Leave your judgment behind.]
...
. . .the #emph[only]  sound. I suddenly realized the noises of the ammit had stopped. I spun around. The chamber behind appeared empty, except for a few bloody stains across the grounds.
...
"The ammit is coming and likely to make it through the corridor since Gideon, uh, #emph[disabled]  the blade trap." Djeru looked at me, then back toward the roaring and scraping sounds as the ammit pushed its way closer.
...
Mighty eyes narrowed. "#strong[The Hours draw nigh. Your numbers are too great. Pay the toll, or fall short and perish.] "

I stared at Bontu, stunned. #emph[Our numbers are too great?]
...
#strong[Watch, Kytheon Iora. Quiet your judgment, and learn.]

#figure(image("006_Brazen/10.jpg", width: 100%), caption: [Cruel Reality | Art by Kieran Yanner], supplement: none, numbering: none)
...
"#strong[You have not paid your toll] ," Bontu rasped.
...
"#strong[Still so brazen.] "

She stood.

"#strong[And yet, still so ignorant of our world] ."

I faltered. #emph[Bontu knows that I'm not from Amonkhet? ] . . . #emph[Of course. She's a god. But perhaps that means she knows Bolas is also—]
...
"#strong[He is no heretic] ," Bontu hissed, "#strong[for he has yet to find his faith.] "

I shivered.

"#strong[You]  #strong[embarked on my Trial to find answers, Kytheon Iora. But you forgot to ask the right questions.] "

Bontu stood from her throne, her figure towering above us.

"#strong[You've seen more of us, what we demand] ." Another hissing laugh escaped her fangs. "#strong[Only excellence. True ambition. And yet, rather than understanding, I see only judgment in your heart] ."
...
"#strong[You look only for what satisfies your sense of justice. Your ambitions end with vindication for your past hubris.] "

She sneered.

"#strong[Shallow and selfish.] "
...
#strong[Such a long quest for faith, Kytheon Iora, and still you know nothing of it. Of course they doubt. Doubt is the necessary shadow to the light of faith, Kytheon. The stronger the faith, the deeper the shadows of uncertainty. Yet still, their ambitions drive them to shine brighter, reach higher, unsatisfied by complacent divinity. When will you be able to say the same for yourself?]

Her mouth curved into a smile.

"#strong[They are mine, and I am the God-Pharaoh's.] "
...
#emph[And I've moved ever further from understanding. This world. Myself.]
...
#figure(image("006_Brazen/11.jpg", width: 100%), caption: [Anointed Procession | Art by Victor Adame Minguez], supplement: none, numbering: none)
