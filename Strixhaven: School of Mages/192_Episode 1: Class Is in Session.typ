...
#figure(image("192_Episode 1: Class Is in Session/01.jpg", width: 100%), caption: [Professor Onyx | Art by: Kieran Yanner], supplement: none, numbering: none)
...
Will clenched his jaw, fighting the pull at his core. But his connection to his sister was too strong. Soon the same tendrils of light and shadow erupted around him, washing the bed in its ethereal glow. Desperately, he grabbed the #emph[Memoirs of Thadus the Healer]  before the light could pull him to a new plane. All around him, then, was light and color and sound unlike any in Kylem. He was hurtling through nothing, through everything.

The first thing Will heard, wherever Rowan had taken them, was a high-pitched screech. It was coming from a blur of feathers and talons—a blur that was headed right for him. Will yelped, raising the #emph[Memoirs ] as a shield. The bird cut up into the air just before impact, whirling in a wide arc overhead.
...
#emph[The first torch? ] Will wondered what that could mean.
...
"The #emph[Stormwright Texts]  were a lot more thorough," Kasmina said, idly.
...
"Are you #emph[joking] ?" exclaimed Will. "We could learn anything! Everything! We've got to pick up the pace!"
...
#figure(image("192_Episode 1: Class Is in Session/02.jpg", width: 100%), caption: [Art by: Brian Valeza], supplement: none, numbering: none)
...
#figure(image("192_Episode 1: Class Is in Session/03.jpg", width: 100%), caption: [Art by: Manuel Castañón], supplement: none, numbering: none)
...
Will stared in horror. "I thought this was supposed to be a #emph[school] . This is—"
...
"We're not here to have #emph[fun] , Rowan! We're here to become better mages!"

"Stand aside, first-year!" came a shout from behind him. He turned just in time to catch an orb of ink in the chest, which exploded and sent him crashing into Rowan. Together, they picked themselves off the ground, coughing, and Will looked down in horror: the copy of #emph[Memoirs of Thadus ] that he'd had in his traveler's pack had fallen out and was dripping with black ink. He knew at once that it was ruined. "Okay," Will growled, clenching his jaw. "Maybe it is our fight."
...
They probably weren't Oriq agents. But if they were planeswalkers, then maybe they could be useful if—#emph[when] , she corrected herself—trouble arrived at Strixhaven.
...
#figure(image("192_Episode 1: Class Is in Session/04.jpg", width: 100%), caption: [Art by: Piotr Dura], supplement: none, numbering: none)
...
"I know many things. Things that I could teach you." The masked man stepped away from the strange creature, toward Lukka. "And in exchange, I believe there are things #emph[you ] could do for me."
