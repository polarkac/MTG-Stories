...
#figure(image("201_A Silent Voice Calls/01.jpg", width: 100%), caption: [Killian, Ink Duelist | Art by: Ryan Pancoast], supplement: none, numbering: none)
...
#figure(image("201_A Silent Voice Calls/02.jpg", width: 100%), caption: [Crushing Disappointment | Art by: Andrey Kuzinskiy], supplement: none, numbering: none)
...
"Well, well, look who decided to make an appearance," exclaimed Fannessa, "Killian Lu, the rule breaker~and with a #emph[girlfriend]  no less?"
...
#figure(image("201_A Silent Voice Calls/03.jpg", width: 100%), caption: [Tempted by the Oriq | Art by: Billy Christian], supplement: none, numbering: none)
...
#figure(image("201_A Silent Voice Calls/04.jpg", width: 100%), caption: [Beaming Defiance | Art by: Manuel Castañón], supplement: none, numbering: none)
